...
const HBS_PARTIAL_TEMPLATES = [
  `${TEMPLATES_PATH}/actor/character-enhanced/anarchy-actor.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/armor.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/asset-module.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/attribute.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/attributebutton.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/attributebuttons.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/check-element.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/checkbar.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/contact.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/contacts.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/damage-armor.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/damage-code.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/description.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/edge.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/gear.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/gears.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/gmnotes.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/hexabox.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/owned-actor.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/physical.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/quality.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/skill.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/social-credibility.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/social-rumor.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/stun.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/weapon.hbs`,
  `${TEMPLATES_PATH}/actor/character-enhanced/weapons.hbs`,
