...
export function buildBattlemechHeatVisualState(source = null) {
  ...
  if (current < overheat) {
    ...
    return {
      ...
      glow: 0.04 + (progress * 0.10),
      shimmer: 0.02 + (progress * 0.05),
      blur: 0,
      pulseAmplitude: 0,
      pulseSpeed: 0,
      animated: false,
  ...
  if (current < danger) {
    ...
    return {
      ...
      glow: 0.18 + (progress * 0.18),
      shimmer: 0.16 + (progress * 0.20),
      blur: progress * 0.18,
      pulseAmplitude: 0,
      pulseSpeed: 0,
      animated: true,
  ...
  return {
    ...
    glow: 0.42 + (dangerRamp * 0.14),
    shimmer: 0.42 + (dangerRamp * 0.14),
    blur: 0.18 + (dangerRamp * 0.10),
    pulseAmplitude: 0.05 + (dangerRamp * 0.05),
