...
export const MACHINE_ACTION_DEFINITIONS = Object.freeze({
  ...
  chargeAttack: action("chargeAttack", {
    ...
    implementation: stub("Charge, ram, and DFA collision resolution is not implemented yet."),
  }),
  evasiveManeuver: action("evasiveManeuver", {
    label: "Dodge / Evasive Maneuver",
    attributeKey: "handling",
    skillKey: "piloting",
    cost: 2,
    category: "complex",
    ...
    implementation: stub("Machine evasive posture bonuses are not automated yet."),
  }),
  shield: action("shield", {
    label: "Physical Defense / Shielding",
    cost: 2,
    category: "complex",
    resolver: "movement",
    tags: ["defense", "shield", "posture"],
    implementation: stub("Machine shielding state is not automated yet."),
  }),
