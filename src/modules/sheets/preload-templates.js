...
const PARTIALS = [
  ...
  `systems/${SYSTEM_NAME}/templates/v2/ui/combat-awareness-preview.hbs`,
  ...
  `systems/${SYSTEM_NAME}/templates/v2/ui/character/active-criticals.hbs`,
  ...
  `systems/${SYSTEM_NAME}/templates/v2/ui/character/advancement.hbs`,
  `systems/${SYSTEM_NAME}/templates/v2/ui/character/knowledge-skills.hbs`,
  ...
  `systems/${SYSTEM_NAME}/templates/v2/ui/battlemech/fire-mode.hbs`,
