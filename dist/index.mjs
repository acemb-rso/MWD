...
var yf = (a, e, t) => e in a ? pf(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[e] = t;
var O = (a, e, t) => yf(a, typeof e != "symbol" ? e + "" : e, t), ss = (a, e, t) => e.has(a) || Ol("Cannot " + t);
var j = (a, e, t) => (ss(a, e, "read from private field"), t ? t.call(a) : e.get(a)), we = (a, e, t) => e.has(a) ? Ol("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(a) : e.set(a, t), Pe = (a, e, t, i) => (ss(a, e, "write to private field"), i ? i.call(a, t) : e.set(a, t), t), C = (a, e, t) => (ss(a, e, "access private method"), t);
var Xt = (a, e, t) => gf(hf(a), t, e);
const $e = {
  TYPES: {
    Actor: {
      character: "Character",
...
}, k = $e, T = "mwd", bf = "MechWarrior: Destiny", xs = `system.${T}`, Sf = T, En = `systems/${T}`, Su = `${En}/style`, Xa = `${En}/third-party/style`, Z = `systems/${T}/templates`, Pr = `${En}/img/icons`, fe = `${Pr}/skills`, Ce = "MWD | ", Af = 2, Tf = 5, wf = 4, Au = 8, Ri = {
  reflexes: "reflexes",
  strength: "strength",
  willpower: "willpower",
  intelligence: "intelligence",
...
Object.freeze(Object.values(vf));
const _a = {
...
globalThis.ANARCHY_CONSTANTS = {
  ...
  TEMPLATES_PATH: Z,
  ICONS_PATH: Pr,
  ICONS_SKILLS_PATH: fe,
  LOG_HEAD: Ce,
  SPECIALIZATION_BONUS: Af,
  TARGET_SUCCESS: Tf,
  TARGET_SUCCESS_EDGE: wf,
  BASE_MONITOR: Au,
  ACTOR_ATTRIBUTES: Ri,
  ITEM_ATTRIBUTES: $s,
  EDGE_POOL_GROUPS: Fo,
...
class X {
  ...
  static iconD6(e) {
    ...
    return X.fontAwesome(Ef[e]);
  }
}
globalThis.ANARCHY_ICONS = X;
...
const Ho = Object.freeze(["templated"]), Nf = Object.freeze([
  "burstCapable",
  "fullAutoCapable",
  "salvoCapable"
]), If = Object.freeze([
...
]), Lf = Object.freeze(["blast", "cone", "line"]);
new Set(Ho);
...
function Bf(a) {
  ...
  return e === "circle" ? "blast" : e === "ray" ? "line" : Tu.some((t) => t.value === e) ? e : "";
}
function zf(a) {
  const e = String(a ?? "").trim().toLowerCase();
  return ["target", "targeted"].includes(e) ? "targeted" : wu.some((t) => t.value === e) ? e : "";
}
function Ff(a = null) {
  const e = a ?? {}, t = Bf(e.shape ?? e.t ?? e.type), i = e.size ?? e.distance ?? e.radius ?? e.length, n = zf(e.placement ?? e.origin ?? e.mode);
...
function Uf({
  ...
  var g, y;
  const r = fn((a == null ? void 0 : a.traits) ?? []), s = fn((e == null ? void 0 : e.traits) ?? []), o = t.includes("templated"), l = r.includes("templated"), c = s.includes("templated"), u = (e == null ? void 0 : e.template) ?? null, d = (a == null ? void 0 : a.template) ?? null, m = Wn((g = e == null ? void 0 : e.resolution) == null ? void 0 : g.resolverKey, ""), f = Wn((y = a == null ? void 0 : a.resolution) == null ? void 0 : y.resolverKey, ""), p = Wn(i == null ? void 0 : i.resolverKey, "standard"), h = [];
  if (!o)
    return {
      errors: h,
      liveCapabilities: [],
...
const pn = Object.freeze(["none", "minor", "major", "full"]), Hf = Object.freeze(["blast", "cone", "line", "rect"]), jf = Object.freeze({
  blast: "circle",
  cone: "cone",
  line: "ray",
  rect: "rect"
...
function Ue(a, e = le.none) {
  const t = String(a ?? "").trim().toLowerCase();
  return pn.includes(t) ? t : e;
}
function Bs(a) {
  return Number(Wf[Ue(a)] ?? 0) || 0;
}
function Li(a) {
  return pn.indexOf(Ue(a));
}
function zs(a, e = 1) {
...
function Ko(a = {}) {
  ...
  return {
    startExposure: Ue(e.startExposure, le.minor),
    escalation: {
      rate: i,
      intervalTurns: t,
      max: Ue((o = e == null ? void 0 : e.escalation) == null ? void 0 : o.max, le.full)
    },
    onFull: {
...
function Nr(a, e = "") {
  const t = String(a ?? "").trim().toLowerCase();
  return Hf.includes(t) ? t : e;
}
function Pu(a, e = "circle") {
  return jf[Nr(a)] ?? e;
}
function Vf(a, e = "") {
  const t = String(a ?? "").trim().toLowerCase();
...
function Yf({ geometry: a = {}, tokenCenter: e = {} } = {}) {
  const t = L(e.x, 0) - L(a.x, 0), i = L(e.y, 0) - L(a.y, 0), n = Rn(a.direction ?? 0), r = Math.cos(n), s = Math.sin(n);
...
function Ll({ template: a = {}, placement: e = {} } = {}) {
  var l, c;
  const t = Nr((e == null ? void 0 : e.shape) ?? (a == null ? void 0 : a.shape), "");
  if (!t) return null;
  const i = L(
...
function Qf(a = null) {
  return a ? typeof (a == null ? void 0 : a.toObject) == "function" ? a.toObject() : typeof (a == null ? void 0 : a.toJSON) == "function" ? a.toJSON() : a && typeof a == "object" ? Eu(a) : null : null;
}
function Jf(a = []) {
  const e = [];
  for (const t of a) {
...
function Xf(a = null, { placementMode: e = "region", shapeHint: t = "" } = {}) {
  const i = Qf(a);
  if (!i || typeof i != "object") return null;
  const n = String(i.type ?? "").trim().toLowerCase(), r = Nr(t, "");
  if (n === "circle")
    return He({
      shape: r || "blast",
  ...
  if (n === "line") {
    const s = Array.from((a == null ? void 0 : a.measuredSegments) ?? []), o = Jf(s.map((f) => f == null ? void 0 : f.distance)), l = Math.max(
      L(i.distance, 0),
      L(i.length, 0),
      L(i.radius, 0),
      ...o,
...
function Nu(a = null, { placementMode: e = "region", shapeHint: t = "" } = {}) {
  const i = (a == null ? void 0 : a.document) ?? a ?? null, n = Array.from((i == null ? void 0 : i.shapes) ?? []);
  return n.length !== 1 ? null : Xf(n[0], { placementMode: e, shapeHint: t });
}
function Zf(a = null, e = null) {
  const t = He(a);
  return t ? {
    template: {
      shape: t.shape,
...
function ep(a) {
  var i, n, r, s;
  const e = L((a == null ? void 0 : a.w) ?? ((i = a == null ? void 0 : a.object) == null ? void 0 : i.w) ?? ((n = a == null ? void 0 : a.document) == null ? void 0 : n.width), 1) * mr(), t = L((a == null ? void 0 : a.h) ?? ((r = a == null ? void 0 : a.object) == null ? void 0 : r.h) ?? ((s = a == null ? void 0 : a.document) == null ? void 0 : s.height), 1) * mr();
  return Math.max(e, t) / 2;
}
function tp({ geometry: a, tokenCenter: e, tokenRadius: t }) {
  const i = wt(a.distance);
  return Fs({ x: a.x, y: a.y }, e) <= i + t;
}
function ip({ geometry: a, tokenCenter: e, tokenRadius: t }) {
  const i = wt(a.distance), n = wt(a.width ?? wi()), r = Rn(a.direction), s = e.x - a.x, o = e.y - a.y, l = Math.cos(r), c = Math.sin(r), u = s * l + o * c;
...
function np({ geometry: a, tokenCenter: e, tokenRadius: t }) {
  ...
  if (!(i > 0) || !(n > 0)) return !1;
  const r = L(a.anchorX, 0), s = L(a.anchorY, 0), o = L(a.x, 0), l = L(a.y, 0), c = o + i * (0.5 - r), u = l + n * (0.5 - s), d = -Rn(a.direction ?? 0), m = Math.cos(d), f = Math.sin(d), p = e.x - c, h = e.y - u, g = p * m - h * f, y = p * f + h * m;
  return Math.abs(g) <= i / 2 + t && Math.abs(y) <= n / 2 + t;
}
function Ir(a = null, e = null) {
  const t = He(a);
  if (!t || !e) return !1;
  const i = Iu(e), n = ep(e);
  return t.shape === "blast" ? tp({ geometry: t, tokenCenter: i, tokenRadius: n }) : t.shape === "line" ? ip({ geometry: t, tokenCenter: i, tokenRadius: n }) : t.shape === "cone" ? ap({ geometry: t, tokenCenter: i, tokenRadius: n }) : t.shape === "rect" ? np({ geometry: t, tokenCenter: i, tokenRadius: n }) : !1;
}
function Du({ template: a = {}, placement: e = {}, geometry: t = null, token: i = null } = {}) {
  if (!i) return le.none;
  const n = He(t, { template: a, placement: e });
  if (!n || !Ir(n, i))
    return le.none;
  const r = Iu(i), s = wt(n.distance);
  if (!(s > 0)) return le.none;
  if (n.shape === "line" || n.shape === "cone") {
    const l = Yf({ geometry: n, tokenCenter: r });
    return cs(l, s);
  }
  if (n.shape === "rect") {
    const l = {
...
function zi({ tier: a = le.none, appliedTier: e = null, evadeUsed: t = !1, evadeLocked: i = !1 } = {}) {
  const n = Ue(a, le.none), r = Ue(e ?? n, n);
  return {
    initialTier: n,
    initialLabel: Ft(n),
...
function Go(a = {}, { locked: e = !1, active: t = !1 } = {}) {
  const i = Ue((a == null ? void 0 : a.initialTier) ?? (a == null ? void 0 : a.tier), le.none);
  if (!t || e || i === le.none)
    return zi({
      tier: i,
      appliedTier: i,
...
function rp(a = {}) {
  const e = wt(L(a.distance, 0)), t = wt(L(a.width, wi())) / 2, i = Rn(a.direction ?? 0), n = Math.cos(i), r = Math.sin(i), s = -r, o = n, l = {
    x: L(a.x, 0) + e * n,
    y: L(a.y, 0) + e * r
  };
  return {
...
function Dr(a = null) {
  ...
  return e.shape === "line" ? [rp(e)] : e.shape === "cone" ? [sp(e)] : e.shape === "rect" ? [op(e)] : [];
}
function oi(a = null) {
  const e = He(a);
  return e ? Eu(e) : null;
...
const Lu = Object.freeze({
  ...
  Object.entries(Lu).map(([a, e]) => ({ value: a, label: e }))
), lp = Object.freeze({
  ...
  fr.map((a) => a.value)
), Us = Object.freeze({}), Or = Object.freeze({
...
function Lr(a) {
  return a && typeof a == "object" && !Array.isArray(a) ? Object.values(a).flatMap((e) => Lr(e)) : Array.isArray(a) ? a.map((e) => String(e ?? "").trim()).filter(Boolean) : String(a ?? "").split(",").map((e) => e.trim()).filter(Boolean);
}
...
function Fu(a, e) {
  return Ha(a).map((t) => fp(t, e)).filter(Boolean);
}
function fp(a, e) {
...
function Uu(a, e) {
  var n;
  const t = hp(a == null ? void 0 : a.key, e), i = Math.max(0, Number((a == null ? void 0 : a.rating) ?? 0) || 0);
...
function yp(a = []) {
  ...
  for (const i of a.filter(Boolean)) {
    i.accuracyMod !== void 0 && (e.accuracyMod = (Number(e.accuracyMod ?? 0) || 0) + (Number(i.accuracyMod ?? 0) || 0)), i.ap !== void 0 && (e.ap = (Number(e.ap ?? 0) || 0) + (Number(i.ap ?? 0) || 0)), i.addHeat !== void 0 && (e.addHeat = (Number(e.addHeat ?? 0) || 0) + (Number(i.addHeat ?? 0) || 0)), i.bonusVsArmorTag && (e.bonusVsArmorTag = gp(e.bonusVsArmorTag, i.bonusVsArmorTag));
...
function bp(a = [], e = []) {
  const t = Array.isArray(a) || typeof a == "string" ? { traits: a, standardTraits: e } : a ?? {}, i = Ua(t.traits), n = Ki(t.standardTraits), r = Hu(n, Us), s = i.map((o) => {
    var u;
    const l = _u[hn(o)];
    if (!l) return null;
...
function Sp(a) {
  ...
  return {
    ...
    damageType: $u(e.damageType),
    apMod: Number(e.apMod ?? e.ap ?? 0) || 0,
    attackRatingBandMod: pr(e.attackRatingBandMod ?? e.attackRatingBand),
    traits: i.traits,
    keywords: i.keywords,
    migration: t
  };
...
function Ap(a) {
  var l;
  const e = a ?? {}, t = Math.max(0, Number(e.max ?? 0) || 0), i = Number(e.current), n = Number.isFinite(i) ? Math.max(0, Math.min(i, t > 0 ? t : i)) : Math.max(0, t), r = Ha(e.types).map(Sp), s = String(e.activeTypeId ?? "").trim(), o = r.some((c) => c.id === s) ? s : ((l = r[0]) == null ? void 0 : l.id) ?? "";
  return {
    current: n,
    max: t,
...
function _l(a = {}) {
  ...
  return {
    ...
    attackRatingBand: pr(e.attackRatingBand ?? e.attackRatingBandMod)
  };
}
function js(a = {}) {
  return Cu(a, "standard");
}
function wp(a) {
  return String(a ?? "").trim().toLowerCase() === "unloaded";
}
function Rt(a, { report: e = null, path: t = "system.payloads[]" } = {}) {
  var l;
  const i = a ?? {}, n = String(i.id ?? "").trim() || xa("payload"), r = Mu({
    traits: i.traits ?? ((l = i.modifies) == null ? void 0 : l.traits),
    keywords: i.keywords,
    report: e,
    path: `${t}.traits`
  }), s = Lr(i.compatibleWith ?? i.compatible), o = mp(i.template);
  return wp(n) ? {
    id: "unloaded",
    label: "Unloaded",
    compatibleWith: [],
    ...
    consumption: Hs({ amount: 1, sourceId: "" })
  } : {
    id: n,
    ...
    consumption: Hs(i.consumption ?? i)
  };
}
function ni(a) {
  var o, l, c, u, d, m;
...
function ju({ report: a = null, path: e = "system.payloads" } = {}) {
  return {
    payloads: [Rt({
      id: "unloaded",
      label: "Unloaded",
...
function Ks(a = [], { report: e = null, path: t = "system.payloads" } = {}) {
  const i = Ha(a).map((n, r) => Rt(n, { report: e, path: `${t}[${r}]` })).filter(Boolean);
...
function _r(a = {}, { report: e = null, path: t = "system.payloads" } = {}) {
  var d;
  const i = Ap(a), n = Math.max(1, Number(i.consumePerAttack ?? 1) || 1), r = i.max > 0, s = r ? "internal-magazine" : "untracked", o = [ni(r ? {
    id: s,
    ...
    kind: "untracked",
    tracking: {}
  })], l = i.types.length ? i.types.map((m, f) => Rt({
    id: m.id,
    label: m.name,
    modifies: {
...
function gi(a, { legacyAmmo: e = null, category: t = "", report: i = null, path: n = "system.payloads" } = {}) {
  if (Ku(t)) return [];
  const r = Ha(a).map((s, o) => Rt(s, { report: i, path: `${n}[${o}]` })).filter(Boolean);
  return r.length > 0 ? Ks(r, { report: i, path: n }) : e ? Ks(_r(e, { report: i, path: n }).payloads, { report: i, path: n }) : ju({ report: i, path: n }).payloads;
}
function Za(a, { legacyAmmo: e = null } = {}) {
  const t = Ha(a).map(ni).filter(Boolean);
  return t.length > 0 ? t : e ? _r(e).consumptionSources : ju().consumptionSources;
}
function Aa(a, e = [], { legacyAmmo: t = null, category: i = "" } = {}) {
  ...
  if (t) {
    const o = _r(t).selectedPayloadId;
...
function Wu({ source: a = null, actor: e = null } = {}) {
  var i, n, r, s, o, l, c;
  if (!a)
    return {
      id: "",
...
function vp({ source: a = null, actor: e = null } = {}) {
  return Wu({ source: a, actor: e });
}
function Ws({
  payloads: a = [],
  selectedPayloadId: e = "",
  ...
  const s = gi(a, { category: r }), o = Za(t), l = Aa(n || e, s, { category: r }), c = s.find((f) => f.id === l) ?? s[0] ?? null, u = (c == null ? void 0 : c.consumption) ?? Hs(), d = u.sourceId ? o.find((f) => f.id === u.sourceId) ?? null : o.find((f) => f.kind === "untracked") ?? ni({
    id: "untracked",
    label: "Untracked",
    kind: "untracked"
  }), m = Wu({ source: d, actor: i });
  return {
    payloads: s,
    activePayload: c,
...
function kp({
  ...
  const g = Ws({
    ...
    payloadId: d || p,
    category: h
  }) : null) ?? g, A = b.activePayload, w = ku({
    traits: i,
    keywords: n
  }), v = Array.from(/* @__PURE__ */ new Set([
    ...w.traits,
    ...Ua(A == null ? void 0 : A.traits)
  ])), R = dr([
    ...w.keywords,
    ...dr(A == null ? void 0 : A.keywords)
  ]), E = qn(s, "standard"), x = (V = A == null ? void 0 : A.resolution) != null && V.resolverKey ? js(A.resolution) : E, K = Vn(o), q = jo(), H = Uf({
    weapon: {
      traits: w.traits,
      resolution: E
    },
  ...
  return delete F.sourceItem, {
    damageType: ((Y = A == null ? void 0 : A.modifies) == null ? void 0 : Y.damageType) || Yt(a),
    ap: (Number(e ?? 0) || 0) + (Number(((re = A == null ? void 0 : A.modifies) == null ? void 0 : re.ap) ?? 0) || 0),
    attackRatingBand: pp(
      t,
      ((ce = A == null ? void 0 : A.modifies) == null ? void 0 : ce.attackRatingBand) ?? {}
    ),
    effects: _,
    traits: v,
    keywords: R,
    ...
    payloadState: {
      payloads: b.payloads.map((oe) => foundry.utils.deepClone(oe)),
      activePayloadId: b.activePayloadId,
      payloadLabel: b.payloadLabel,
      sourceId: ((ue = b.source) == null ? void 0 : ue.id) ?? "",
    ...
    template: H.template ? foundry.utils.deepClone(H.template) : null,
    areaEffect: Ti((A == null ? void 0 : A.areaEffect) ?? {}),
    ...
    capabilityReport: {
      ...q,
      liveCapabilities: H.liveCapabilities,
      isTemplated: H.isTemplated,
      template: H.template ? foundry.utils.deepClone(H.template) : null,
      resolverKey: String((x == null ? void 0 : x.resolverKey) ?? "standard").trim() || "standard"
    },
    ...
    ammoState: {
      ...
      types: b.payloads.map((oe) => {
        var Re;
        return {
          id: oe.id,
          name: oe.label,
          damageType: ((Re = oe.modifies) == null ? void 0 : Re.damageType) ?? "",
          traits: oe.traits ?? [],
          keywords: oe.keywords ?? []
        };
      }),
...
function us({ standardTraits: a = [], traits: e = [], traitState: t = {} } = {}) {
  ...
  const i = hi(a), r = Ua(e).map((p) => {
    ...
    var g;
    return Gu(p, ((g = h.effect) == null ? void 0 : g.mitigationByType) ?? {});
  }, li({})), l = s.reduce(
    (p, h) => {
      var g;
...
function Mp({ traits: a = [], standardTraits: e = [] } = {}) {
  return [
    ...Ua(a),
    ...hi(e).map((i) => Uu(i, Or))
  ].filter(Boolean);
...
function Ep({ damageIncoming: a = 0, armorTags: e = [], effects: t = {} } = {}) {
  const i = new Set(Gn(e));
  let n = Number(a ?? 0) || 0;
  const r = [];
...
class da {
  ...
  static checkOutOfRange(e, t, i, n) {
    if (t < i || t > n) {
      const r = Ne(k.common.errors.outOfRange, {
        resource: e,
        value: t,
        min: i,
        max: n
  ...
  static checkActorCanReceiveDamage(e, t, i) {
    if (!t) {
      const n = Ne(k.common.errors.actorCannotReceiveDamage, {
        actor: i.name,
        damageType: Bu(e) ? Qt(e) : k.actor.monitors[e] ?? k.mwd.weaponDamageType[e] ?? k.mwd.personalDamageType[e] ?? e
      });
      throw ui.notifications.error(n), n;
    }
  }
  static checkWeaponDefense(e, t) {
    ...
    if ((((n = e.isPersonalWeapon) == null ? void 0 : n.call(e)) ?? e.type === S.itemType.personalWeapon) && !i) {
      const r = Ne(k.common.errors.noDefenseOnWeapon, { actor: t.name, weapon: e.name });
      throw ui.notifications.error(r), r;
    }
  }
...
const tt = S.actorAttributes, it = S.actorTypes, _t = gt.actions, _n = gt.defenses, ds = [
  fi(_t.defense, (a) => tt.reflexes, (a) => tt.intelligence, X.fontAwesome("fas fa-shield-alt"), [it.character, it.npc]),
  fi(_t.resistTorture, (a) => tt.strength, (a) => tt.willpower, X.fontAwesome("fas fa-angry"), [it.character, it.npc]),
  fi(_t.perception, (a) => tt.logic, (a) => tt.willpower, X.fontAwesome("fas fa-eye"), [it.character, it.npc]),
  fi(_t.perception, (a) => tt.system, (a) => tt.handling, X.fontAwesome("fas fa-video"), [it.vehicle, it.battlemech]),
  fi(_t.composure, (a) => tt.charisma, (a) => tt.willpower, X.fontAwesome("fas fa-meh"), [it.character, it.npc]),
  fi(_t.judgeIntentions, (a) => tt.charisma, (a) => tt.charisma, X.fontAwesome("fas fa-theater-masks"), [it.character, it.npc]),
  fi(_t.memory, (a) => tt.logic, (a) => tt.logic, X.fontAwesome("fas fa-brain"), [it.character, it.npc]),
  fi(_t.catch, (a) => tt.reflexes, (a) => tt.reflexes, X.fontAwesome("fas fa-baseball-ball"), [it.character, it.npc]),
  fi(_t.lift, (a) => tt.strength, (a) => tt.strength, X.fontAwesome("fas fa-dumbbell"), [it.character, it.npc])
], xn = [
  Ln(_n.physicalDefense, _t.defense),
  Ln(_n.physicalResistance, _t.resistTorture),
  Ln(_n.socialDefense, _t.composure),
  Ln(_n.mentalResistance, _t.perception)
];
class ze {
  static init() {
    Handlebars.registerHelper("fixedDefenseCode", (e) => ze.fixedDefenseCode(e));
  }
  static all(e = void 0) {
  ...
  static getActorDefenses(e) {
    return xn.map((t) => {
      const i = ze.getActorAction(e, t.actionCode);
      return ze._convertToDefense(i, t);
    }).filter((t) => t == null ? void 0 : t.code);
  }
  static getDefenseAttributeAction(e) {
    var t;
    return (t = xn.find((i) => i.code == e)) == null ? void 0 : t.actionCode;
  }
  static getActorAction(e, t) {
    return ze.getActorActions(e).find((i) => i.code == t);
  }
  static getActorDefense(e, t) {
    t = ze.fixedDefenseCode(t);
    const i = xn.find((r) => r.code == t), n = ze.getActorAction(e, i.actionCode);
    return da.checkActorDefenseAction(n, e, i), ze._convertToDefense(n, i);
  }
  ...
  static prepareShortcut(e, t) {
    const i = ze.getActorActions(e).find((n) => n.code == t);
    if (i)
      return {
        icon: i.icon,
        label: i.labelkey,
...
class Gs {
  ...
  async onSocketMessage(e) {
    ...
    if (t) {
      ...
      i && (n || r) ? t.callback(e.data) : console.log(Ce + "RemoteCall.onSocketMessage(", e, ") ignored :", i, n, r);
    } else
...
class Gt {
  ...
  static firstConnectedGM() {
    return Gt.getUsers((e) => e.isGM && e.active).sort(de.ascending((e) => e.id)).at(0) ?? {};
  }
  /**
...
const ha = k.actor.monitors, pi = k.actor.counters, qu = {
  armor: {
    path: "system.monitors.armor.value",
    monitor: (a) => a.system.monitors.armor,
    iconChecked: X.fontAwesome("fas fa-shield-slash"),
    iconUnchecked: X.fontAwesome("fas fa-shield-alt"),
    iconHit: X.fontAwesome("fas fa-bahai"),
    resource: ha.armor
  },
  fatigue: {
    path: "system.monitors.fatigue.value",
    monitor: (a) => a.system.monitors.fatigue,
    iconChecked: X.fontAwesome("fas fa-grimace"),
    iconUnchecked: X.fontAwesome("far fa-smile"),
    iconHit: X.fontAwesome("fas fa-bahai"),
    resource: ha.fatigue,
  ...
  physical: {
    ...
    iconChecked: X.fontAwesome("fas fa-heartbeat"),
    iconUnchecked: X.fontAwesome("far fa-heart"),
    iconHit: X.fontAwesome("fas fa-bahai"),
  ...
  structure: {
    ...
    iconChecked: X.fontAwesome("fas fa-car-crash"),
    iconUnchecked: X.fontAwesome("fas fa-car-alt"),
    iconHit: X.fontAwesome("fas fa-bahai"),
  ...
  heat: {
    ...
    iconChecked: X.fontAwesome("fas fa-fire"),
    iconUnchecked: X.fontAwesome("far fa-sun"),
    iconHit: X.fontAwesome("fas fa-temperature-high"),
    resource: ha.heat
  },
  criticals: {
    ...
    iconChecked: X.fontAwesome("fas fa-bolt"),
    iconUnchecked: X.fontAwesome("far fa-dot-circle"),
    iconHit: X.fontAwesome("fas fa-exclamation-triangle"),
    resource: ha.structure
  },
  anarchy: {
    ...
    iconChecked: X.iconPath(`${Xa}/anarchy-point.webp`, "checkbar-img"),
    iconUnchecked: X.iconPath(`${Xa}/anarchy-point-off.webp`, "checkbar-img"),
    resource: pi.anarchy
  },
  plot: {
    path: "system.counters.anarchy.value",
    ...
    iconChecked: X.iconPath(`${Xa}/danger-point.webp`, "checkbar-img"),
    iconUnchecked: X.iconPath(`${Xa}/danger-point-off.webp`, "checkbar-img"),
    resource: pi.anarchy
  },
  sceneAnarchy: {
    ...
    iconChecked: X.iconPath("systems/mwd/icons/default/explosion.svg", "checkbar-img"),
    iconUnchecked: X.iconPath("systems/mwd/icons/default/explosion.svg", "checkbar-img"),
  ...
  grit: {
    ...
    iconChecked: X.iconPath("systems/mwd/icons/default/shield.svg", "checkbar-img"),
    iconUnchecked: X.iconPath("systems/mwd/icons/default/shield.svg", "checkbar-img"),
  ...
  insight: {
    ...
    iconChecked: X.iconPath("systems/mwd/icons/default/eye.svg", "checkbar-img"),
    iconUnchecked: X.iconPath("systems/mwd/icons/default/eye.svg", "checkbar-img"),
  ...
  legend: {
    ...
    iconChecked: X.iconPath("systems/mwd/icons/default/tower-flag.svg", "checkbar-img"),
    iconUnchecked: X.iconPath("systems/mwd/icons/default/tower-flag.svg", "checkbar-img"),
  ...
  credibility: {
    ...
    iconChecked: X.iconPath("systems/mwd/icons/misc/hand.svg", "checkbar-img"),
    iconUnchecked: X.iconPath("systems/mwd/icons/misc/hand.svg", "checkbar-img"),
  ...
  rumor: {
    ...
    iconChecked: X.iconPath("systems/mwd/icons/default/mystery-man.svg", "checkbar-img"),
    iconUnchecked: X.iconPath("systems/mwd/icons/default/mystery-man.svg", "checkbar-img"),
    resource: pi.edgePools.rumor
  }
}, Zt = foundry.utils.mergeObject(qu, {});
class G {
  static init() {
  ...
  static hackCheckbars(e) {
    if (e) {
      const t = foundry.utils.mergeObject(qu, {});
  ...
  static _notifyOverflow(e, t, i, n) {
    const r = Ne(k.actor.monitors.overflow, {
      actor: e.name,
  ...
  static async _manageFatigueOverflow(e, t, i) {
    await G.addCounter(e, S.monitors.physical, t - i);
  }
  static async setAnarchy(e, t) {
    if (e.hasOwnAnarchy()) {
      ...
      await G._setAnarchyMonitor(e, S.monitors.anarchy, t);
    }
  }
  static async setSceneAnarchy(e, t) {
    await G._setAnarchyMonitor(e, S.monitors.sceneAnarchy, t);
  }
...
const { loadTemplates: Rp, renderTemplate: Pp } = foundry.applications.handlebars, Bl = {
...
class yi {
  ...
  static async diceCursor({ value: e, min: t, max: i, editable: n }) {
    return await Pp("systems/mwd/templates/roll/parts/dice-cursor.hbs", {
      value: e,
      min: t,
      max: i,
      editable: n
...
class aa {
  ...
  static register(e) {
    aa.instance()._register(e);
  }
  _register(e) {
    if (console.log(Ce + "HooksManager.register", e), !e.startsWith(zl))
...
class he {
  constructor() {
    this.modifiers = {
      ...
      roll: he._buildGroupOptions("roll"),
      attribute: he._buildGroupOptions("attribute"),
      monitor: he._buildGroupOptions("monitor"),
      other: he._buildGroupOptions("other")
          ...
          case "monitor": {
            switch (t.hash.category) {
              case "resistanceByType":
                return Me.getDamageTypes().map((r) => ({ key: r.value, label: r.labelkey }));
            }
            return [];
          }
        }
  ...
  getSelectRollSubCategories(e) {
    switch (e) {
      ...
      case "attributeAction":
        const t = ze.all().map((i) => ({ key: i.code, label: i.labelkey }));
        return de.distinct(t.map((i) => i.key)).map((i) => t.find((n) => n.key == i));
    }
    return [];
  }
  getEnums() {
    ...
    return (i) => {
      ...
      if (i.group == "roll" && i.effect == t)
        switch (i.category) {
          ...
          case "attributeAction":
            return i.subCategory == e.attributeAction || i.subCategory == ze.getDefenseAttributeAction(e.defenseAction);
        }
      return !1;
    };
  }
  static computeRollModifiers(e, t, i) {
    const n = he.buildRollModifiersFilter(t, i), r = (c) => c.group == "roll" && c.effect == i && n(c), s = he._activeItems(e).map((c) => he.itemModifiers(c, r)).reduce((c, u) => c.concat(u), []).sort(de.descending((c) => c.modifier.value)), o = he.$sumAssetModuleModifiers(s.filter((c) => Fl.includes(c.item.type)).map((c) => c.modifier.value)), l = de.sumValues(s.filter((c) => !Fl.includes(c.item.type)).map((c) => c.modifier.value));
    return {
      value: o + l,
      sources: s
    };
  ...
  static $sumAssetModuleModifiers(e) {
    const t = e.find((r) => r > 3) ?? 0, i = de.sumValues(e.filter((r) => r < 0)), n = Math.min(3, de.sumValues(e.filter((r) => r > 0 && r <= 3)));
    return i + Math.max(n, t);
  }
  static computeModifiers(e, t, i = void 0, n = void 0) {
    const r = he._createFilter(t, i, n), s = he._activeItems(e).map((l) => he.itemModifiers(l, r)).reduce((l, c) => l.concat(c), []);
    return {
      value: de.sumValues(s, (l) => l.modifier.value),
      sources: s
    };
  }
  static sumMonitorModifiers(e, t, i, n = void 0) {
    return he.sumModifiers(he._activeItems(e), "monitor", t, i, n);
  }
  static sumModifiers(e, t, i, n, r = void 0) {
    const s = he._createFilter(t, i, n, r), o = he._activeItems(e).map((l) => he.itemModifiers(l, s)).reduce((l, c) => l.concat(c), []);
    return de.sumValues(o, (l) => l.modifier.value);
  }
  ...
  static countModifiers(e, t, i = void 0, n = void 0) {
    const r = he._createFilter(t, i, n);
    return he._activeItems(e).map((o) => he.itemModifiers(o, r)).reduce((o, l) => o.concat(l), []).count;
  }
  static itemModifiers(e, t) {
    return he._listItemModifiers(e, t).map((i) => he._itemModifier(e, i));
  }
...
const { loadTemplates: ms, renderTemplate: U0 } = foundry.applications.handlebars, ve = {
  pool: "pool",
  reroll: "reroll",
  rerollMax: "rerollMax",
  ...
  // attribute1
  {
    ...
    options: {
      order: 1,
      category: ve.pool,
      hbsTemplateRoll: `${Z}/roll/parts/select-attribute.hbs`
    },
  ...
  // attribute2
  {
    ...
    options: {
      ...
      category: ve.pool,
      hbsTemplateRoll: `${Z}/roll/parts/select-attribute.hbs`,
      hbsTemplateChat: `${Z}/chat/parts/pool-attribute2.hbs`
    },
  ...
  // skill
  {
    ...
    options: {
      ...
      order: 3,
      category: ve.pool,
      hbsTemplateRoll: `${Z}/roll/parts/input-numeric.hbs`
    },
  ...
  // specialization
  {
    ...
    options: {
      ...
      order: 4,
      category: ve.pool,
      hbsTemplateRoll: `${Z}/roll/parts/check-option.hbs`
    },
    isUsed: (a) => a.used,
  ...
  // modifiers bonus
  {
    ...
    factory: (a) => Hi.computeRollModifiers(ve.pool, a)
  },
  // wounds
  {
    code: "wounds",
  ...
  // glitch
  {
    ...
    options: {
      ...
      hbsTemplateRoll: `${Z}/roll/parts/input-numeric.hbs`,
      hbsTemplateChat: `${Z}/chat/parts/glitch.hbs`,
      min: 0,
      max: 5
    },
    isUsed: (a) => a.value > 0,
    factory: (a) => {
      const e = a.actor.getWounds(), t = Hi.computeRollModifiers(ve.glitch, a);
      return {
  ...
  // rerolls
  {
    ...
    factory: (a) => {
      const e = Hi.computeRollModifiers(ve.reroll, a), t = Hi.computeRollModifiers(ve.rerollMax, a);
  ...
  // forced success rerolls
  {
    ...
    factory: (a) => {
      var t;
      const e = Hi.computeRollModifiers(ve.successReroll, a);
  ...
  // anarchy take risks
  {
    ...
    options: {
      ...
      hbsTemplateRoll: `${Z}/roll/parts/check-option.hbs`,
      hbsTemplateChat: `${Z}/chat/parts/anarchy-risk.hbs`
    },
    isUsed: (a) => a.used,
    condition: (a) => a.actor.getAnarchyValue() > 0,
    onChecked: (a, e) => {
  ...
  // edge
  {
    ...
    factory: (a) => {
      ...
      }), i = ((n = t.find((r) => r.value > 0)) == null ? void 0 : n.code) ?? S.counters.edgePools.grit;
      return {
        edgePools: t,
        pool: i
      };
  ...
  // reduce opponent pool
  {
    ...
    options: {
      ...
      order: 100,
      category: ve.opponentPool,
      labelkey: k.common.roll.modifiers.opponentPool,
      hbsTemplateRoll: `${Z}/roll/parts/input-numeric.hbs`,
      min: 0,
      max: 4
    },
    factory: (a) => Hi.computeRollModifiers(ve.opponentPool, a),
  ...
  // force opponent rerolls
  {
    ...
    factory: (a) => Hi.computeRollModifiers(ve.opponentReroll, a),
    condition: (a) => !a.attributeAction
  }
];
class Hi {
  constructor() {
    this.registeredParameters = {}, aa.register(Pt.REGISTER_ROLL_PARAMETERS), aa.register(Pt.MODIFY_ROLL_PARAMETER), Hooks.on(Pt.MODIFY_ROLL_PARAMETER, (e) => this._validate(e)), Hooks.once(Pt.REGISTER_ROLL_PARAMETERS, (e) => Np.forEach(
      (t) => e(t)
    )), Hooks.once("ready", () => this.onReady());
  }
  async onReady() {
    Hooks.callAll(Pt.REGISTER_ROLL_PARAMETERS, async (t) => {
      Hooks.callAll(Pt.MODIFY_ROLL_PARAMETER, t), t.ignore || await this._register(t);
    });
    const e = de.distinct([].concat(Object.values(this.registeredParameters).map((t) => t.options.hbsTemplateRoll)).concat(Object.values(this.registeredParameters).map((t) => t.options.hbsTemplateChat)).filter((t) => typeof t == "string" && t.length > 0));
    await ms(de.distinct(e)), await ms([`${Z}/roll/parts/parameter-label.hbs`]);
  }
  _validate(e) {
  ...
  compute(e) {
    const t = e.filter((r) => this.isParameterUsed(r)), i = de.classify(t, (r) => r.category), n = {};
    return Object.values(i).forEach((r) => n[r[0].category] = de.sumValues(r, (s) => s.value ?? (s.optional ? 1 : 0))), n;
  }
  isParameterUsed(e) {
  ...
  static computeRollModifiers(e, t) {
    ...
    return he.computeRollModifiers(n, t, e);
  }
}
const { ApplicationV2: Ip, HandlebarsApplicationMixin: Dp } = foundry.applications.api, { loadTemplates: Op, renderTemplate: Lp } = foundry.applications.handlebars;
var Er, Vu;
const Qe = class Qe extends Dp(Ip) {
  ...
  static async rollAttribute(e, t) {
    const i = foundry.utils.mergeObject(Qe.prepareActorRoll(e), {
  ...
  static async rollSkill(e, t, i) {
    const n = foundry.utils.mergeObject(Qe.prepareActorRoll(e), {
  ...
  static async rollWeapon(e, t, i, n) {
    const r = foundry.utils.mergeObject(Qe.prepareActorRoll(e), {
  ...
  static async itemAttributeRoll(e, t) {
    const i = foundry.utils.mergeObject(Qe.prepareActorRoll(e.actor), {
      mode: gt.rollType.attribute,
      item: e,
      attribute1: t,
  ...
  static async create(e) {
    var s;
    const t = C(s = Qe, Er, Vu).call(s, e), i = await Lp(`${Z}/roll/roll-dialog-title.hbs`, t), n = {
      id: `roll-dialog-${foundry.utils.randomID()}`,
      classes: [game.system.anarchy.styles.selectCssClass(), ...Qe.DEFAULT_OPTIONS.classes],
      window: { title: i }
    };
    return new Qe({ roll: t }, n).render({ force: !0 });
  }
  constructor(e = {}, t = {}) {
  ...
  async activateListeners(e) {
    ...
    await super.activateListeners(t), this.html = t instanceof HTMLElement ? $(t) : e, this.html.find(".select-attribute-parameter").change(async (i) => {
      ...
      n.onChecked(n, i.currentTarget.checked), n.category == ve.pool && await this._updateParameterValue(n, n.value), n.code == "edge" && this.html.find(`.parameter[data-parameter-code='${n.code}'] .edge-pool-select`).prop("disabled", !n.used);
...
Er = new WeakSet(), Vu = function(e) {
  const t = game.system.anarchy.rollParameters.build(e).sort(de.ascending((i) => i.order ?? 200));
  return foundry.utils.mergeObject(e, {
  ...
  body: {
    template: `${Z}/roll/roll-dialog.hbs`
  }
});
let ri = Qe;
const Vo = 2, qs = "skillSpecializationCatalog", _p = [
  { key: "running", label: "Running" },
  { key: "jumping", label: "Jumping" },
  { key: "swimming", label: "Swimming" },
  { key: "climbing", label: "Climbing" },
  { key: "acrobatics", label: "Acrobatics" }
], Yu = /* @__PURE__ */ new Set(), di = [
  // Strength
  { code: "athletics", label: "Athletics", attribute: "strength", icon: `${fe}/athletics.svg`, domains: ["physical"], specializations: _p },
  { code: "heavyWeapons", label: "Heavy Weapons", attribute: "strength", icon: `${fe}/heavy-weapons.svg`, defense: "physicalDefense", domains: ["physical"] },
  // Reflexes
  { code: "escapeArtist", label: "Escape Artist", attribute: "reflexes", icon: `${fe}/escape-artist.svg`, domains: ["physical"] },
  { code: "gunnery", label: "Gunnery", attribute: "reflexes", icon: `${fe}/vehicle-weapons.svg`, defense: "physicalDefense", domains: ["physical"] },
  { code: "meleeCombat", label: "Melee Combat", attribute: "reflexes", icon: `${fe}/close-combat.svg`, defense: "physicalDefense", domains: ["physical"] },
  { code: "piloting", label: "Piloting", attribute: "reflexes", icon: `${fe}/piloting-ground-steering-wheel.svg`, domains: ["physical"] },
  { code: "projectileWeapons", label: "Projectile Weapons", attribute: "reflexes", icon: `${fe}/projectile-weapons.svg`, defense: "physicalDefense", domains: ["physical"] },
  { code: "firearms", label: "Firearms", attribute: "reflexes", icon: `${fe}/firearms.svg`, defense: "physicalDefense", domains: ["physical"] },
  { code: "stealth", label: "Stealth", attribute: "reflexes", icon: `${fe}/stealth.svg`, domains: ["physical"] },
  { code: "zeroGOps", label: "Zero-G Operations", attribute: "reflexes", icon: `${fe}/fly.svg`, domains: ["physical"] },
  // Intelligence
  { code: "art", label: "Art", attribute: "intelligence", icon: `${fe}/art.svg`, domains: ["mental"] },
  { code: "artillery", label: "Artillery", attribute: "intelligence", icon: `${fe}/artillery.svg`, domains: ["mental"] },
  { code: "systemOps", label: "System Operations", attribute: "intelligence", icon: `${fe}/electronics.svg`, domains: ["mental"] },
  { code: "computers", label: "Computers", attribute: "intelligence", icon: `${fe}/hacking.svg`, domains: ["mental"] },
  { code: "demolitions", label: "Demolitions", attribute: "intelligence", icon: `${fe}/demolition.svg`, domains: ["mental"] },
  { code: "medTech", label: "Medtech", attribute: "intelligence", icon: `${fe}/biotech.svg`, domains: ["mental"] },
  { code: "science", label: "Science", attribute: "intelligence", icon: `${fe}/skills.svg`, domains: ["mental"] },
  { code: "perception", label: "Perception", attribute: "intelligence", icon: `${fe}/skills.svg`, domains: ["mental"] },
  { code: "tactics", label: "Tactics", attribute: "intelligence", icon: `${fe}/skills.svg`, domains: ["mental"] },
  { code: "technician", label: "Technician", attribute: "intelligence", icon: `${fe}/engineering.svg`, domains: ["mental"] },
  { code: "tracking", label: "Tracking", attribute: "intelligence", icon: `${fe}/tracking.svg`, domains: ["physical", "mental"] },
  { code: "navigation", label: "Navigation", attribute: "intelligence", icon: `${fe}/piloting-other.svg`, domains: ["mental"] },
  // Guts
  { code: "administration", label: "Administration", attribute: "willpower", icon: `${fe}/knowledge.svg`, domains: ["social", "mental"] },
  { code: "animalHandling", label: "Animal Handling", attribute: "willpower", icon: `${fe}/animals.svg`, domains: ["physical", "mental"] },
  { code: "survival", label: "Survival", attribute: "willpower", icon: `${fe}/survival.svg`, domains: ["physical", "mental"] },
  // Charisma
  { code: "acting", label: "Acting", attribute: "charisma", icon: `${fe}/con-art.svg`, domains: ["social"] },
  { code: "disguise", label: "Disguise", attribute: "charisma", icon: `${fe}/disguise.svg`, domains: ["social", "mental"] },
  { code: "leadership", label: "Leadership", attribute: "charisma", icon: `${fe}/psychology.svg`, domains: ["social"] },
  { code: "negotiation", label: "Negotiation", attribute: "charisma", icon: `${fe}/negotiation.svg`, domains: ["social"] },
  { code: "etiquette", label: "Etiquette", attribute: "charisma", icon: `${fe}/etiquette.svg`, domains: ["social"] },
  { code: "streetwise", label: "Streetwise", attribute: "charisma", icon: `${fe}/etiquette2.svg`, domains: ["social"] },
  { code: "intimidation", label: "Intimidation", attribute: "charisma", icon: `${fe}/intimidation.svg`, domains: ["social", "mental"] }
].map(xp);
for (const a of di)
  Yu.add(a.code);
function xp(a) {
...
const zp = Object.freeze(Bp());
function Fp(a, e = [], { strict: t = !1, errors: i = [] } = {}) {
  var r, s;
  if (!Array.isArray(e)) {
    if (t) {
...
function Qu(a, { strict: e = !1 } = {}) {
  ...
  for (const [r, s] of Object.entries(t)) {
    ...
    const o = Fp(r, s, { strict: e, errors: i });
    o.length && (n[r] = o);
  }
  if (e && i.length) throw $p(i);
...
function Xu(a = [], { allowedKeys: e = null } = {}) {
...
function xr(a, { strict: e = !1 } = {}) {
  return Qu(a, { strict: e });
}
function gr(a = []) {
  return Xu(a);
}
function jp(a, e = []) {
  const t = new Set(na(a).map((n) => n.key)), i = new Set(Xu(e, { allowedKeys: t }));
  return na(a).filter((n) => i.has(n.key)).map((n) => n.key);
}
function Ys(a, e) {
  var t, i;
  return gr(
...
function ed(a, e) {
  const t = new Set($r(a, e));
  return na(e).filter((i) => t.has(i.key));
}
function Kp(a) {
...
function Wp(a) {
  ...
  for (const i of di) {
    ...
    n.rating == null && (n.rating = 0), n.bonus == null && (n.bonus = 0), n.specializations = gr(n.specializations);
  }
}
function td(a, { bonusBySkill: e = null } = {}) {
  const t = hr(), { left: i, right: n } = Kp(t), r = (s) => {
    var y, b, A, w, v, R;
    const o = s.code, l = s.attribute, c = Number(((b = (y = a == null ? void 0 : a.skills) == null ? void 0 : y[o]) == null ? void 0 : b.rating) ?? 0), u = Number(((w = (A = a == null ? void 0 : a.attributes) == null ? void 0 : A[l]) == null ? void 0 : w.value) ?? 0), d = Number(((R = (v = a == null ? void 0 : a.skills) == null ? void 0 : v[o]) == null ? void 0 : R.bonus) ?? 0), m = Number((e == null ? void 0 : e[o]) ?? 0), f = d + m, p = ed(a, o), h = na(o).filter((E) => !p.some((x) => x.key === E.key)), g = u + c + f;
    return {
      code: o,
      label: s.label,
      icon: s.icon,
...
const Pa = {
...
}, id = "statusConditionCatalog", Gp = Object.freeze([
  ...
  S.actorTypes.vehicle,
  S.actorTypes.battlemech
]), qp = Object.freeze([...ad, ...nd]), yr = Object.freeze({
  person: ad,
  machine: nd,
  all: qp,
  character: [S.actorTypes.character],
  npc: [S.actorTypes.npc],
  vehicle: [S.actorTypes.vehicle],
  battlemech: [S.actorTypes.battlemech]
}), rd = "systems/mwd/img/icons/status", Vp = Object.freeze([
  // Person conditions: lightly filtered from the existing status/icon pool.
  se("prone", "Prone", "person", "physical", ["movement", "posture"], "prone.svg", { modifierKey: "prone", order: 10 }),
  se("blinded", "Blinded", "person", "sensory", ["vision"], "blinded.svg", { modifierKey: "blinded", order: 20 }),
  se("frightened", "Frightened", "person", "mental", ["morale"], "brain_injury.svg", { modifierKey: "frightened", order: 30 }),
  se("deafened", "Deafened", "person", "sensory", ["hearing"], "deafened.svg", { order: 40 }),
  se("hidden", "Hidden", "person", "tactical", ["stealth"], "hidden.svg", { order: 50 }),
  se("suppressed", "Suppressed", "person", "tactical", ["offense"], "suppressed.svg", { order: 60 }),
  se("grappled", "Grappled", "person", "physical", ["movement"], "grappled.svg", { order: 70 }),
  se("stunned", "Stunned", "person", "physical", ["action"], "concussion.svg", { order: 80 }),
  se("knockedOut", "Knocked Out", "person", "physical", ["unconscious"], "knockout.svg", { order: 90 }),
  se("onFire", "On Fire", "all", "hazard", ["fire", "heat", "escalating"], "on_fire.svg", { order: 100 }),
  se("drugged", "Drugged", "person", "chemical", ["impairment"], "drugged.svg", { order: 110 }),
  se("radiation", "Radiation", "person", "hazard", ["radiation"], "radiation_low.svg", { order: 120 }),
  se("overloaded", "Overloaded", "all", "reactor", ["heat", "actionRestriction"], "surge.svg", { managed: !0, modifierKey: "overloaded", order: 130 }),
  se("preparedInterrupt", "Prepared", "person", "tactical", ["reaction", "prepared"], "readied_action.svg", { manual: !1, managed: !0, order: 140 }),
  se("machineCritical", "Machine Critical", "machine", "damage", ["critical", "system"], "surge.svg", { manual: !1, managed: !0, order: 150 }),
  // Machine stability and movement.
  se("unstable", "Unstable", "machine", "stability", ["movement", "piloting", "knockdown"], "falling.svg", { order: 1e3 }),
  se("staggeredMechanical", "Staggered (Mechanical)", "machine", "stability", ["movement", "actionRestriction"], "falling.svg", { order: 1010 }),
  se("proneMechFall", "Prone (Mech Fall)", "battlemech", "stability", ["movement", "posture", "standUp"], "prone.svg", { order: 1020 }),
  se("skidding", "Skidding", "machine", "movement", ["forcedMovement", "tracking"], "falling.svg", { order: 1030 }),
  se("stalled", "Stalled", "machine", "movement", ["movement", "actionRestriction"], "emp.svg", { order: 1040 }),
  se("limping", "Limping", "machine", "movement", ["movement", "location"], "broken_leg.svg", { order: 1050 }),
  se("jumpJetFailure", "Jump Jet Failure", "battlemech", "movement", ["jump", "equipment"], "surge.svg", { order: 1060 }),
  // Machine weapons.
  se("weaponFailure", "Weapon Failure", "machine", "weapon", ["weapon", "mountScoped"], "broken_weapon.svg", { order: 1100 }),
  se("jammedBallistic", "Jammed (Ballistic)", "machine", "weapon", ["weapon", "ballistic", "clearAction"], "broken_weapon.svg", { order: 1110 }),
  se("armDestroyed", "Arm Destroyed", "battlemech", "damage", ["location", "weapon", "arm"], "dismembered_arm.svg", { order: 1120 }),
  // Sensors and electronics.
  se("sensorDegraded", "Sensor Degraded", "machine", "sensor", ["sensor", "perception"], "all-seeing-eye.webp", { order: 1200 }),
  se("sensorBlind", "Sensor Blind", "machine", "sensor", ["sensor", "targeting", "rangeLimit"], "damaged_eye.svg", { order: 1210 }),
  se("ecmJamming", "ECM Jamming", "machine", "electronicWarfare", ["ecm", "tracking"], "emp.svg", { order: 1220 }),
  se("ecmShrouded", "ECM Shrouded", "machine", "electronicWarfare", ["ecm", "defense"], "hidden.svg", { order: 1230 }),
  se("eccmBoosted", "ECCM Boosted", "machine", "electronicWarfare", ["eccm", "sensor"], "all-seeing-eye.webp", { order: 1240 }),
  se("sensorLocked", "Sensor Locked", "machine", "sensor", ["sensor", "targeted"], "all-seeing-eye.webp", { order: 1250 }),
  // Reactor and heat.
  se("reactorInstability", "Reactor Instability", "machine", "reactor", ["heat", "reactor", "escalating"], "surge.svg", { order: 1300 }),
  se("shutdown", "Shutdown", "machine", "reactor", ["heat", "actionRestriction"], "emp.svg", { order: 1310 }),
  se("overheating", "Overheating", "machine", "reactor", ["heat", "escalating"], "on_fire_mild.svg", { order: 1320 }),
  se("reactorBreach", "Reactor Breach", "machine", "reactor", ["reactor", "catastrophic", "countdown"], "radiation_high.svg", { order: 1330 }),
  // Machine damage and battlefield exposure.
  se("legDestroyed", "Leg Destroyed", "battlemech", "damage", ["location", "movement", "leg"], "dismembered_leg.svg", { order: 1400 }),
  se("exposed", "Exposed", "machine", "tactical", ["defense", "vulnerable"], "target.svg", { icon: `${rd}/falling.svg`, order: 1410 }),
  se("entrenchedHullDown", "Entrenched / Hull Down", "machine", "tactical", ["defense", "cover"], "cover.svg", { order: 1420 }),
  se("obscured", "Obscured (Smoke/Dust)", "machine", "visibility", ["visibility", "cover"], "hidden.svg", { order: 1430 }),
  // Tactical markers.
  se("evasiveWeave", "Evasive Weave", "machine", "tactical", ["defense", "attackPenalty", "selfInduced"], "falling.svg", { order: 1500 }),
  se("braced", "Braced", "machine", "tactical", ["defense", "mobilityPenalty"], "cover.svg", { order: 1510 }),
  se("overextended", "Overextended", "machine", "tactical", ["attack", "defensePenalty"], "surge.svg", { order: 1520 }),
  se("targetFocused", "Target Focused", "machine", "tactical", ["targeted", "attack"], "all-seeing-eye.webp", { order: 1530 }),
  se("suppressedMechanical", "Suppressed", "machine", "tactical", ["offense", "suppressed"], "suppressed.svg", { order: 1540 })
]);
function se(a, e, t, i, n, r, s = {}) {
  return {
    id: a,
    label: e,
    actorGroup: t,
...
function Qp(a) {
  return Yp() && typeof foundry.utils.deepClone == "function" ? foundry.utils.deepClone(a) : JSON.parse(JSON.stringify(a));
}
function jl(a, e = !1) {
  if (typeof a == "boolean") return a;
  const t = String(a ?? "").trim().toLowerCase();
...
function od(a, e = "person") {
  const i = String(a ?? "").trim().toLowerCase();
  return i === "battlemech" ? "battlemech" : Object.prototype.hasOwnProperty.call(yr, i) ? i : e;
}
function Xp(a) {
  return [...yr[od(a)] ?? []];
}
function Zp(a = {}, { strict: e = !1, index: t = 0 } = {}) {
  const i = [], n = `Row ${t + 1}`, r = String((a == null ? void 0 : a.id) ?? "").trim(), s = String((a == null ? void 0 : a.label) ?? "").trim(), o = String((a == null ? void 0 : a.actorGroup) ?? "person").trim(), l = od(o, ""), c = Xo((a == null ? void 0 : a.category) ?? "general") || "general", u = Zo(a == null ? void 0 : a.tags), d = String((a == null ? void 0 : a.icon) ?? "").trim(), m = String((a == null ? void 0 : a.modifierKey) ?? "").trim(), f = Number((a == null ? void 0 : a.order) ?? 0);
  if (r || i.push(`${n}: id cannot be blank.`), s || i.push(`${n}: label cannot be blank.`), (!l || o && !Object.prototype.hasOwnProperty.call(yr, l)) && i.push(`${n}: actorGroup must be one of ${Object.keys(yr).join(", ")}.`), m && !(Pa != null && Pa[m]) && i.push(`${n}: modifierKey "${m}" is not a known mechanics-backed status.`), Number.isFinite(f) || i.push(`${n}: order must be numeric.`), e && i.length) {
  ...
  return {
    ...
    tags: u,
    icon: d,
    manual: jl(a == null ? void 0 : a.manual, !0),
    managed: jl(a == null ? void 0 : a.managed, !1),
    modifierKey: m,
...
function Br(a = void 0) {
  var i, n;
  if (a !== void 0) return ra(a, { strict: !1 });
  const e = (i = globalThis.game) == null ? void 0 : i.settings, t = (n = e == null ? void 0 : e.get) == null ? void 0 : n.call(e, T, id);
  return ra(
    Array.isArray(t) ? t : sd(),
    { strict: !1 }
  );
}
function zr(a, e = Br()) {
...
function Fr(a, e = null) {
  const t = ld(e);
  return !t || !a ? !1 : Xp(a.actorGroup).includes(t);
}
function eh({ statusId: a = "", actor: e = null, metadata: t = {}, catalogEntry: i = null } = {}) {
  const n = i ?? zr(a), r = Zo((t == null ? void 0 : t.tags) ?? (n == null ? void 0 : n.tags) ?? []);
  return {
...
const ih = /* @__PURE__ */ new Set(["overloaded", "preparedInterrupt"]);
function Wl(a) {
...
function sa(a, e) {
  var t, i, n, r, s, o;
  return e === "overloaded" && cd(a) ? !!((i = (t = a == null ? void 0 : a.system) == null ? void 0 : t.burn) != null && i.overloaded) || !!((r = (n = a == null ? void 0 : a.statuses) == null ? void 0 : n.has) != null && r.call(n, e)) : ((o = (s = a == null ? void 0 : a.statuses) == null ? void 0 : s.has) == null ? void 0 : o.call(s, e)) ?? !1;
}
function oh(a, e) {
  const t = sa(e, a.id), i = dd(e, a.id) ?? {};
  return {
    id: a.id,
    label: a.label,
    icon: a.icon,
    active: t,
    managed: !!a.managed || ih.has(a.id),
    manual: !!a.manual,
    legacy: !1,
    category: a.category,
    tags: [...a.tags ?? []],
...
function lh(a, e) {
  const t = (CONFIG.statusEffects ?? []).find((n) => String((n == null ? void 0 : n.id) ?? "").trim() === a) ?? null, i = dd(e, a) ?? {};
  return {
    id: a,
    label: t ? nh(t) : el(a),
    icon: t ? rh(t) : "",
...
function tl(a) {
  const e = /* @__PURE__ */ new Set(), t = Br(), i = [];
  for (const n of t) {
    const r = String((n == null ? void 0 : n.id) ?? "").trim();
    if (!r || e.has(r)) continue;
    const s = sa(a, r), o = Fr(n, a);
    !s && (!o || !n.manual) || (e.add(r), i.push(oh(n, a)));
  }
  for (const n of Array.from((a == null ? void 0 : a.statuses) ?? [])) {
    const r = String(n ?? "").trim();
    !r || e.has(r) || (e.add(r), i.push(lh(r, a)));
  }
...
async function uh({ actor: a, effects: e, selectedStatusIds: t }) {
...
async function Ur({ actor: a, statusId: e, active: t, metadata: i = {} }) {
  if (!a || !e) return !1;
  const n = sa(a, e);
  if (!!t === n)
    return t ? Gl(a, e, i) : !1;
  const r = zr(e), s = r ? Fr(r, a) : !1;
  return t && r && !s ? !1 : e === "overloaded" && cd(a) ? (await a.update({ "system.burn.overloaded": !!t }), !0) : (await a.toggleStatusEffect(e, { active: !!t, overlay: !1 }), t && await Gl(a, e, i), !0);
}
function dh(a) {
  var i, n, r, s, o;
  ...
  for (const l of t) {
    ...
    if (!c) continue;
    const u = sh(c), d = !!((r = l.querySelector(`input[name="status.${u}.active"]`)) != null && r.checked), m = String(((s = l.querySelector(`input[name="status.${u}.scope"]`)) == null ? void 0 : s.value) ?? "").trim(), f = String(((o = l.querySelector(`input[name="status.${u}.notes"]`)) == null ? void 0 : o.value) ?? "").trim();
    e.set(c, {
      id: c,
      active: d,
...
async function md({ actor: a, token: e } = {}) {
  var n;
  if (!a || !e) return !1;
  const t = ah(a, e), i = tl(t);
    ...
    buttons: [
      {
        ...
        callback: async (r, s) => {
          ...
          try {
            const l = dh(s.form);
            return await uh({ actor: t, effects: i, selectedStatusIds: l }), !0;
          } catch (l) {
...
function mh() {
  typeof Hooks > "u" || Hooks.on("renderTokenHUD", (a, e, t = {}) => {
    ...
    if (!r) return;
    const s = Br(), o = new Map(s.map((g) => [g.id, g])), c = typeof jQuery < "u" && e instanceof jQuery ? e[0] : e;
    ...
    for (const g of u) {
      ...
      const b = o.get(y);
      if (!b) continue;
      !sa(r, y) && !Fr(b, r) && (g.hidden = !0, g.style.display = "none");
    }
  });
}
...
function yh(a) {
  return fh[String(a ?? "").trim().toUpperCase()] ?? null;
}
function bh(a) {
  return ph[String(a ?? "").trim().toUpperCase()] ?? String(a ?? "").trim().toUpperCase();
}
function Sh(a = []) {
...
]), Ah = new Set(al.map((a) => a.value)), Th = new Set(nl.map((a) => a.value)), wh = new Set(fd.map((a) => a.value)), vh = new Set(pd.map((a) => a.value)), yd = new Set(hd.map((a) => a.value)), kh = new Set(rl.map((a) => a.value)), Mh = new Set(gd.map((a) => a.value));
function me(a, e = "") {
  return String(a ?? "").trim() || e;
}
function Se(a, e = 0) {
...
function Eh(a = {}) {
  const e = a && typeof a == "object" ? a : {}, t = {
    id: me(e.id, foundry.utils.randomID()),
    fact: me(e.fact)
  }, i = rl.find((r) => e[r.value] !== void 0 && e[r.value] !== null), n = (i == null ? void 0 : i.value) ?? (kh.has(String(e.comparator ?? "").trim()) ? String(e.comparator).trim() : "eq");
  return t.comparator = n, n !== "truthy" && n !== "falsy" && (t.value = Ch(e[n] ?? e.value ?? "")), t;
}
function bi(a = []) {
  return (Array.isArray(a) ? a : []).map(Eh);
}
function Rh(a = {}) {
  const e = a && typeof a == "object" ? a : {}, t = vh.has(String(e.type ?? "").trim()) ? String(e.type).trim() : "rollMod", i = Ph(t), n = yd.has(String(e.phase ?? "").trim()) ? String(e.phase).trim() : i, r = Mh.has(String(e.operation ?? "").trim()) ? String(e.operation).trim() : "adjustAmount";
  return {
    id: me(e.id, foundry.utils.randomID()),
    type: t,
    phase: n,
    selector: me(e.selector),
    skillKeys: bd(e.skillKeys),
    label: me(e.label),
    value: Se(e.value, 0),
...
function Sd(a = {}) {
  const e = me(a == null ? void 0 : a.selector);
  return e === "intent.skill" || e.startsWith("intent.skill.");
}
function ji(a = []) {
  return (Array.isArray(a) ? a : []).map(Rh).filter((t) => t.phase && t.type);
}
function qt(a = {}) {
  const e = a && typeof a == "object" ? br(a) : {}, t = e.positive === !1 ? "negative" : "positive", i = Ah.has(String(e.category ?? "").trim()) ? String(e.category).trim() : t, n = Th.has(String(e.tier ?? "").trim()) ? String(e.tier).trim() : "minor", r = wh.has(String(e.activation ?? "").trim()) ? String(e.activation).trim() : "passive";
  return {
    ...e,
    positive: i === "positive",
    category: i,
...
function Td(a = {}) {
  var n, r, s;
  const e = me(a.combatId ?? ((n = a.combat) == null ? void 0 : n.id)), t = Math.max(0, Math.trunc(Se(a.round ?? ((r = a.combat) == null ? void 0 : r.round), 0))), i = me(a.sceneId ?? ((s = canvas == null ? void 0 : canvas.scene) == null ? void 0 : s.id));
  return {
    activationKey: me(a.activationKey),
    roundKey: e ? `${e}:${t}` : "",
    sceneKey: i
  };
}
...
function Lh(a, e, t, i) {
  ...
  for (const r of ["perActivation", "perRound", "perScene"]) {
    ...
    if (!s) continue;
    Oh(a, e, r, i) >= s && n.push(`${r} limit reached`);
  }
  return n;
}
function _h(a, e, t) {
...
function ql(a, e) {
  if (!me(a == null ? void 0 : a.fact)) return !0;
  const t = foundry.utils.getProperty(e, a.fact);
  return _h(t, a.comparator, a.value);
}
function xh(a = "", e = {}) {
  const t = me(a);
...
function Bh({ item: a, effect: e, phase: t, packet: i, result: n }) {
  switch (e.type) {
    case "rollMod": {
      const r = Se(e.value, 0);
      return ki(n.modifiers, a, e, r, t), r;
    }
    case "burnAdjust": {
      if (t === "onEndOfActivation") {
        const s = ga(i, "burnDelta", e);
        return ki(n.modifiers, a, e, s, t), s;
      }
    ...
    case "edgeEvent": {
      if (t === "onEndOfActivation" && e.operation === "grantPool" && e.pool)
        return i.edgeAdjustments ?? (i.edgeAdjustments = []), i.edgeAdjustments.push({
          ...
          source: a.name
        }), ki(n.modifiers, a, e, Se(e.value, 0), t), Se(e.value, 0);
      const r = ga(i, "amount", e);
      return ki(n.modifiers, a, e, r, t), r;
    }
    default:
...
function ma(a, e = {}) {
  var o, l, c, u, d;
  const t = e.snapshot ?? null, i = e.state ?? (t == null ? void 0 : t.state) ?? {}, n = Array.isArray(i == null ? void 0 : i.actionLog) ? i.actionLog.map((m) => me(m == null ? void 0 : m.id)).filter(Boolean) : [], r = (i == null ? void 0 : i.actionState) ?? {}, s = [];
...
function sl({ actor: a, resolved: e, payload: t, runtime: i = {} } = {}) {
  var d, m, f, p, h, g, y, b, A, w, v, R;
  const n = ma(a, i), r = me((e == null ? void 0 : e.intent) ?? (t == null ? void 0 : t.intent), "skill"), s = Array.isArray(e == null ? void 0 : e.domains) ? e.domains : [], o = me(((d = e == null ? void 0 : e.attack) == null ? void 0 : d.rangeBand) ?? (t == null ? void 0 : t.rangeBand)), l = me(((f = (m = t == null ? void 0 : t.edge) == null ? void 0 : m.pre) == null ? void 0 : f.poolKey) ?? ((p = t == null ? void 0 : t.edge) == null ? void 0 : p.poolKey) ?? ""), c = me(
    ...
    ((A = (b = (y = e == null ? void 0 : e.breakdown) == null ? void 0 : y.find) == null ? void 0 : b.call(y, (E) => (E == null ? void 0 : E.id) === "skill")) == null ? void 0 : A.label) ?? (e == null ? void 0 : e.title)
  );
  ...
  }, n.selectors.push(`intent.${r}`), s.forEach((E) => n.selectors.push(`domain.${E}`)), o && n.selectors.push(`range.${o}`), r === "skill" && c && n.selectors.push(`skill.${c}`), (R = t == null ? void 0 : t.toggles) != null && R.useEdge && n.selectors.push("edge.pre"), n;
}
function kd({ actor: a, packet: e = {}, runtime: t = {} } = {}) {
  const i = ma(a, t);
  return i.action = {
    id: me(e.actionId),
    category: me(e.category),
    resource: me(e.resource),
    cost: Se(e.cost, 0),
...
function Jn({ actor: a, packet: e = {}, runtime: t = {} } = {}) {
  const i = ma(a, t);
  return i.action = {
    id: me(e.actionId),
    category: me(e.category),
...
function Bt({ actor: a, phase: e, facts: t = {}, packet: i = {}, options: n = {} } = {}) {
  ...
  if (!a || !yd.has(String(e ?? "").trim()))
    return r;
  const s = n.runtime ?? {}, o = Dh(a, s), l = Td(s), c = Nh(a);
  for (const { item: d, system: m } of c) {
    ...
    const f = m.prerequisites.filter((p) => me(p == null ? void 0 : p.fact)).filter((p) => !ql(p, t));
    if (f.length) {
      r.skipped.push({
        traitItemId: d.id,
        traitEffectId: "",
    ...
    for (const p of m.effects.filter((h) => h.phase === e)) {
      ...
      if (Sd(p) && p.skillKeys.length) {
        const w = me((u = t == null ? void 0 : t.skill) == null ? void 0 : u.key);
      ...
      const h = p.conditions.filter((w) => me(w == null ? void 0 : w.fact)).filter((w) => !ql(w, t));
      if (h.length) {
        r.skipped.push({
          traitItemId: d.id,
          traitEffectId: p.id,
      ...
      const g = Ih(m.limits, p.limit), y = wd(d, p), b = Lh(o, l, g, y);
      if (b.length) {
        r.skipped.push({
          traitItemId: d.id,
          traitEffectId: p.id,
      ...
      r.applied.push({
        ...
        phase: e,
        source: d.name
      }), n.consumeUsage && r.mutations.push(...zh(d, p, g));
    }
  }
  return r;
}
async function Ai({ actor: a, mutations: e = [], runtime: t = {} } = {}) {
  ...
  if (!i.length) return;
  const n = br(((c = (l = (o = a.flags) == null ? void 0 : o[T]) == null ? void 0 : l.traitUsage) == null ? void 0 : c.scene) ?? {}), r = t.state ? br(t.state) : null, s = Td(t);
  for (const g of i) {
    const y = me(g.key), b = Math.max(0, Math.trunc(Se(g.delta, 0)));
    if (!(!y || !b))
      switch (g.scope) {
        case "perActivation": {
          if (!r) break;
...
]), Yl = new Set(Js.map((a) => a.value)), Ql = new Set(Pd.map((a) => a.value)), Nd = Object.freeze([
...
].map((a) => Object.freeze(Hr(a)))), Fh = new Map(Nd.map((a) => [a.id, a]));
function Hr(a) {
...
function Hh(a, { strict: e = !1, index: t = 0 } = {}) {
  const i = String((a == null ? void 0 : a.id) ?? "").trim(), n = Fh.get(i) ?? {}, r = `Row ${t + 1}`, s = [];
...
function Xn(a) {
  const e = String(a ?? "").trim();
  return Id().find((t) => t.id === e) ?? null;
}
function jh(a) {
  return Id().filter((e) => e.category === a).map((e) => Object.freeze(Hr(e)));
}
const ea = "hazard";
function Kh(a) {
...
function $i(a) {
  var n, r, s;
  const e = ((n = a == null ? void 0 : a.getFlag) == null ? void 0 : n.call(a, "mwd", ea)) ?? ((s = (r = a == null ? void 0 : a.flags) == null ? void 0 : r.mwd) == null ? void 0 : s[ea]) ?? null;
...
async function ps(a) {
  var i, n, r;
  const e = ((i = a == null ? void 0 : a.getFlag) == null ? void 0 : i.call(a, "mwd", ea)) ?? ((r = (n = a == null ? void 0 : a.flags) == null ? void 0 : n.mwd) == null ? void 0 : r[ea]) ?? null;
  if (!e || typeof e != "object") return null;
  if (e != null && e.templateGeometry) return $i(a);
  const t = $i(a);
  return !(t != null && t.templateGeometry) || !(a != null && a.setFlag) ? t : (await a.setFlag("mwd", ea, {
...
async function Gh({ attacker: a = null, attack: e = {}, targetResult: t = null } = {}) {
  ...
  const o = {
    ...
    label: `${String(((b = e == null ? void 0 : e.weapon) == null ? void 0 : b.name) ?? "Hazard").trim() || "Hazard"} (${Ft(((A = r.hazard) == null ? void 0 : A.startExposure) ?? "minor")})`,
    areaEffect: r,
    hazardDef: r.hazard
...
function Xl(a = null) {
  ...
  return Array.from(t.regions ?? []).filter(Wh).filter((c) => {
    var u, d, m;
...
function qh({ actor: a = null, token: e = null } = {}) {
  var r;
...
function ll(a = {}) {
  var c, u, d;
  const e = (a == null ? void 0 : a.preview) ?? {}, t = Ue(((c = a == null ? void 0 : a.exposure) == null ? void 0 : c.initialTier) ?? (a == null ? void 0 : a.exposureTier) ?? (a == null ? void 0 : a.tier), "none"), i = Ue(
  ...
  }), r = Math.max(0, Mi(a == null ? void 0 : a.baseDamage, 0)), s = Math.max(0, Mi(a == null ? void 0 : a.damageBefore, ia(r, n.initialTier))), o = Math.max(0, Mi(a == null ? void 0 : a.damageAfter, ia(r, n.finalTier))), l = (e == null ? void 0 : e.reactionPreview) ?? {};
  return {
    ...
    damageBefore: s,
    damageAfter: o,
    nextTier: Ue(a == null ? void 0 : a.nextTier, n.finalTier),
    ...
    preview: {
      ...
      edgePools: Vh(l == null ? void 0 : l.edgePools)
    }
  };
}
function Yh(a = {}, { actor: e = null, token: t = null } = {}) {
...
async function Dd(a = {}, { actor: e = null, token: t = null } = {}) {
  return foundry.applications.handlebars.renderTemplate(
    "mwd.v2.roll.mwd-hazard-card",
    Yh(a, { actor: e, token: t })
  );
}
const ft = "mwd", pt = "personalCombat", Wi = "preparedInterrupt", Jh = "systems/mwd/img/icons/status/readied_action.svg", Ei = 3, Xh = 1, Zh = 1;
function $n(a, e) {
...
function ya(a, e = null) {
  const t = Zn(a ?? {}, (a == null ? void 0 : a.activation) ?? e);
  return t.actionLog = cn(t.actionLog), t.hazards = Sr(t.hazards), t.pendingReaction = er(t.pendingReaction), t;
}
function Sr(a) {
...
function er(a) {
  ...
  return e ? {
    ...
    exposureBefore: Ue(a.exposureBefore, le.none),
    exposureAfterPreview: Ue(a.exposureAfterPreview, le.none),
...
function Zl(a = null, e = null) {
  const t = cl(e);
  return t.reactionBurnSinceLastActivation = Math.max(0, Number((a == null ? void 0 : a.reactionBurnSinceLastActivation) ?? 0) || 0), t.actionLog = eg(a == null ? void 0 : a.actionLog), t.hazards = Sr(a == null ? void 0 : a.hazards), t;
}
function tg(a, e) {
  return a === "free" ? "Free" : a === "burn" ? `+${e} Burn` : `${e} ${String(a).toUpperCase()}`;
}
function ig(a = {}, e = "", { snapshot: t = null, metadata: i = {} } = {}) {
  var s, o, l, c;
...
function ec() {
  return (CONFIG.statusEffects ?? []).find((a) => String((a == null ? void 0 : a.id) ?? "").trim() === Wi) ?? {
    id: Wi,
    name: "Prepared",
    icon: Jh
  };
...
const Ca = class Ca {
  ...
  static getCurrentSceneTokenDocument(e, t = null) {
    ...
    return m.find((b) => {
      var A, w, v;
      return ((A = b == null ? void 0 : b.combatant) == null ? void 0 : A.id) === ((v = (w = game.combat) == null ? void 0 : w.combatant) == null ? void 0 : v.id);
    }) ?? null ?? m[0] ?? null;
  }
  ...
  static getTargetingSnapshot(e = null, t = game.user) {
    ...
    const r = i[0], s = this._measureTokenDistance(e, r), o = String(((d = (u = canvas == null ? void 0 : canvas.scene) == null ? void 0 : u.grid) == null ? void 0 : d.units) ?? ((f = (m = game.system) == null ? void 0 : m.grid) == null ? void 0 : f.units) ?? "").trim(), l = sg(s, o), c = String((r == null ? void 0 : r.name) ?? ((p = r == null ? void 0 : r.actor) == null ? void 0 : p.name) ?? "Target").trim() || "Target";
    return {
      count: n,
      none: !1,
      single: !0,
  ...
  static getRollImpact(e = []) {
    const t = (Array.isArray(e) ? e : []).map((n) => {
      const r = rg((n == null ? void 0 : n.numericValue) ?? (n == null ? void 0 : n.value) ?? 0);
      return {
  ...
  static getCombat(e, t = null) {
    ...
    if (!u) {
      const g = this._collectActorIds(e, l), y = String((l == null ? void 0 : l.id) ?? "").trim(), b = d.filter((v) => {
        const R = this._getCombatantTokenId(v), E = this._getCombatantTokenDocument(v, i), x = R || String((E == null ? void 0 : E.id) ?? "").trim();
        return o && y ? x === y : g.has(this._getCombatantActorId(v)) ? !0 : this._tokenDocumentMatchesActor(E, e, g);
      }), A = b.find((v) => {
        var R;
        return v.id === ((R = n == null ? void 0 : n.combatant) == null ? void 0 : R.id);
      }) ?? null;
      u = b.find(
        (v) => {
          var R;
          return y && (this._getCombatantTokenId(v) || String(((R = this._getCombatantTokenDocument(v, i)) == null ? void 0 : R.id) ?? "").trim()) === y;
        }
      ) ?? null ?? A ?? b[0] ?? null;
    }
  ...
  static getSnapshot(e, { token: t = null } = {}) {
    ...
    const {
      ...
      token: r,
      tokenDocument: s
    } = this.getCombat(e, t), o = !!n && ((E = i == null ? void 0 : i.combatant) == null ? void 0 : E.id) === n.id, l = n ? this.getActivationIdentity(i, n) : null, c = n ? n.getFlag(ft, pt) : null, u = n ? o ? $n(c, l) ? ya(c, l) : Zl(c, l) : ya(c, l) : cl(l);
    u.actionLog = cn(u.actionLog);
    const d = Math.max(0, Number(((K = (x = e == null ? void 0 : e.system) == null ? void 0 : x.burn) == null ? void 0 : K.value) ?? 0)), m = Math.floor(d / 2), f = !!((H = (q = e == null ? void 0 : e.system) == null ? void 0 : q.burn) != null && H.overloaded), p = Ya(u), h = this.getActiveStatuses(e), g = h.filter(
      (W) => !(f && W.id === "overloaded") && W.id !== Wi
    ), y = this.getModifierSummary(e, m), b = this.getRollImpact(y), A = Math.max(0, Number(u.burnThisActivation ?? 0)), w = n ? o ? "" : "Waiting for this combatant's activation." : "No combatant on the current scene.", v = [];
    f && v.push({ id: "overloaded", label: "Overloaded" }), p && v.push({
      id: "preparedInterrupt",
      label: "Prepared",
      hint: ag(p)
    });
    const R = Object.entries(u.hazards ?? {});
    if (R.length) {
      const W = R.map(([, _]) => _).sort((_, F) => Li(F == null ? void 0 : F.tier) - Li(_ == null ? void 0 : _.tier))[0] ?? null;
      W && v.push({
        id: "hazard",
        label: `Hazard ${Ft(W.tier)}`,
        hint: `${R.length} active hazard${R.length === 1 ? "" : "s"}`
      });
    }
    return {
      token: r,
  ...
  static async commitReactionSpend(e, {
    ...
    if (c.usesReaction)
      ...
      const w = c.edgePoolKey ? 0 : 2, v = Bt({
        actor: e,
    ...
    }), (y = m.pendingMutations) != null && y.length ? await Ai({ actor: e, mutations: m.pendingMutations, runtime: m }) : await u.combatant.setFlag(ft, pt, d), f > 0 && await e.update({ "system.burn.value": Math.max(0, Number(((A = (b = e.system) == null ? void 0 : b.burn) == null ? void 0 : A.value) ?? 0) + f) }), {
      ok: !0,
  ...
  static async setPendingReaction(e, { token: t = null, pendingReaction: i = null } = {}) {
    return this.updateCombatantState(e, {
      token: t,
      mutate: (n) => (n.pendingReaction = er(i), n)
    });
  }
  ...
  static async setHazardState(e, { token: t = null, regionId: i = "", hazardState: n = null } = {}) {
    ...
    return r ? this.updateCombatantState(e, {
      token: t,
      mutate: (s) => (s.hazards ?? (s.hazards = {}), n ? s.hazards[r] = Sr({ [r]: n })[r] : delete s.hazards[r], s)
  ...
  static buildActionModel(e, t) {
    ...
    const i = (d) => {
      ...
      const m = jh(d).filter((f) => f.id !== "overloadCheck").filter((f) => !(d === xe.recovery && f.id === "reduceBurn"));
      if (d === xe.standard) {
  ...
  static _buildCatalogAction(e, t, i) {
    const n = t.hasCombatant ? "" : "No current-scene combatant.", r = t.isCurrentTurn ? "" : "Only during your activation.", s = t.overloaded ? "Overloaded actors can only recover Burn." : "", o = Bn(e, t), l = t.state ?? {}, c = i.category;
    let u = "sa", d = Number(i.cost ?? 0) || 0, m = tg(u, d), f = "";
    if (i.id === "reduceBurn")
      ...
      const p = er(l.pendingReaction), h = t.isCurrentTurn && !(p != null && p.allowCurrentTurn) ? "Only outside your activation." : "";
  ...
  static async _executeReactionAction(e, { token: t = null, action: i, metadata: n = {} } = {}) {
    ...
    const r = this.getSnapshot(e, { token: t });
    if (!r.hasCombatant) return { ok: !1, reason: "No combatant on the current scene." };
    const s = er((d = r.state) == null ? void 0 : d.pendingReaction), o = i.id === "evade" && (s == null ? void 0 : s.allowCurrentTurn);
  ...
  static async _syncPreparedIndicatorForCombatant(e) {
    ...
    if (!i || !n) return;
    const r = e.getFlag(ft, pt), s = !!Ya(r), o = ec(), l = String((o == null ? void 0 : o.id) ?? Wi).trim() || Wi;
  ...
  static async clearPreparedIndicatorForCombatant(e) {
    ...
    if (!i || !n) return;
    const r = ec(), s = String((r == null ? void 0 : r.id) ?? Wi).trim() || Wi;
  ...
  static async ensureCurrentCombatantState() {
    ...
    $n(n, i) || await t.setFlag(ft, pt, Zl(n, i));
  }
  static async spendResource(e, {
    ...
    const u = {
      ...
      state: Zn(c.state, this.getActivationIdentity(c.combat, c.combatant)),
    ...
    const h = u.state, g = i === "sa" ? Xs(e) : 0, y = Math.max(0, Number(((v = c.state) == null ? void 0 : v.saSpentThisActivation) ?? 0) || 0);
    if (i === "sa" && y + d > g)
      return { ok: !1, reason: "Activation SA cap reached." };
    ...
    let b = 0;
    if (i === "sa") {
      const q = Math.max(0, y - Ei), H = Math.max(0, h.saSpentThisActivation - Ei), W = Math.max(0, Number(((R = c.state) == null ? void 0 : R.attacksThisActivation) ?? 0) || 0), _ = Math.max(0, Number(h.attacksThisActivation ?? 0) || 0);
      for (let F = q + 1; F <= H; F += 1) {
        const V = Bt({
          actor: e,
          phase: "onBeforeBurnApplied",
          facts: Jn({
  ...
  static async reduceBurn(e, { token: t = null } = {}) {
    ...
    if (Bn(e, i) <= 0) return { ok: !1, reason: "Activation SA cap reached." };
  ...
  static async finalizeActivation(e, t) {
    ...
    if (!i || !n) return;
    const r = i.getFlag(ft, pt), s = $n(r, this.getActivationIdentity(e, i)) ? Zn(r, this.getActivationIdentity(e, i)) : Zn(r), l = {
      ...
      facts: Ed({ actor: n, packet: l, runtime: c }),
      packet: l,
    ...
    if (d) {
      ...
      w === 0 && ((A = (b = n.system) == null ? void 0 : b.burn) != null && A.overloaded) && (v["system.burn.overloaded"] = !1), await n.update(v);
    }
  ...
  static async _onUpdateCombat(e, t) {
    if (Object.prototype.hasOwnProperty.call(t ?? {}, "turn") || Object.prototype.hasOwnProperty.call(t ?? {}, "round")) {
      const n = this._lastActivationByCombat.get(e == null ? void 0 : e.id) ?? null, r = typeof n == "string" ? n : (n == null ? void 0 : n.combatantId) ?? null, s = this.getActivationIdentity(e, e == null ? void 0 : e.combatant), o = n && typeof n == "object" ? !$n(n, s) : r && r !== s.combatantId;
  ...
  static async _syncHazardPresenceForToken(e) {
    ...
    await this.updateCombatantState(i, {
      ...
      mutate: (h) => {
        var g, y, b, A, w;
        h.hazards ?? (h.hazards = {});
        for (const [v, { flag: R }] of s.entries()) {
          if (h.hazards[v]) continue;
          const E = {
            tier: Ue((g = R == null ? void 0 : R.hazardDef) == null ? void 0 : g.startExposure, le.minor),
            turnsExposed: 0,
            evadeLocked: !1,
            lastProcessedRound: 0
          };
          h.hazards[v] = E, o.push({ regionId: v, flag: R, hazardState: E });
        }
        for (const [v, R] of Object.entries(h.hazards ?? {})) {
          if (s.has(v)) continue;
          const E = $i((A = (b = (y = canvas == null ? void 0 : canvas.scene) == null ? void 0 : y.regions) == null ? void 0 : b.get) == null ? void 0 : A.call(b, v)) ?? null;
          ((w = E == null ? void 0 : E.hazardDef) == null ? void 0 : w.clearOnExit) !== !1 && (delete h.hazards[v], l.push({ regionId: v, hazardState: R, flag: E }));
        }
        return h;
      }
    });
  ...
  static _getHazardNextTier(e = {}, t = {}) {
    ...
    if (!(r > 0 && (i + 1) % n === 0)) return Ue(e == null ? void 0 : e.tier, le.none);
    let o = Ue(e == null ? void 0 : e.tier, le.none);
    for (let m = 0; m < r; m += 1)
      if (o = qf(o, 1), Li(o) >= Li(((u = t == null ? void 0 : t.escalation) == null ? void 0 : u.max) ?? le.full)) {
        o = Ue((d = t == null ? void 0 : t.escalation) == null ? void 0 : d.max, le.full);
        break;
      }
    return o;
  }
  static async _createHazardEventChatCard({
    ...
    var h, g, y;
    if (!e) return null;
    const c = Ue(r == null ? void 0 : r.tier, le.none), u = Ue(o, c), d = l && c !== le.none && !(r != null && r.evadeLocked) ? this.getReactionSpendPreview(e, { token: t }) : null, m = {
      kind: "hazard",
      eventType: s,
      ...
      damageBefore: ia(Number((n == null ? void 0 : n.damage) ?? 0) || 0, c),
      damageAfter: ia(
    ...
    }, f = await Dd(m, { actor: e, token: t }), p = await ChatMessage.create(ic({
  ...
  static _refreshHazardOverlay(e) {
    ...
    if (!t || !i) return;
    const n = (i == null ? void 0 : i.actor) ?? null, r = n ? this.getSnapshot(n, { token: i }) : null, s = Object.values((r == null ? void 0 : r.hazards) ?? {}), o = og(s);
...
]), lg = new Map(Zs.map((a) => [a.key, a]));
function zn(a, e) {
  const t = Number(a);
  return !Number.isFinite(t) || t <= 0 ? e : Math.max(0, Math.trunc(t));
}
function jr(a = "") {
  return lg.get(String(a ?? "").trim().toLowerCase()) ?? null;
}
function Ar(a = "") {
...
function ul(a = {}) {
  return {
    ...
    close: zn((a == null ? void 0 : a.close) ?? (a == null ? void 0 : a.short), 5),
    near: zn((a == null ? void 0 : a.near) ?? (a == null ? void 0 : a.medium), 26),
    far: zn((a == null ? void 0 : a.far) ?? (a == null ? void 0 : a.long), 62),
    extreme: zn(a == null ? void 0 : a.extreme, 120)
  };
}
function ug(a, e = {}, t = "close") {
  var u;
  const i = Number(a);
  if (!Number.isFinite(i) || i < 0)
    return String(t ?? "close").trim().toLowerCase() || "close";
  const n = ul(e), r = ((u = jr(n.max)) == null ? void 0 : u.key) ?? "extreme", s = Zs.findIndex((d) => d.key === r), o = Number((n == null ? void 0 : n[r]) ?? NaN);
...
const Na = "lifeModuleCatalog", Wr = Object.freeze([
  ...
  Object.fromEntries(Wr.map((a) => [a.moduleType, a.label]))
), mg = new Set(Wr.map((a) => a.moduleType)), fg = /* @__PURE__ */ new Set(["skill", "edgePool"]), dl = Object.freeze({
  grit: "Grit",
  chaos: "Chaos",
  insight: "Insight",
  rumor: "Rumor",
  legend: "Legend",
  credibility: "Credibility"
}), Od = Object.freeze(Object.keys(dl)), pg = Object.freeze({
  skill: "Skill",
  edgePool: "Edge Pool"
}), hg = Object.freeze(Tg()), gg = Object.freeze(wg()), yg = /* @__PURE__ */ new Set(["artillery", "gunnery", "piloting", "heavyWeapons"]), bg = /* @__PURE__ */ new Set([
  "artillery",
  "gunnery",
  "heavyWeapons",
  "meleeCombat",
  ...
  di.map((a) => a.code).filter((a) => !bg.has(a))
), Ag = Object.freeze(fa([
  {
  ...
  },
  {
    ...
    grants: [{
      id: "choice",
      choices: [
        ...Sg.map((a) => ({ type: "skill", value: a })),
        ...Od.map((a) => ({ type: "edgePool", value: a }))
      ]
    }]
  },
  ...
  },
  {
    ...
    label: "Vagabond",
    moduleType: "realLife",
    skillChoices: di.map((a) => a.code).filter((a) => !yg.has(a)),
    excludesAny: [
      "higher-education-military-enlistment",
      "higher-education-military-academy",
      "higher-education-family-training",
...
function qr(a) {
  const e = String(a ?? "").trim();
  return e ? hg.get(e.toLowerCase()) ?? "" : "";
}
function kg(a) {
  const e = String(a ?? "").trim();
  return e ? gg.get(e.toLowerCase()) ?? "" : "";
}
function Mg(a, { strict: e = !1, errors: t = [], prefix: i = "Entry" } = {}) {
...
function ac(a) {
  const e = /* @__PURE__ */ new Set();
  return Ld(a).map(Nn).filter((t) => !t || e.has(t) ? !1 : (e.add(t), !0));
}
...
function Ng(a, { strict: e = !1, errors: t = [], prefix: i = "Entry", grantLabel: n = "Bonus" } = {}) {
  const r = typeof a == "string" ? Pg(a) : a, s = String((r == null ? void 0 : r.type) ?? "").trim(), o = String((r == null ? void 0 : r.value) ?? "").trim();
  if (!fg.has(s))
    return e && t.push(`${i} ${n}: unknown bonus type "${s || a}".`), null;
  const l = s === "skill" ? qr(o) : kg(o);
  return l ? {
    type: s,
    value: l
...
function eo(a, { strict: e = !1, errors: t = [], prefix: i = "Entry", grantLabel: n = "Bonus" } = {}) {
  ...
  for (const l of o) {
    const c = Ng(l, { strict: e, errors: t, prefix: i, grantLabel: n });
    if (!c) continue;
    const u = $a(c);
...
function xd(a, { strict: e = !1, errors: t = [], prefix: i = "Entry" } = {}) {
  const n = Mg(a, { strict: e, errors: t, prefix: i });
  return n.length ? [{
    id: "skill",
    label: "",
...
function Ig(a, { strict: e = !1, errors: t = [], prefix: i = "Entry" } = {}) {
...
function $d(a, e = "grant") {
  return Nn(a) || e;
}
function Dg(a, e, { strict: t = !1, errors: i = [], prefix: n = "Entry" } = {}) {
  ...
  const o = $d(a == null ? void 0 : a.id, r), l = String((a == null ? void 0 : a.label) ?? "").trim(), c = eo(a == null ? void 0 : a.choices, { strict: t, errors: i, prefix: n, grantLabel: s });
...
function Og(a, { strict: e = !1, errors: t = [], prefix: i = "Entry" } = {}) {
  if (Array.isArray(a)) {
    if (a.every((r) => typeof r == "string" && !String(r).includes(":")))
      return xd(a, { strict: e, errors: t, prefix: i });
    const n = /* @__PURE__ */ new Set();
    return a.map((r, s) => Dg(r, s, { strict: e, errors: t, prefix: i })).filter((r) => r ? n.has(r.id) ? (e && t.push(`${i}: duplicate bonus id "${r.id}".`), !1) : (n.add(r.id), !0) : !1);
  }
  return typeof a == "string" ? Ig(a, { strict: e, errors: t, prefix: i }) : [];
}
function Lg(a = []) {
...
function ml() {
  return foundry.utils.deepClone(Ag);
}
function Ba(a) {
  return dg[a] ?? (String(a ?? "").trim() || "Life Module");
}
function Bd() {
  return Wr.map((a) => ({
    value: a.moduleType,
...
function fa(a = [], { strict: e = !1 } = {}) {
  const t = Array.isArray(a) ? a : [], i = [], n = /* @__PURE__ */ new Set(), r = t.map((o, l) => {
    const c = `Entry ${l + 1}`, u = String((o == null ? void 0 : o.label) ?? "").trim(), d = Nn((o == null ? void 0 : o.id) ?? u), m = Gr(o == null ? void 0 : o.moduleType), f = (o == null ? void 0 : o.grants) != null ? Og(o.grants, { strict: e, errors: i, prefix: c }) : xd(o == null ? void 0 : o.skillChoices, { strict: e, errors: i, prefix: c }), p = ac(o == null ? void 0 : o.requiresAny), h = ac(o == null ? void 0 : o.excludesAny);
...
async function _g() {
  ...
  try {
    ...
    const i = game.settings.get(T, Na), n = zd(i);
...
function xg() {
  ...
  try {
    if ((t = (e = (a = game == null ? void 0 : game.settings) == null ? void 0 : a.settings) == null ? void 0 : e.has) != null && t.call(e, `${T}.${Na}`))
      return zd(game.settings.get(T, Na));
  } catch {
  }
  return ml();
}
function Vr() {
  return fa(xg(), { strict: !1 });
}
function xi(a) {
  const e = Nn(a);
  return e ? Vr().find((t) => t.id === e) ?? null : null;
}
function fl(a) {
  const e = Gr(a);
  return Vr().filter((t) => t.moduleType === e);
}
function Fd(a) {
  return !a || typeof a != "object" || Array.isArray(a) ? {} : Object.fromEntries(
    Object.entries(a).map(([e, t]) => [$d(e, ""), String(t ?? "").trim()]).filter(([e]) => !!e)
  );
}
function Ud(a, e = "", { legacySelectedSkill: t = "" } = {}) {
  ...
  if (i.has(n)) return n;
  if (t) {
    const r = qr(t), s = r ? `skill:${r}` : "";
    if (s && i.has(s)) return s;
  }
  return i.size === 1 ? Array.from(i)[0] : "";
}
function Hd(a, e = {}, { legacySelectedSkill: t = "" } = {}) {
  const i = Array.isArray(a == null ? void 0 : a.grants) ? a.grants : [], n = Fd(e);
  return Object.fromEntries(
    i.map((r) => [
      r.id,
      Ud(r, n[r.id], { legacySelectedSkill: t })
    ])
  );
}
function Yr(a, e = {}, { legacySelectedSkill: t = "" } = {}) {
  const i = Array.isArray(a == null ? void 0 : a.grants) ? a.grants : [], n = Hd(a, e, { legacySelectedSkill: t });
  return i.map((r, s) => {
    const o = Ud(r, n[r.id], { legacySelectedSkill: t }), l = (Array.isArray(r.choices) ? r.choices : []).find((c) => $a(c) === o) ?? null;
    return {
      id: r.id,
      index: s,
...
function $g(a, e = {}, { legacySelectedSkill: t = "" } = {}) {
  var i;
  return ((i = Yr(a, e, { legacySelectedSkill: t }).map((n) => n.choice).find((n) => (n == null ? void 0 : n.type) === "skill")) == null ? void 0 : i.value) ?? "";
}
function yn(a = {}) {
  const e = foundry.utils.deepClone(a ?? {}), t = Nn(e.catalogId), i = t ? xi(t) : null, n = Gr(e.moduleType || (i == null ? void 0 : i.moduleType)), r = i ? Hd(i, e.selectedGrants, { legacySelectedSkill: e.selectedSkill }) : Fd(e.selectedGrants);
  return e.moduleType = n, e.catalogId = t, e.selectedGrants = r, e.selectedSkill = i ? $g(i, r, { legacySelectedSkill: e.selectedSkill }) : qr(e.selectedSkill), e;
}
function jd(a, e = {}, { legacySelectedSkill: t = "" } = {}) {
  return Yr(a, e, { legacySelectedSkill: t }).map((i) => {
    var l, c;
...
function zg(a, e = [], t = {}) {
  ...
  return e.filter((o) => (o == null ? void 0 : o.type) === "edgePool").map((o) => {
    var p, h, g, y;
    const l = String(o.value ?? "").trim(), c = _d(l), u = Math.max(0, Number(((y = (g = (h = (p = a.system) == null ? void 0 : p.counters) == null ? void 0 : h.edgePools) == null ? void 0 : g[l]) == null ? void 0 : y.rating) ?? 0)), d = Math.max(0, Number((t == null ? void 0 : t[l]) ?? 0)), m = Math.max(0, u + d - i);
    return m ? `${c} Pool bonus loses ${m} ${m === 1 ? "point" : "points"} to the Edge cap.` : "";
  }).filter(Boolean);
}
function Bi(a) {
  var m;
  const e = Vr(), t = new Map(e.map((f) => [f.id, f])), i = Array.from((a == null ? void 0 : a.items) ?? []).filter((f) => f.type === S.itemType.lifeModule), n = /* @__PURE__ */ new Map();
  for (const f of i) {
    const p = Gr((m = f.system) == null ? void 0 : m.moduleType);
    !p || n.has(p) || n.set(p, f.id);
  }
  const r = i.map((f) => {
    var v;
    const p = yn(f.system ?? {}), h = t.get(p.catalogId) ?? null, g = p.moduleType || (h == null ? void 0 : h.moduleType) || "", y = h ? Yr(h, p.selectedGrants, { legacySelectedSkill: p.selectedSkill }) : [], b = y.map((R) => R.choice).filter(Boolean), A = ((v = b.find((R) => R.type === "skill")) == null ? void 0 : v.value) ?? "", w = A ? Dt(A) : null;
    return {
      item: f,
      itemId: f.id,
      moduleType: g,
      ...
      resolvedGrants: y,
      unresolvedGrantCount: y.filter((R) => !R.isResolved).length,
      selectedChoices: b,
      selectedChoiceLabels: b.map((R) => gn(R, { includeBonusText: !0 })),
      selectedSkill: A,
  ...
  const l = Object.fromEntries(di.map((f) => [f.code, 0])), c = Object.fromEntries(Od.map((f) => [f, 0])), u = /* @__PURE__ */ new Map();
  for (const f of r) {
    ...
    f.inactiveReason = f.isActive ? "" : Bg(f, t), u.set(f.itemId, f);
  }
  for (const f of r)
    f.warningLabels = f.isActive ? zg(a, f.selectedChoices, c) : [];
  const d = Wr.map((f) => {
...
function Ug({ actor: a, resolved: e } = {}) {
  const t = Fg(e);
...
function Wd(a = Qr, e = "", t = "", i = /* @__PURE__ */ new Set()) {
  var c;
  const n = String(t ?? "").trim();
  if (!n || i.has(n)) return {};
  const r = Kd(e, a), s = (c = r == null ? void 0 : r.templates) == null ? void 0 : c[n];
  if (!bn(s)) return {};
  i.add(n);
  let o = {};
...
function Kg(a = Qr, e = "", t = "") {
  const i = String(t ?? "").trim();
  if (!i) return {};
  const n = Kd(e, a), r = n == null ? void 0 : n[i];
  if (!bn(r)) return {};
  let s = {};
...
function Wg(a = "", e = "", t = Qr) {
  const i = Kg(t, a, e), n = rc[a] ?? rc.Item, r = { system: {} };
  for (const [s, o] of Object.entries(i))
    n.has(s) ? r[s] = za(o) : r.system[s] = za(o);
  return r;
}
async function Gd(a = "", e = "") {
  return Wg(a, e);
}
...
function Vg(a) {
  return Object.prototype.hasOwnProperty.call(qd, a);
}
const oa = Object.freeze(["close", "near", "far", "extreme"]), sc = Object.freeze({
...
function Yd(a) {
  return a === "long" ? "extreme" : a === "short" ? "close" : a === "medium" ? "near" : oa.includes(a) ? a : "near";
}
function Ta(a) {
  const e = ul(a);
  return e.max = Yd(e.max ?? (a == null ? void 0 : a.max) ?? "extreme"), e;
}
function gs(a) {
  return {
    close: Number((a == null ? void 0 : a.close) ?? (a == null ? void 0 : a.short) ?? 0) || 0,
...
function Jg(a) {
  ...
  return e >= 0 ? e : oa.indexOf("near");
}
function Xg(a = Ta({})) {
  const e = ["near", "close", "far", "extreme"], t = Jg(a.max);
  return e.find((i) => oa.indexOf(i) <= t) ?? "close";
}
function Zg(a) {
  const e = Yd(a == null ? void 0 : a.max), t = oa.indexOf(e);
  return oa.map((i, n) => ({
    key: i,
    allowed: t >= 0 ? n <= t : n === 0,
...
const ht = class ht extends Item {
  static init() {
    j(this, vn) || (Pe(this, vn, !0), Hooks.on("createItem", (e, t, i) => {
      var n, r;
      Promise.resolve((n = e.onCreateItem) == null ? void 0 : n.call(e, t, i)).catch((s) => {
        console.error(`${Ce}Item create hook failed`, s);
      ...
      var t;
      C(t = ht, Vt, Qd).call(t, e);
    }), Hooks.on("createActiveEffect", (e) => {
      var t;
      C(t = ht, Vt, tr).call(t, e);
  ...
  async _preCreate(e, t, i) {
    ...
    const n = (e == null ? void 0 : e.type) ?? this.type, r = this.constructor.canonicalType(n), s = {}, o = await Gd("Item", r);
    ...
    )), n !== r && Vg(n) && (s.type = r), ay((e == null ? void 0 : e.img) ?? this.img)) {
      const l = this.constructor.defaultIconForType(r);
      l && (s.img = l);
    }
    if (r === S.itemType.lifeModule && (!(e != null && e.name) || e.name === "DOCUMENT.Item") && (s.name = "MWD.itemType.singular.lifeModule"), r === S.itemType.lifeModule) {
  ...
  async _preUpdate(e, t, i) {
    ...
    if (n && this.isPersonalWeapon()) {
      ...
      ), e.system.traits = d.traits, e.system.keywords = d.keywords, e.system.resolution = qn(n.resolution, "standard"), e.system.fireModes = Vn(n.fireModes), e.system.attackRatingBand = gs(n.attackRatingBand), e.system.range = Ta(n.range), e.system.damageType = Yt(n.damageType), e.system.ammo = Qa();
    }
    if (n && this.isArmor() && (e.system ?? (e.system = {}), e.system.mitigationByType = li(n.mitigationByType ?? n.mitigation), e.system.tags = Gn(n.tags), e.system.traits = Ja(n.traits), e.system.standardTraits = hi(n.standardTraits), e.system.traitState = us({
  ...
  prepareBaseData() {
    ...
    e === S.itemType.personalWeapon ? this._preparePersonalWeaponBaseData() : e === S.itemType.armor ? this._prepareArmorBaseData() : e === S.itemType.lifeModule ? this._prepareLifeModuleBaseData() : e === S.itemType.quality ? this._prepareQualityBaseData() : [S.itemType.gear, S.itemType.consumable].includes(e) && this._prepareGearBaseData();
  }
  ...
  _prepareArmorBaseData() {
    ...
    ), e.standardTraits = hi(e.standardTraits), e.tags = Gn(e.tags), e.traits = Ja(e.traits), e.traitState = us({
  ...
  isConsumable() {
    return this.canonicalType === S.itemType.consumable;
  }
  ...
  async syncEquippedActorEffects({ actor: e = this.actor } = {}) {
    ...
    for (const g of i) {
      const b = (n.get(g.id) ?? [])[0] ?? null, A = this._prepareSyncedActorEffectData(g);
      b ? s.push({ _id: b.id, ...A }) : r.push(A);
    }
  ...
  async _mutateModifiers(e = (t) => t) {
    ...
    de.reindexIds(t), await this.update({ "system.modifiers": t });
  }
  ...
  async createQualityEffect(e = {}) {
    await this._mutateQualitySystem((t) => (t.effects = ji(t.effects).concat([{
      id: e.id ?? foundry.utils.randomID(),
      type: e.type ?? "rollMod",
  ...
  async deleteQualityEffectCondition(e, t) {
    await this._mutateQualitySystem((i) => (i.effects = ji(i.effects).map((n) => (n.id !== e || (n.conditions = bi(n.conditions).filter((r) => r.id !== t)), n)), i));
  }
  async updateQualityEffectCondition(e, t, i, n) {
    await this._mutateQualitySystem((r) => (r.effects = ji(r.effects).map((s) => (s.id !== e || (s.conditions = bi(s.conditions).map((o) => (o.id !== t || (i === "fact" && (o.fact = n), i === "comparator" && (o.comparator = n), i === "value" && (o.value = n)), o))), s)), r));
  }
  async _mutateWeaponStandardTraits(e = (t) => t) {
    var i;
    const t = e(foundry.utils.deepClone(Ki((i = this.system) == null ? void 0 : i.standardTraits)));
    await this.update({ "system.standardTraits": Ki(t) });
  }
  ...
  async _mutatePayloads(e = (t) => t) {
    ...
    )).map(Rt), i = Aa((l = this.system) == null ? void 0 : l.selectedPayloadId, t, {
  ...
  async updatePayloadField(e, t, i) {
    String(e ?? "").trim() !== "unloaded" && await this._mutatePayloads((n) => n.map((r) => r.id !== e ? r : (Qg(r, t) && foundry.utils.setProperty(r, t, i), Rt(r))));
  }
  async createPayload(e = {}) {
    await this._mutatePayloads((t) => t.concat([Rt({
      id: e.id ?? foundry.utils.randomID(),
  ...
  async createPayloadStandardTrait(e, t = {}) {
    String(e ?? "").trim() !== "unloaded" && await this._mutatePayloads((i) => i.map((n) => n.id !== e ? n : (n.modifies ?? (n.modifies = {}), n.modifies.standardTraits = Ki(n.modifies.standardTraits).concat([{
      id: t.id ?? foundry.utils.randomID(),
  ...
  async deletePayloadStandardTrait(e, t) {
    String(e ?? "").trim() !== "unloaded" && await this._mutatePayloads((i) => i.map((n) => n.id !== e ? n : (n.modifies ?? (n.modifies = {}), n.modifies.standardTraits = Ki(n.modifies.standardTraits).filter((r) => r.id !== t), Rt(n))));
  }
  async updatePayloadStandardTrait(e, t, i, n) {
    String(e ?? "").trim() !== "unloaded" && await this._mutatePayloads((r) => r.map((s) => s.id !== e ? s : (s.modifies ?? (s.modifies = {}), s.modifies.standardTraits = Ki(s.modifies.standardTraits).map((o) => (o.id !== t || (i === "key" && (o.key = n), i === "rating" && (o.rating = Math.max(0, Number(n ?? 0) || 0))), o)), Rt(s))));
  }
  ...
  async deleteConsumptionSource(e) {
    await this._mutateConsumptionSources((t) => t.filter((i) => i.id !== e)), await this._mutatePayloads((t) => t.map((i) => {
      var n;
      return ((n = i == null ? void 0 : i.consumption) == null ? void 0 : n.sourceId) !== e ? i : (i.consumption.sourceId = "", Rt(i));
    }));
  }
  ...
  getCombatProfile({ payloadId: e = "", ammoTypeId: t = "" } = {}) {
    ...
    const i = this.system ?? {}, n = Ta(i.range), r = String(i.skill ?? "").trim(), s = Dt(r), o = Number(i.damage ?? 0) || 0, l = String(i.category ?? i.weaponCategory ?? "ranged").trim() || "ranged", c = kp({
      damageType: i.damageType,
      ap: Number(i.ap ?? i.armorPiercing ?? 0) || 0,
      attackRatingBand: gs(i.attackRatingBand),
      traits: Ja(i.traits),
      keywords: dp(i.keywords),
      standardTraits: [],
      resolution: qn(i.resolution, "standard"),
  ...
  getArmorProfile({ actor: e = this.actor } = {}) {
    ...
    }), c = Gn(t == null ? void 0 : t.tags), u = qo(s);
    return {
      id: this.id ?? "armor",
      uuid: this.uuid ?? null,
      ...
      baseMitigation: u,
      baseResistance: u,
      mitigationByType: Gu(o, l.mitigationByType),
      tags: c,
      isDestroyed: r <= 0,
      durability: {
        current: r,
  ...
  getDefense() {
    if (!this.isPersonalWeapon())
      return this.system.defense ? ze.fixedDefenseCode(this.system.defense) : void 0;
    if (this.system.defense)
      return ze.fixedDefenseCode(this.system.defense);
    const e = Dt(String(this.system.skill ?? "").trim());
    return e != null && e.defense ? ze.fixedDefenseCode(e.defense) : void 0;
  }
  getDamage() {
    ...
    return {
      ...
      armorMode: iy(e, this.system.noArmor ?? this.system.armorAvoidance)
    };
  }
  getDamageCode() {
    return ty(
  ...
  getRanges() {
    return Zg(Ta(this.system.range)).filter((e) => e.allowed).map((e) => ({ value: e.value, labelkey: e.labelkey }));
  }
  validateTargets(e) {
    var s;
    ...
    if (r.length > 0) {
      const o = Ne($e.common.errors.ignoredTargets, {
        targets: r.reduce(de.joiner(", "))
      });
      ui.notifications.info(o);
    }
    if (n.length === 0) {
      const o = Ne($e.common.errors.noTargetSelected, {
...
vn = new WeakMap(), Vt = new WeakSet(), to = async function(e) {
...
}, we(ht, Vt), we(ht, vn, !1), O(ht, "RANGE_ORDER", oa), O(ht, "EQUIPPED_EFFECT_FLAG", "equippedItemSync"), O(ht, "DEFAULT_UNARMED", Object.freeze({
  id: "unarmed",
  name: "Unarmed",
  category: "melee",
  skill: "meleeCombat",
...
const fc = {
  ...
  options: {
    ...
    hbsTemplateRoll: `${Z}/roll/parts/select-option.hbs`,
  ...
  static buildDefaultUnarmedProfile(e = null) {
    ...
    const t = Math.max(0, Number(
      ((n = e == null ? void 0 : e.getAttributeValue) == null ? void 0 : n.call(e, S.actorAttributes.strength)) ?? ((o = (s = (r = e == null ? void 0 : e.system) == null ? void 0 : r.attributes) == null ? void 0 : s.strength) == null ? void 0 : o.value) ?? 0
  ...
  static init() {
    Hooks.once(Pt.REGISTER_ROLL_PARAMETERS, (e) => {
      e(ry), e(ny);
    });
  }
  prepareBaseData() {
  ...
  getCombatProfile(e = {}) {
    ...
    const t = this.system ?? {}, i = this.canonicalType ?? this.type, n = i === S.itemType.personalWeapon ? Ae.normalizePersonalRangeData(t.range) : Ae.normalizeRangeData(t.range), r = String(t.skill ?? "").trim(), s = Dt(r), o = Number(t.damage ?? 0) || 0, l = Number(t.ap ?? t.armorPiercing ?? 0) || 0, c = String(t.category ?? t.weaponCategory ?? "ranged").trim() || "ranged", u = Ae.normalizeTraits(t.traits);
    return {
      id: this.id ?? "weapon",
      uuid: this.uuid ?? null,
      name: this.name ?? "Weapon",
      ...
      damage: o,
      ap: l,
      damageType: i === S.itemType.personalWeapon ? Yt(t.damageType) : String(t.damageType ?? "kinetic").trim() || "kinetic",
  ...
  getWeaponSkill() {
    ...
    const e = (i = this.actor) == null ? void 0 : i.items.find(
      (n) => n.type === S.itemType.skill && n.system.code === this.system.skill
    );
    if (e) return e;
  ...
  getRanges() {
    const e = (this.canonicalType ?? this.type) === S.itemType.personalWeapon, t = e ? Ae.normalizePersonalRangeData(this.system.range) : Ae.normalizeRangeData(this.system.range);
  ...
  static getRangeList(e, { personalScale: t = !1 } = {}) {
    ...
    return Ae.RANGE_ORDER.map((r, s) => ({
      ...
      labelkey: t ? Ar(r) : Me.getFromList(Me.getEnums().ranges, r)
    }));
  }
...
class pl {
  ...
  registerHelpers() {
    const e = ly(), t = {
      ...
      toUpperCase: Cf.toUpperCaseNoAccent,
      // Math
      modulo: (i, n) => i % n,
      divint: de.divint,
      divup: de.divup,
      ...
      // Icons
      iconFA: X.fontAwesome,
      iconSrc: X.iconSystemPath,
      iconPath: X.iconPath,
      iconD6: X.iconD6,
      // Enums
...
const pc = "sheetTheme", io = "mwd-theme-default", cy = "mwd-theme-sra", uy = [
  { name: "Default (CSB)", cssClass: io },
  { name: "SRA", cssClass: cy }
];
class dy {
  constructor() {
    this.availableStyles = {}, aa.register(Pt.REGISTER_STYLES), Hooks.once(Pt.REGISTER_STYLES, (e) => uy.forEach((t) => e(t.cssClass, t.name))), Hooks.once("ready", () => this.onReady());
  }
  async onReady() {
    Hooks.callAll(Pt.REGISTER_STYLES, (e, t) => this.availableStyles[e] = t), console.log(Ce + "Loaded styles", this.availableStyles), game.settings.register(T, pc, {
      scope: "world",
      name: "Sheet Theme",
...
const my = /* @__PURE__ */ new Set([S.actorTypes.vehicle, S.actorTypes.battlemech]), fy = Object.freeze({
  head: "Head",
...
function An(a = "") {
  return fy[a] ?? (String(a ?? "").trim() || "Location");
}
function Jr(a = null) {
  return my.has(Jd(a));
}
...
function Zd({
  ...
  const n = Jd(a), r = py(e), s = Math.max(0, Number(t ?? 0) || 0) <= 0, o = n === S.actorTypes.battlemech ? yy(a, r) : by(a, r), l = r <= 4, c = s && r >= 16, u = l || c, d = !u && r >= 16, m = r === 18 && n === S.actorTypes.battlemech ? ke(a, ["torsoFront", "core"]) : o.locationKey, f = o.family || gy(o.locationKey);
  return {
    rollTotal: r,
    actorType: n,
...
const yt = Object.freeze({
  ...
  torsoFront: Object.freeze({ enabled: !0, stress: 0, condition: 0, tags: ["weaponGroup", "engine"], destroyed: !1 }),
  torsoRear: Object.freeze({ enabled: !0, stress: 0, condition: 0, tags: ["weaponGroup", "ammoStore"], destroyed: !1 }),
  leftArm: Object.freeze({ enabled: !0, stress: 0, condition: 0, tags: ["weaponGroup"], destroyed: !1 }),
  rightArm: Object.freeze({ enabled: !0, stress: 0, condition: 0, tags: ["weaponGroup"], destroyed: !1 }),
  leftLeg: Object.freeze({ enabled: !0, stress: 0, condition: 0, tags: ["motiveSystem"], destroyed: !1 }),
  rightLeg: Object.freeze({ enabled: !0, stress: 0, condition: 0, tags: ["motiveSystem"], destroyed: !1 }),
  core: Object.freeze({ enabled: !0, stress: 0, condition: 0, tags: ["engine", "gyro", "ammoStore"], destroyed: !1 })
}), Cy = Object.freeze({
  ...
  [S.actorTypes.battlemech]: Object.freeze({
    head: Object.freeze({ type: "cockpitCatastrophe", destroyed: !0, statusState: "destroyed" }),
    torsoFront: Object.freeze({ type: "torsoCollapse", destroyed: !0, statusState: "destroyed" }),
    torsoRear: Object.freeze({ type: "torsoCollapse", destroyed: !0, statusState: "destroyed" }),
    core: Object.freeze({ type: "coreFailure", destroyed: !0, statusState: "destroyed" }),
    leftArm: Object.freeze({ type: "armSystemCollapse", destroyed: !0, statusState: "" }),
    rightArm: Object.freeze({ type: "armSystemCollapse", destroyed: !0, statusState: "" }),
    leftLeg: Object.freeze({ type: "legCollapse", destroyed: !0, statusState: "immobilized" }),
    rightLeg: Object.freeze({ type: "legCollapse", destroyed: !0, statusState: "immobilized" })
  }),
  [S.actorTypes.vehicle]: Object.freeze({
...
function Xr(a = null) {
  ...
  return e === S.actorTypes.battlemech || e === "mech" ? S.actorTypes.battlemech : S.actorTypes.vehicle;
}
function Ry(a = S.actorTypes.vehicle) {
  return a === S.actorTypes.battlemech ? My : Cy;
}
function Py(a = S.actorTypes.vehicle) {
  return a === S.actorTypes.battlemech ? vy : ky;
}
function la(a = 0) {
  return im(Math.trunc(Fe(a, 0)), 0, yt.disabled);
}
function gc(a = {}, e = {}) {
  return {
    enabled: (a == null ? void 0 : a.enabled) !== void 0 ? !!a.enabled : !!e.enabled,
    stress: Math.max(0, Fe((a == null ? void 0 : a.stress) ?? (e == null ? void 0 : e.stress), 0)),
    condition: la((a == null ? void 0 : a.condition) ?? (e == null ? void 0 : e.condition) ?? 0),
...
function Ny(a = {}, e = S.actorTypes.vehicle) {
  const t = Ry(e), i = {};
  for (const [n, r] of Object.entries(t))
    i[n] = gc((a == null ? void 0 : a[n]) ?? {}, r);
  for (const [n, r] of Object.entries(a ?? {}))
    i[n] || (i[n] = gc(r, {}));
  return i;
}
function Iy(a = {}, e = S.actorTypes.vehicle) {
  const t = a.mwd = a.mwd ?? {};
  return t.unitType = String(t.unitType ?? (e === S.actorTypes.battlemech ? "mech" : "vehicle")).trim() || (e === S.actorTypes.battlemech ? "mech" : "vehicle"), t.status = t.status ?? { state: "operational", reasons: [] }, t.crits = Array.isArray(t.crits) ? t.crits : [], t;
}
function Dy(a = {}) {
  var n, r;
  const e = a.attributes = a.attributes ?? {}, t = (n = e.reliability) == null ? void 0 : n.value, i = (r = e.condition) == null ? void 0 : r.value;
  return Math.max(0, Fe(t ?? i, 0));
}
function Oy(a = [], e = -1) {
  return !Array.isArray(a) || e < 0 ? !1 : a.some((t) => Math.trunc(Fe(t, -1)) === e);
}
function am(a, e, t) {
...
function _y(a, e, t) {
  ...
  const i = Py(t), n = i.indexOf(a.key), r = i.indexOf(e.key);
  if (n !== r) {
...
function xy(a = {}, e = S.actorTypes.vehicle) {
  return Object.entries(a).filter(([, t]) => t && t.enabled === !0 && t.destroyed !== !0).map(([t, i]) => ({
    key: t,
    stress: Math.max(0, Fe(i == null ? void 0 : i.stress, 0)),
    condition: la(i == null ? void 0 : i.condition)
  })).sort((t, i) => _y(t, i, e));
}
function $y(a = {}, e = S.actorTypes.vehicle, t = "") {
  var n;
  const i = String(t ?? "").trim();
  if (i) {
  ...
  return ((n = xy(a, e)[0]) == null ? void 0 : n.key) ?? "";
}
function By(a, e, t, i) {
...
function zy({ result: a, locations: e, locationKey: t, reliability: i, threshold: n, currentShock: r }) {
  var c;
  const s = Math.max(0, i), o = Math.max(0, Fe((c = e == null ? void 0 : e[t]) == null ? void 0 : c.stress, 0)), l = Math.max(0, o - s);
  return e[t].stress = l, am(a, t, l - o), Math.max(0, r - Math.max(1, n));
}
function Fy({ locations: a = {}, shockBefore: e = 0, shockGain: t = 0, threshold: i = 1, reliability: n = 0, spendableBefore: r = 0 } = {}) {
  return {
    stressDelta: {},
    shockDelta: 0,
...
function nm(a = 0) {
  const e = im(Math.trunc(Fe(a, 0)), 0, 5);
  return Math.max(1, Number(wy[e] ?? 1));
}
function rm(a = 0) {
  return hc[la(a)] ?? hc[0];
}
...
function Zr(a = {}, e = S.actorTypes.vehicle) {
  var o, l, c;
  const t = Xr(e), i = a.attributes = a.attributes ?? {}, n = Dy(a);
  i.reliability = i.reliability ?? {}, i.reliability.value = n, i.condition = i.condition ?? {}, i.condition.value = Math.max(0, Fe(((o = i.condition) == null ? void 0 : o.value) ?? n, n));
  const r = Iy(a, t);
  r.shock = r.shock ?? {}, r.shock.value = Math.max(0, Fe((l = r.shock) == null ? void 0 : l.value, 0)), r.reliabilitySpendable = r.reliabilitySpendable ?? {};
  const s = (c = r.reliabilitySpendable) == null ? void 0 : c.value;
  return r.reliabilitySpendable.value = Math.max(0, Fe(s ?? n, n)), r.locations = Ny(r.locations ?? {}, t), a;
}
function Uy({ actorSnapshot: a = null, unitType: e = "", locationKey: t = "" } = {}) {
  var s;
  const i = Xr(e || (a == null ? void 0 : a.type) || (a == null ? void 0 : a.actorType)), n = String(t ?? "").trim(), r = ((s = Ey[i]) == null ? void 0 : s[n]) ?? {
...
function Hy({
  ...
  var x, K, q, H, W, _, F, V;
  const l = Ia(a ?? {}), c = Xr((l == null ? void 0 : l.type) ?? (l == null ? void 0 : l.actorType)), u = Zr(l.system ?? {}, c), d = Ia(((x = u.mwd) == null ? void 0 : x.locations) ?? {}), m = Math.max(0, Fe((q = (K = u.attributes) == null ? void 0 : K.reliability) == null ? void 0 : q.value, 0));
  let f = Math.max(0, Fe((W = (H = u.mwd) == null ? void 0 : H.reliabilitySpendable) == null ? void 0 : W.value, m));
  const p = nm(m), h = Math.max(0, Fe(t, 0)), g = Math.max(0, Fe((F = (_ = u.mwd) == null ? void 0 : _.shock) == null ? void 0 : F.value, 0)), y = Ly(i);
  ...
  if (w && d[w] && h > 0) {
    const re = Math.max(0, Fe((V = d[w]) == null ? void 0 : V.stress, 0)) + h;
    d[w].stress = re, am(A, w, h);
  }
  let v = 0, R = 0;
  const E = (Y = "", re = "shock") => {
    const ce = $y(d, c, Y);
    if (!ce) return !1;
    const ue = d[ce];
    A.summary.selectedLocations.push({ source: re, location: ce });
    const oe = !!n && f > 0, Re = oe && Oy(r, v);
    if (A.spendOpportunities.push({
      index: v,
      location: ce,
      source: re,
      canSpend: oe,
      ...
      f = Math.max(0, f - 1), A.reliabilitySpends.push({ location: ce, prevented: !0, source: re });
    else {
      const Ie = la(ue.condition);
      if (Ie >= yt.disabled)
        By(
          A,
          Uy({ actorSnapshot: l, unitType: c, locationKey: ce }),
          ce,
          d
        );
      else {
        const _e = la(Ie + 1);
        d[ce].condition = _e, A.conditionAdvancements.push({ location: ce, from: Ie, to: _e, source: re });
      }
    }
    return b = zy({
      result: A,
  ...
  for (; b >= p && R < Math.max(1, Math.trunc(Fe(o, 10))); ) {
    const Y = E("", "shock");
    if (R += 1, !Y) break;
  }
  R >= Math.max(1, Math.trunc(Fe(o, 10))) && b >= p && (A.loopGuardTriggered = !0);
  for (const Y of Array.isArray(s) ? s : [])
    E(String(Y ?? "").trim(), "critical");
  return A.shockDelta = Math.max(0, b) - g, A.summary.shockAfter = Math.max(0, b), A.summary.reliabilitySpendableAfter = f, A.summary.locationsAfter = Ia(d), A;
}
function jy(a = null, e = null) {
  var l, c, u, d, m;
  if (!a || !e) return {};
  const t = Xr(a), i = Zr(Ia(a.system ?? {}), t), n = Ia(((l = i.mwd) == null ? void 0 : l.locations) ?? {}), r = {};
  for (const [f, p] of Object.entries(e.stressDelta ?? {})) {
    const h = n[f];
    h && (h.stress = Math.max(0, Math.max(0, Fe(h.stress, 0)) + Fe(p, 0)), r[`system.mwd.locations.${f}.stress`] = h.stress);
  }
  for (const f of Array.from(e.conditionAdvancements ?? [])) {
    const p = String((f == null ? void 0 : f.location) ?? "").trim(), h = n[p];
    h && (h.condition = la((f == null ? void 0 : f.to) ?? h.condition), r[`system.mwd.locations.${p}.condition`] = h.condition);
  }
  for (const f of Array.from(e.fallbackEvents ?? [])) {
    const p = String((f == null ? void 0 : f.location) ?? "").trim(), h = n[p];
    h && f.destroyed && (h.destroyed = !0, r[`system.mwd.locations.${p}.destroyed`] = !0);
  }
  const s = Array.isArray(e.reliabilitySpends) ? e.reliabilitySpends.length : 0, o = Math.max(0, Fe((u = (c = i.mwd) == null ? void 0 : c.reliabilitySpendable) == null ? void 0 : u.value, 0));
  return r["system.mwd.reliabilitySpendable.value"] = Math.max(0, o - s), r["system.mwd.shock.value"] = Math.max(0, Fe((m = (d = i.mwd) == null ? void 0 : d.shock) == null ? void 0 : m.value, 0) + Fe(e.shockDelta, 0)), e.statusState && (r["system.mwd.status.state"] = e.statusState), r;
}
const om = "machineCritical", lm = "machineCriticalTableGeneralUuid", Ky = "machineCriticalTableBattlemechUuid", Wy = "machineCriticalTableVehicleUuid", cm = "machineCriticalTableBattlemechHeadUuid", um = "machineCriticalTableBattlemechTorsoUuid", dm = "machineCriticalTableBattlemechArmsUuid", mm = "machineCriticalTableBattlemechLegsUuid", fm = "machineCriticalTableVehicleBodyUuid", pm = "machineCriticalTableVehicleTurretUuid", hm = "machineCriticalTableVehicleMobilityUuid", nt = Object.freeze({
...
}), Gy = /* @__PURE__ */ new Set(["physical", "fatigue", ""]), no = Object.freeze({
...
function Dn(a) {
  return gm() && typeof foundry.utils.deepClone == "function" ? foundry.utils.deepClone(a) : JSON.parse(JSON.stringify(a ?? null));
}
...
function qy() {
  return gm() && typeof foundry.utils.randomID == "function" ? foundry.utils.randomID() : Math.random().toString(36).slice(2, 18).padEnd(16, "0").slice(0, 16);
}
function Vy() {
  try {
...
function ca(a = {}, { strict: e = !1 } = {}) {
  const t = Yy(a), i = [], n = String((t == null ? void 0 : t.key) ?? "").trim(), r = String((t == null ? void 0 : t.remedyKey) ?? "emergencyRepair").trim() || "emergencyRepair", s = bc(t == null ? void 0 : t.gates).map((p) => String(p ?? "").trim()).filter(Boolean), o = bc(t == null ? void 0 : t.mods).map((p) => String(p ?? "").trim()).filter(Boolean), l = Sc(t == null ? void 0 : t.resourceEffects), c = Sc(t == null ? void 0 : t.pilotDamage), u = String((t == null ? void 0 : t.escalationKey) ?? "").trim();
  n || i.push("Critical signal key cannot be blank."), Sy(r) || i.push(`Unknown machine critical remedy "${r}".`);
  ...
  return Gy.has(d) || i.push(`Pilot damage track "${d}" is invalid.`), (!Number.isFinite(m) || m < 0) && i.push("Pilot damage amount must be non-negative."), i.length ? (Qy(i[0], i, e), null) : {
    key: n,
    remedyKey: r,
    gates: s,
    mods: o,
...
function Jy(a) {
  return (a == null ? void 0 : a.type) === S.actorTypes.vehicle || (a == null ? void 0 : a.type) === S.actorTypes.battlemech;
}
function Xy(a, e, t, i) {
  return {
    ...e != null && e.hitLocation && typeof e.hitLocation == "object" ? e.hitLocation : Zd({
      actor: a,
...
function eb({
  ...
  if (!Jy(a)) return { ok: !1, reason: "Machine damage requires a vehicle or BattleMech actor." };
  const n = Math.max(0, Math.ceil(Number((e == null ? void 0 : e.damage) ?? (e == null ? void 0 : e.amount) ?? 0) || 0)), r = Tc(a, S.monitors.armor), s = Tc(a, S.monitors.structure), o = t ? { ...t, armorBefore: r.remaining, structureBefore: s.remaining, pureStructureHit: r.remaining <= 0 } : Xy(a, e, r.remaining, s.remaining), l = Math.min(n, a.type === S.actorTypes.vehicle && r.max <= 0 ? 0 : r.remaining), c = Math.min(s.remaining, Math.max(0, n - l)), u = Math.min(r.max, r.value + l), d = Math.min(s.max, s.value + c), m = Zy(o, i), f = bm(o, i), p = Sm(e), h = c;
  return {
    ok: !0,
...
function tb(a = null) {
  return ei(lm, nt.general);
}
async function Am(a = null, e = "") {
  const t = String(e || tb(a)).trim();
...
function Tm(a = null, e = {}) {
  const t = String((e == null ? void 0 : e.locationFamily) ?? (e == null ? void 0 : e.locationKey) ?? "").trim();
  return (a == null ? void 0 : a.type) === S.actorTypes.battlemech ? t === "head" ? "head" : t === "arms" || t === "arm" || /arm/i.test(String((e == null ? void 0 : e.locationKey) ?? "")) ? "arms" : t === "legs" || t === "leg" || /leg/i.test(String((e == null ? void 0 : e.locationKey) ?? "")) ? "legs" : "torso" : t === "turret" || t === "weapon" || /turret|weapon/i.test(String((e == null ? void 0 : e.locationKey) ?? "")) ? "turret" : t === "mobility" || t === "motive" || /mobility|motive|drive|wheel|track/i.test(String((e == null ? void 0 : e.locationKey) ?? "")) ? "mobility" : "body";
}
function ib(a = null, e = {}) {
  const t = Tm(a, e);
  return (a == null ? void 0 : a.type) === S.actorTypes.battlemech ? t === "head" ? ei(cm, nt.mechHead) : t === "arms" ? ei(dm, nt.mechArms) : t === "legs" ? ei(mm, nt.mechLegs) : ei(um, nt.mechTorso) || ei(Ky, nt.battlemech) : t === "turret" ? ei(pm, nt.vehicleTurret) : t === "mobility" ? ei(hm, nt.vehicleMobility) : ei(fm, nt.vehicleBody) || ei(Wy, nt.vehicle);
}
function ab(a = null, e = {}, t = 7) {
  var s, o, l, c;
  const i = (a == null ? void 0 : a.type) === S.actorTypes.vehicle ? "vehicle" : "battlemech", n = Tm(a, e), r = Math.min(12, Math.max(2, Math.trunc(Number(t ?? 7)) || 7));
  return Dn(((o = (s = yc[i]) == null ? void 0 : s[n]) == null ? void 0 : o[r]) ?? ((c = (l = yc[i]) == null ? void 0 : l[n]) == null ? void 0 : c[7]));
}
function Fn(a = {}, e = {}) {
...
async function wc({ actor: a = null, hitLocation: e = {}, rollTotal: t = 7, tableUuid: i = "" } = {}) {
  const n = ab(a, e, t), r = String(i || ib(a, e)).trim();
...
async function vc({ actor: a = null, drawFn: e = null, tableUuid: t = "", recursiveCascade: i = !1 } = {}) {
  var l;
...
function Ss({ actor: a, drawn: e, hitLocation: t, source: i = {}, cascade: n = !1 } = {}) {
  var u, d, m, f, p, h, g;
  const r = ca((e == null ? void 0 : e.signal) ?? e, { strict: !0 }), s = In(r.remedyKey), o = bm(t, !1), l = String((e == null ? void 0 : e.label) ?? r.key).trim() || r.key, c = em({
    key: r.key,
    label: l,
  ...
  return {
    ...
    remedyLabel: s.label,
    remedySkillKey: c,
    remedyBaseDn: tm({ remedyKey: r.remedyKey }, s),
    remedyEffect: hl({}),
...
async function rb({
  ...
  try {
    const r = await vc({ actor: a, drawFn: i, tableUuid: n, recursiveCascade: !1 });
    if (r != null && r.error) return { ok: !1, reason: r.error, crits: [] };
    const s = ca(r.signal, { strict: !0 }), o = Fn(r, s), l = await wc({ actor: a, hitLocation: e, rollTotal: o });
    ...
    const u = await vc({ actor: a, drawFn: i, tableUuid: n, recursiveCascade: !0 }), d = u != null && u.error ? Ac(12) : ca(u.signal, { strict: !0 }), m = bs(d, Fn(u, d)) ? 12 : Fn(u, d), f = m === 12 && bs(d, Fn(u, d)) ? Ac(12) : d, p = await wc({ actor: a, hitLocation: e, rollTotal: m });
...
function sb(a = {}) {
  return Array.isArray(a == null ? void 0 : a.preparedCriticalRecords) ? a.preparedCriticalRecords.map((e) => Dn(e)) : [];
}
function ob(a = []) {
...
async function cb({
  ...
  if (!n.ok) return n;
  const r = !!i.dryRun, s = sb(t);
  let o = s.length ? { ok: !0, crits: s, cascade: s.length > 1 } : { ok: !0, crits: [] };
  !s.length && n.critical.selected && (o = await rb({
    actor: a,
    hitLocation: {
      ...n.hitLocation,
  ...
  const l = Hy({
    ...
    attackQuality: ((d = n.degradation) == null ? void 0 : d.attackQuality) ?? Sm(t),
    ...
    directConditionLocations: o.ok ? ob(o.crits) : []
  });
  ...
  const c = Array.isArray((f = (m = a == null ? void 0 : a.system) == null ? void 0 : m.mwd) == null ? void 0 : f.crits) ? Dn(a.system.mwd.crits) : [], u = o.ok && o.crits.length ? c.concat(o.crits) : c;
  if (!r) {
    const p = {
    ...
    o.ok && o.crits.length && (p["system.mwd.crits"] = u), await a.update(p), await lb(a, u.some((h) => (h == null ? void 0 : h.active) !== !1));
  }
  return {
    ...n,
    dryRun: r,
...
function db(a) {
  return (a == null ? void 0 : a.type) === S.actorTypes.character || (a == null ? void 0 : a.type) === S.actorTypes.npc;
}
function mb(a) {
  return (a == null ? void 0 : a.type) === S.actorTypes.vehicle || (a == null ? void 0 : a.type) === S.actorTypes.battlemech;
}
...
function pb(a, e) {
  const t = String(a ?? "").trim();
  return t === "status" ? fb(e) : t === "machineAttackDamage" ? mb(e) : db(e);
}
function hb(a, e) {
  var t;
...
class Tt {
  ...
  static async _applyTrackDelta(e, t, i = {}) {
    const n = (t == null ? void 0 : t.track) === S.monitors.fatigue ? S.monitors.fatigue : S.monitors.physical, r = kc((t == null ? void 0 : t.delta) ?? (t == null ? void 0 : t.amount) ?? 0);
    ...
    const l = i.dryRun ? Math.max(0, o + r) : Un(e, n);
    return {
      mode: "trackDelta",
      track: n,
      requestedDelta: r,
  ...
  static async _applyBurnDelta(e, t) {
    var l, c;
    const i = kc((t == null ? void 0 : t.delta) ?? (t == null ? void 0 : t.amount) ?? 0), n = Mc(e), r = Math.max(0, n + i), s = { "system.burn.value": r };
  ...
  static async _applyStatus(e, t) {
    ...
    const n = sa(e, i), r = !!(t != null && t.active);
    await Ur({
      actor: e,
      statusId: i,
      active: r,
  ...
  static async _applyMachineAttackDamage(e, t, i, n = {}) {
    return cb({ actor: e, token: t, payload: i, options: n });
  }
  static async _applyPersonalArmorAwareDamage(e, t, i = {}) {
    var x, K, q, H, W, _, F, V, Y;
    const n = !!i.dryRun, r = (t == null ? void 0 : t.track) === S.monitors.fatigue ? S.monitors.fatigue : S.monitors.physical, s = Math.max(0, Number((t == null ? void 0 : t.damage) ?? 0) || 0), o = Math.max(0, Number((t == null ? void 0 : t.netHits) ?? 0) || 0), l = (t == null ? void 0 : t.effects) ?? {}, c = ((x = e.getPersonalCombatLoadout) == null ? void 0 : x.call(e, { refresh: !0 })) ?? null, u = (c == null ? void 0 : c.activeArmor) ?? null, d = Math.max(0, Number((u == null ? void 0 : u.currentArmorRating) ?? ((K = u == null ? void 0 : u.durability) == null ? void 0 : K.current) ?? 0) || 0), m = Yt(t == null ? void 0 : t.damageType, "concussive"), f = Un(e, r);
    let p = s + o;
    const h = d > 0 ? Ep({
      damageIncoming: p,
    ...
    let A = Math.max(0, Math.ceil(p - b));
    const w = {
    ...
    n || await Ai({ actor: e, mutations: v.mutations, runtime: w }), A = Math.max(0, Number(v.packet.amount ?? A) || 0), !n && A > 0 && await G.addCounter(e, r, A);
    const R = ub({
      incomingDamage: s + o,
      armorBefore: ((H = u == null ? void 0 : u.durability) == null ? void 0 : H.current) ?? 0,
    ...
    !n && Object.keys(R.update).length > 0 && await u.item.update(R.update);
    const E = n ? Math.max(0, f + A) : Un(e, r);
    return {
      ...
      mitigation: {
        ...
        reinforcedBefore: R.reinforcedBefore,
        reinforcedAfter: R.reinforcedAfter,
        reinforcedMax: R.reinforcedMax
      },
      damageIncoming: p,
      adjustedIncoming: p,
      finalDamage: A,
...
const Cc = fr, ro = "damage-mode", bb = `${T}.${ro}`, Hn = {}, Ts = {};
class ye {
  static init() {
    aa.register(Pt.PROVIDE_DAMAGE_MODE), Hooks.on("updateSetting", async (e, t, i, n) => ye.onUpdateSetting(e, t, i, n)), Hooks.on(Pt.PROVIDE_DAMAGE_MODE, (e) => {
      e("resistanceArmorMonitor", k.settings.damageMode.values.resistanceArmorMonitor, ye.sufferDamageResistanceArmorMonitor), e("armorResistanceMonitor", k.settings.damageMode.values.armorResistanceMonitor, ye.sufferDamageArmorResistanceMonitor), e("armorGivesResistance", k.settings.damageMode.values.armorGivesResistance, ye.sufferDamageArmorAsResistance_Earthdawn), e("armorGiveResistanceHitsAvoid", k.settings.damageMode.values.armorGiveResistanceHitsAvoid, ye.sufferDamageArmorAsResistance_Cyberpunk);
  ...
  static _registerDamageModeSetting() {
    Hooks.callAll(Pt.PROVIDE_DAMAGE_MODE, (e, t, i) => {
      Hn[e] = t, Ts[e] = i;
      ...
      config: !0,
      default: Object.keys(Hn)[0],
      choices: Hn,
      type: String
    });
  }
  static async onUpdateSetting(e, t, i, n) {
    e.key == bb && ye._selectDamageMode();
  }
  static _selectDamageMode() {
    let e = game.settings.get(T, ro);
    Ts[e] || (e = Object.keys(Hn)[0]), ye.damageModeCode = e, ye.damageModeMethod = Ts[e];
  }
  static async sufferDamage(e, t, i, n, r, s, o) {
    ...
    await (ye.damageModeMethod ?? ye.sufferDamageResistanceArmorMonitor)(e, l, c, i, n, r, s), await e.applyArmorDamage(l, c, he.sumModifiers([o], "other", "damageArmor"));
  }
  static _shouldUsePersonalDamageV2(e, t, i) {
    var n, r;
    return !((n = e == null ? void 0 : e.isCharacterLike) != null && n.call(e)) || ![S.monitors.physical, S.monitors.fatigue].includes(t) ? !1 : !!((r = i == null ? void 0 : i.isPersonalWeapon) != null && r.call(i) || (i == null ? void 0 : i.canonicalType) === S.itemType.personalWeapon || (i == null ? void 0 : i.type) === S.itemType.personalWeapon);
  }
  ...
  static async damageToArmor(e, t, i) {
    if (i > 0) {
      const n = G.max(e, S.monitors.armor), r = G.getCounterValue(e, S.monitors.armor), s = Math.min(n - r, i), o = G.resistance(e, S.monitors.armor, t), l = Math.max(0, s - o);
      return l > 0 && await G.addCounter(e, S.monitors.armor, l), s;
    } else
      return 0;
  }
  ...
  static _notifyResistanceUsage(e, t, i, n) {
    ...
    if (!n || t === void 0)
      return;
    const r = k.actor.monitors[t] ?? t, s = ye._localizeDamageType(i) ?? r, o = n.usedType ? "type" : "default", l = ((u = k.actor.monitors.resistanceSources) == null ? void 0 : u[o]) ?? o, c = Ne(k.actor.monitors.resistanceApplied, {
      actor: e.name,
      monitor: r,
      damageType: s,
      value: n.value,
  ...
  static _localizeDamageType(e) {
    if (e)
      return Bu(e) ? Qt(e) : k.mwd.weaponDamageType[e] ?? k.mwd.personalDamageType[e] ?? k.actor.monitors[e] ?? e;
  }
...
class Nt extends Actor {
  ...
  prepareDerivedData() {
    if (this.system.modifiers = {
      initiative: he.sumModifiers(this.items, "other", "initiative")
    }, this.system.monitors) {
      const e = Me.getDamageTypes();
      Object.entries(this.system.monitors).forEach((t) => {
        t[1].resistance = Nt.normalizeResistance(t[1].resistance), t[1].maxBonus = he.sumMonitorModifiers(this.items, t[0], "max"), t[1].resistanceBonus = he.sumMonitorModifiers(this.items, t[0], "resistance"), t[1].resistanceBonusByType = Object.fromEntries(
          e.map((i) => [i.value, he.sumMonitorModifiers(this.items, t[0], "resistanceByType", i.value)]).filter(([, i]) => i)
        );
      });
    }
  ...
  _prepareEdgePools() {
    ...
    Object.values(S.counters.edgePools).forEach((n) => {
  ...
  _getMonitorMax(e) {
    ...
    return t == 0 ? 0 : Au + de.divup(t, 2);
  }
  getAttributeActions() {
    return ze.getActorActions(this);
  }
  getUsableAttributes(e = void 0) {
    const t = (e ? [e] : this.items).map((n) => n.getAttributes()).reduce((n, r) => n.concat(r), []), i = de.distinct(this.getAttributes().concat(t));
    return i.sort(de.ascendingBySortedArray(Me.sortedAttributeKeys)), i;
  }
  getAttributeValue(e, t = void 0) {
    ...
    if (e = this.getCorrespondingAttribute(e), e) {
      ...
      i += he.sumModifiers(this.items, "attribute", e);
    }
    return i;
  }
  resolveDamageType(e) {
  ...
  async rollAttributeAction(e) {
    const t = ze.getActorAction(this, e);
  ...
  async rollDefense(e) {
    const t = e.attack.defense, i = ze.getActorDefense(this, t);
  ...
  async onEnterCombat() {
    const e = he.sumModifiers(this.items, "other", "sceneAnarchy");
    e > 0 && await G.setCounter(this, S.monitors.sceneAnarchy, e);
  }
  async onLeaveCombat() {
    await G.setCounter(this, S.monitors.sceneAnarchy, 0);
  }
  getCelebrityValue() {
    return 0;
  }
  ...
  getEdgePoolValue(e) {
    var r, s;
    const t = this.getAttributeValue(S.actorAttributes.edge), n = ((s = (r = this.getEdgePools()) == null ? void 0 : r[e]) == null ? void 0 : s.value) ?? t ?? 0;
  ...
  getShortcut(e, t) {
    ...
    if (e == "attributeAction") {
      const r = ze.prepareShortcut(this, t);
      if (r)
...
const { ApplicationV2: Sb, HandlebarsApplicationMixin: Ab } = foundry.applications.api, { renderTemplate: Ec } = foundry.applications.handlebars, Tb = `${Z}/chat/celebrity-roll.hbs`, Ea = class Ea extends Ab(Sb) {
  static get DEFAULT_OPTIONS() {
    return foundry.utils.mergeObject(super.DEFAULT_OPTIONS, {
      id: "roll-celebrity",
      classes: ["anarchy-dialog"],
  ...
  static async create(e) {
    const t = {
      ...
      modifiers: foundry.utils.mergeObject(
        ...
        he.computeModifiers(e.items, "other", "celebrity")
      ),
      other: {
      ...
      ANARCHY: k
    }, i = await Ec(`${Z}/dialog/roll-celebrite-title.hbs`, t), n = {
...
O(Ea, "PARTS", {
  body: {
    template: `${Z}/dialog/roll-celebrite.hbs`
  }
});
let so = Ea;
const { renderTemplate: wb } = foundry.applications.handlebars, vb = `${Z}/chat/actor-say-word.hbs`;
class Rc extends Nt {
  static get initiative() {
  ...
  prepareDerivedData() {
    !this.system.monitors.fatigue && this.system.monitors.stun && (this.system.monitors.fatigue = foundry.utils.duplicate(this.system.monitors.stun)), this.system.monitors.physical.max = this._getMonitorMax(S.actorAttributes.strength), this.system.monitors.fatigue.max = this._getMonitorMax(S.actorAttributes.willpower), super.prepareDerivedData(), this.system.ignoreWounds = he.sumModifiers(this.items, "other", "ignoreWounds");
  }
  computePhysicalState() {
    var l, c;
  ...
  getAttributes() {
    return _a[this.type] ?? _a[S.actorTypes.character];
  }
  getPhysicalAgility() {
  ...
  async _mutateWords(e, t = (i) => i) {
    ...
    de.reindexIds(i), await this.update({ [`system.${e}`]: i });
  }
  getCelebrityValue() {
  ...
  async spendAnarchy(e) {
    if (e > 0) {
      ...
      da.checkSufficient(k.actor.counters.anarchy, e, i + t);
      const n = Math.min(t, e), r = e - n;
      n > 0 && G.addCounter(this, S.monitors.sceneAnarchy, -n), this.hasPlayerOwner ? (await game.system.anarchy.gmAnarchy.actorGivesAnarchyToGM(this, e), G.addCounter(this, S.monitors.anarchy, -r)) : r > 0 && super.spendAnarchy(r);
    }
  }
  canUseEdge() {
    return !0;
  ...
  getWounds() {
    const e = de.divint(this.system.monitors.fatigue.value, 3) + de.divint(this.system.monitors.physical.value, 3);
...
function Mb(a = {}) {
  return !a || typeof a != "object" || Array.isArray(a) ? {} : Object.fromEntries(
    Object.entries(a).map(([e, t]) => [String(e ?? "").trim(), kb(t, 0)]).filter(([e, t]) => e && t !== 0)
  );
}
function Pc(a = {}) {
  return {
    default: 0,
    byType: Mb(a == null ? void 0 : a.byType)
  };
}
...
function Eb(a = "") {
  return a === S.actorTypes.vehicle || a === S.actorTypes.battlemech;
}
function Rb(a = "") {
  return a === S.actorTypes.battlemech ? ["ground", "flight", "jump"] : a === S.actorTypes.vehicle ? ["ground", "flight"] : [];
}
function gl(a = {}, { actorType: e = "", legacyMoves: t = 0 } = {}) {
  ...
  return e === S.actorTypes.battlemech && (r.jump = tn(i.jump, 0)), r;
}
function wm({
  actorType: a = "",
  movement: e = {},
...
function vm({ actorType: a = "", movement: e = {}, legacyMoves: t = 0 } = {}) {
...
class km extends Nt {
  ...
  static get defaultIcon() {
    return `${Pr}/default/Default_Vehicle.svg`;
  }
  static get initiative() {
  ...
  getAttributes() {
    return _a[this.type] ?? _a[S.actorTypes.vehicle];
  }
  getPhysicalAgility() {
  ...
  _prepareMwdAttributes() {
    const e = this.system.mwd = this.system.mwd ?? {}, t = {
      ...
      [S.actorAttributes.reliability]: { value: 0 },
  ...
  _prepareMwdMonitors() {
    ...
    const e = this.system.mwd = this.system.mwd ?? {}, t = this.system.monitors = this.system.monitors ?? {}, i = this.type === S.actorTypes.battlemech ? 15 : 12, n = Math.max(0, Number(((s = t.armor) == null ? void 0 : s.max) ?? i));
    t.armor = foundry.utils.mergeObject(
      { value: 0, max: n, resistance: Nt.normalizeResistance((o = t.armor) == null ? void 0 : o.resistance) },
      t.armor ?? {},
      { inplace: !1, recursive: !0 }
    ), t.armor.resistance = Pc(t.armor.resistance);
    const r = {
      value: ((l = t.structure) == null ? void 0 : l.value) ?? 0,
      max: ((c = t.structure) == null ? void 0 : c.max) ?? (this.type === S.actorTypes.battlemech ? 18 : 15),
    ...
    if (t.structure = foundry.utils.mergeObject(
      ...
      t.structure ?? {},
      { inplace: !1, recursive: !0 }
    ), t.structure.resistance = Pc(t.structure.resistance), e.monitors = e.monitors ?? {}, e.monitors.structure = foundry.utils.mergeObject(
      foundry.utils.duplicate(r),
...
const Nc = {
  ...
  heavy: 6,
  assault: 7
}, Nb = { mode: "normal", allowedWeaponIds: [], typeRestriction: "" }, Ib = {
...
class Db {
  ...
  compute() {
    ...
    s.length > 1 && l.push(k.mwd.loadout.errors.multiplePrimary);
    ...
    for (const y of n)
      for (const b of y.weaponIds ?? []) {
        ...
        const w = A.system.hardpointType ?? "energy", v = A.system.hardpointSize ?? "small";
        if (p.has(b)) {
          l.push(Ne(k.mwd.loadout.errors.weaponAlreadyGrouped, { weapon: A.name }));
          continue;
        }
        if (p.add(b), y.isPrimary && this._validatePrimaryWeapon(A, w, v, o, l), (A.system.weaponCategory ?? "ranged") === "melee")
          continue;
        const R = h.find((E) => !E.occupiedBy && E.type === w && E.size === v);
        R ? (R.occupiedBy = y.id, R.occupiedByName = y.name) : l.push(Ne(k.mwd.loadout.errors.hardpointUnavailable, {
          weapon: A.name,
  ...
  _primarySlot() {
    const e = foundry.utils.mergeObject(foundry.utils.duplicate(Nb), this.mwd.primarySlot ?? {});
    return e.allowedWeaponIds = this._asArray(e.allowedWeaponIds), e;
  }
  _computeMeleeState(e) {
    var o, l, c;
    const t = foundry.utils.mergeObject(foundry.utils.duplicate(Ib), this.mwd.melee ?? {}), i = this._getWeapons((u) => (u.system.weaponCategory ?? "ranged") === "melee"), n = [], r = Number(t.maxWeapons ?? 0);
    i.length > r && e.push(Ne(k.mwd.loadout.errors.meleeLimitExceeded, {
      equipped: i.length,
      limit: r
    }));
    ...
    return n.push({
      ...
      var d;
      s.length > 0 && u.system.mountLocation && !s.includes(u.system.mountLocation) && e.push(Ne(k.mwd.loadout.errors.meleeLocationRestricted, {
        weapon: u.name,
  ...
  _validatePrimaryWeapon(e, t, i, n, r) {
    var s;
    n.mode === "converted" ? (((s = n.allowedWeaponIds) == null ? void 0 : s.length) > 0 && !n.allowedWeaponIds.includes(e.id) && r.push(Ne(k.mwd.loadout.errors.primaryNotAllowedWeapon, { weapon: e.name })), n.typeRestriction && t !== n.typeRestriction && r.push(Ne(k.mwd.loadout.errors.primaryTypeRestriction, {
      weapon: e.name,
      type: k.mwd.hardpointType[n.typeRestriction] ?? n.typeRestriction
    }))) : i !== "large" && r.push(Ne(k.mwd.loadout.errors.primaryNeedsLarge, { weapon: e.name }));
  }
  _getWeapons(e) {
...
function oo(a = 0, e = {}, t = 0) {
  const i = Math.max(0, an(a, 0)), n = Tr(e, t);
...
class Ob extends km {
  static get defaultIcon() {
    return `${Pr}/vehicles/apc.svg`;
  }
  prepareDerivedData() {
    var e;
    super.prepareDerivedData(), this.system.mwd = this.system.mwd ?? {}, this.system.mwd.chassis = this.system.mwd.chassis ?? "", this.system.mwd.tonnage = this.system.mwd.tonnage ?? 0, this.system.mwd.loadout = new Db(this).compute(), this.system.mwd.weaponGroupDetails = this._prepareConfiguredWeaponGroups(), this.system.mwd.heat = this._prepareHeatTrack(), this.system.mwd.primaryGroupName = ((e = this.system.mwd.weaponGroupDetails.find((t) => t.isPrimary)) == null ? void 0 : e.name) ?? "", this.system.skills = this._prepareSkillMap(), this.system.weaponGroups = this._prepareWeaponGroups(), this.system.meleeProfiles = this._prepareMeleeProfiles(), this.system.quickActions = {
  ...
  _prepareHeatTrack() {
    ...
    r.current = t.value ?? r.current, r.max = t.max ?? r.max, r.thresholds = Tr(
    ...
    return this.system.mwd.heatStatus = {
      code: s,
      label: k.actor.battlemech.heat.status[s] ?? lo(s)
    }, r;
  }
  ...
  _prepareConfiguredWeaponGroups() {
    ...
    return e.map((n, r) => {
      const s = Array.isArray(n.weaponIds) ? n.weaponIds : n.weaponIds ? [n.weaponIds] : [], o = s.map((c) => t.get(c)).filter((c) => (c == null ? void 0 : c.type) === S.itemType.mechWeapon), l = s.filter((c) => !t.has(c));
      return {
        id: n.id ?? `group-${r + 1}`,
        index: r,
  ...
  _prepareWeaponGroups() {
    ...
    const t = this.items.filter((s) => s.type === S.itemType.mechWeapon);
    if (t.length === 0)
      return [];
    const i = t.filter((s) => this.hasFavorite(S.itemType.mechWeapon, s.id)), n = [];
...
class xb {
  ...
  collect({ resolved: e } = {}) {
    var s;
    const t = (s = canvas == null ? void 0 : canvas.scene) == null ? void 0 : s.getFlag("mwd", ir);
    if (!Array.isArray(t) || !t.length) return [];
    const i = Lb(e), n = _b(e), r = [];
    for (const o of t) {
      const l = Mm(o);
...
const $b = `systems/${T}/templates/settings/collection-editor.hbs`, Cm = /* @__PURE__ */ new Map(), ws = /* @__PURE__ */ new Map();
function xt(a = []) {
  const e = Array.isArray(a) ? a.filter(Boolean) : [String(a ?? "").trim()].filter(Boolean), t = new Error(e[0] ?? "Invalid settings data.");
  return t.validationErrors = e, t;
}
function ja(a) {
  zb(a), Cm.set(a.id, a), game.settings.register(T, a.settingKey, {
    scope: "world",
    config: !1,
...
var ee, Rm, co, ar, nr, wa, uo, nn, Pm, Nm, At;
class Em extends FormApplication {
  constructor(t = {}, i = {}) {
    super(t, i);
    we(this, ee);
    const n = C(this, ee, nr).call(this);
    this.editorState = {
      tab: "rows",
  ...
  get definition() {
    const t = Bb(this.constructor.definitionId);
    if (!t)
  ...
  getData(t = {}) {
    const i = C(this, ee, Nm).call(this), n = this.editorState.rows.map((r, s, o) => ({
      index: s,
      fields: i.map((l) => C(this, ee, Pm).call(this, l, r, s)),
      canMoveUp: s > 0,
  ...
  activateListeners(t) {
    super.activateListeners(t), t.find("[data-action]").each((i, n) => {
      n.addEventListener("click", (r) => {
        ...
        o && C(this, ee, Rm).call(this, o, r, s);
      });
    });
  }
  ...
  async _updateObject(t, i) {
    var n;
    C(this, ee, At).call(this, []);
    try {
      const r = this.editorState.tab === "bulk" ? this.definition.parseBulk(C(this, ee, nn).call(this)) : this.definition.rowsToValue(C(this, ee, uo).call(this));
      await game.settings.set(T, this.definition.settingKey, r);
      const s = C(this, ee, nr).call(this);
      C(this, ee, ar).call(this, s), await this.close();
    } catch (r) {
      C(this, ee, At).call(this, jn(r)), this.editorState.errors.length && ((n = ui.notifications) == null || n.error(this.editorState.errors[0])), this.render(!1);
    }
  }
}
ee = new WeakSet(), Rm = async function(t, i, n) {
  var r, s, o, l, c, u, d, m;
  switch (i.preventDefault(), i.stopPropagation(), t) {
    case "switchRows":
      C(this, ee, nn).call(this), this.editorState.tab = "rows", C(this, ee, At).call(this, []), this.render(!1);
      return;
    case "switchBulk":
      C(this, ee, wa).call(this);
      try {
        const f = this.definition.rowsToValue(this.editorState.rows);
        this.editorState.bulkText = this.definition.serializeBulk(f), this.editorState.tab = "bulk", C(this, ee, At).call(this, []);
      } catch (f) {
        C(this, ee, At).call(this, jn(f)), this.editorState.errors.length && ((r = ui.notifications) == null || r.warn(this.editorState.errors[0]));
      }
      this.render(!1);
      return;
    case "addRow":
      C(this, ee, wa).call(this), this.editorState.rows.push(((o = (s = this.definition).createEmptyRow) == null ? void 0 : o.call(s)) ?? {}), C(this, ee, At).call(this, []), this.render(!1);
      return;
    case "removeRow":
      C(this, ee, wa).call(this), this.editorState.rows.splice(Number(((l = n == null ? void 0 : n.dataset) == null ? void 0 : l.index) ?? -1), 1), C(this, ee, At).call(this, []), this.render(!1);
      return;
    case "moveRowUp":
      C(this, ee, wa).call(this), C(this, ee, co).call(this, Number(((c = n == null ? void 0 : n.dataset) == null ? void 0 : c.index) ?? -1), -1), C(this, ee, At).call(this, []), this.render(!1);
      return;
    case "moveRowDown":
      C(this, ee, wa).call(this), C(this, ee, co).call(this, Number(((u = n == null ? void 0 : n.dataset) == null ? void 0 : u.index) ?? -1), 1), C(this, ee, At).call(this, []), this.render(!1);
      return;
    case "loadBulk":
      try {
        const f = this.definition.parseBulk(C(this, ee, nn).call(this));
        this.editorState.rows = this.definition.toRows(f), this.editorState.bulkText = this.definition.serializeBulk(f), this.editorState.tab = "rows", C(this, ee, At).call(this, []);
      } catch (f) {
        C(this, ee, At).call(this, jn(f)), this.editorState.errors.length && ((d = ui.notifications) == null || d.warn(this.editorState.errors[0]));
      }
      this.render(!1);
      return;
    case "formatBulk":
      try {
        const f = this.definition.parseBulk(C(this, ee, nn).call(this));
        this.editorState.bulkText = this.definition.serializeBulk(f), C(this, ee, At).call(this, []);
      } catch (f) {
        C(this, ee, At).call(this, jn(f)), this.editorState.errors.length && ((m = ui.notifications) == null || m.warn(this.editorState.errors[0]));
      }
      this.render(!1);
      return;
    case "resetSetting":
      C(this, ee, ar).call(this, C(this, ee, nr).call(this)), this.render(!1);
      return;
    case "restoreDefaults":
      C(this, ee, ar).call(this, this.definition.defaultData()), this.render(!1);
      return;
    case "cancel":
      await this.close();
      return;
  ...
  this.editorState.rows = this.definition.toRows(t), this.editorState.bulkText = this.definition.serializeBulk(t), this.editorState.tab = "rows", C(this, ee, At).call(this, []);
}, nr = function() {
  const t = game.settings.get(T, this.definition.settingKey);
  return foundry.utils.deepClone(t ?? this.definition.defaultData());
}, wa = function() {
  this.editorState.rows = C(this, ee, uo).call(this);
}, uo = function() {
  ...
  const r = t.type ?? "text", s = String((i == null ? void 0 : i[t.key]) ?? t.default ?? ""), o = r === "select" ? Ub(t).map((l) => ({
...
const mo = "sceneModifierTemplates", Hb = "sceneModifierTemplateEditor", jb = Object.freeze([]);
function Fi(a) {
  const e = String(a ?? "").trim();
  return e === "" ? "" : e;
}
function Im(a = []) {
  ...
  if ((Array.isArray(a) ? a : []).forEach((n, r) => {
    ...
    e.push({
      label: s,
      value: Math.trunc(c),
      attributeFilter: Fi(n == null ? void 0 : n.attributeFilter),
      intentFilter: Fi(n == null ? void 0 : n.intentFilter)
    });
  }), t.length) throw xt(t);
  return e;
}
function Kb(a = []) {
  return (Array.isArray(a) ? a : []).map((e) => ({
    ...
    attributeFilter: Fi(e == null ? void 0 : e.attributeFilter),
    intentFilter: Fi(e == null ? void 0 : e.intentFilter)
  }));
}
function Wb(a = "") {
  const e = String(a ?? "").trim();
  ...
  return Im(t.map((i) => ({
    ...
    attributeFilter: Fi(i == null ? void 0 : i.attributeFilter),
    intentFilter: Fi(i == null ? void 0 : i.intentFilter)
  })));
}
function Gb(a = []) {
...
const qb = {
  ...
  defaultData: () => foundry.utils.deepClone(jb),
  createEmptyRow: () => ({
    label: "",
    value: "0",
    attributeFilter: "",
...
const { ApplicationV2: Yb, HandlebarsApplicationMixin: Qb } = foundry.applications.api, Jb = "mwd-gmgadget", Dm = "gmDnPresets", rr = "gmNextDn", rn = "gmDnAnnounceToChat", Xb = Object.freeze([
  { label: "Standard", dn: 1 },
  { label: "Challenging", dn: 2 },
  { label: "Hard", dn: 3 },
  { label: "Extreme", dn: 4 }
]), Zb = "systems/mwd/templates/v2/mwd-gmgadget.hbs", sn = Object.freeze({
  actorId: "",
  mode: "physical",
  delta: 1,
  useArmor: !1,
...
function aS() {
  return foundry.utils.deepClone(Xb);
}
function On(a, { strict: e = !1 } = {}) {
  const t = typeof a == "string" ? tS(a) : Array.isArray(a) ? a : [], i = [], n = [], r = /* @__PURE__ */ new Set();
  if (t.forEach((s, o) => {
...
const Je = class Je extends Qb(Yb) {
  constructor({ systemId: e = "mwd", ...t } = {}) {
    super(t), this.systemId = e, this.activeTab = "difficulty", this.harmState = vs(), this.hazardState = ks();
  }
  async render(e = {}) {
    var t;
  ...
  async _prepareContext(e) {
    var y, b, A, w;
    const t = await super._prepareContext(e), i = On(
      game.settings.get(this.systemId, Dm),
      { strict: !1 }
    ), n = Number(game.settings.get(this.systemId, rr) ?? 1), r = !!game.settings.get(this.systemId, rn), s = vs(this.harmState), o = Tt.getActorOptions({ mode: s.mode }), l = Tt.getSceneTarget({ mode: s.mode }), c = this.harmState.actorId ? ((b = (y = game.actors) == null ? void 0 : y.get) == null ? void 0 : b.call(y, this.harmState.actorId)) ?? null : null, u = Tt.resolveTarget({
      actor: c,
      actorId: this.harmState.actorId,
      preferSceneTarget: !0,
      mode: s.mode
    }), d = oS(u.actor ?? c ?? null);
    d.length && !d.some((v) => v.value === s.statusId) && (s.statusId = d[0].value, this.harmState.statusId = s.statusId);
    const m = xc(
      game.settings.get(this.systemId, mo)
    ), f = $c(
      (A = canvas == null ? void 0 : canvas.scene) == null ? void 0 : A.getFlag("mwd", ir)
    ), p = _c(), h = nS(p), g = ks(this.hazardState);
  ...
  async _onSetDn(e, t) {
    ...
    if (await game.settings.set(this.systemId, rr, i), !!game.settings.get(this.systemId, rn)) {
  ...
  async _onClearDn(e, t) {
    ...
    if (e.preventDefault(), e.stopPropagation(), !!((i = game.user) != null && i.isGM))
      return await game.settings.set(this.systemId, rr, 1), this.render({ parts: ["body"] });
  }
  ...
  async _onCreateHazard(e, t) {
    ...
    const i = this._captureHazardStateFromDom(t), n = _c(), r = Nu(n);
  ...
  async _mutateSceneModifiers(e) {
    ...
    if (!t) return;
    const i = $c(t.getFlag("mwd", ir)), n = await e(i);
    return await t.setFlag("mwd", ir, n), this.render({ parts: ["body"] });
  }
...
O(Je, "DEFAULT_OPTIONS", {
  ...
  actions: {
    switchTab: Je.prototype._onSwitchTab,
    setDn: Je.prototype._onSetDn,
    clearDn: Je.prototype._onClearDn,
    toggleAnnounce: Je.prototype._onToggleAnnounce,
    harmInputChange: Je.prototype._onHarmInputChange,
    refreshHarmTarget: Je.prototype._onRefreshHarmTarget,
    applyHarm: Je.prototype._onApplyHarm,
    hazardInputChange: Je.prototype._onHazardInputChange,
    refreshHazardTemplate: Je.prototype._onRefreshHazardTemplate,
    createHazard: Je.prototype._onCreateHazard,
    addSceneModifierFromPreset: Je.prototype._onAddSceneModifierFromPreset,
    addSceneModifierAdhoc: Je.prototype._onAddSceneModifierAdhoc,
    toggleSceneModifier: Je.prototype._onToggleSceneModifier,
...
function $c(a) {
  return Array.isArray(a) ? a.map((e) => {
    var r, s;
    const t = Mm(e), i = ((r = yl.find((o) => o.value === (t.attributeFilter ?? ""))) == null ? void 0 : r.label) ?? null, n = ((s = bl.find((o) => o.value === (t.intentFilter ?? ""))) == null ? void 0 : s.label) ?? null;
    return {
      ...t,
...
let Ms = null;
function cS({ systemId: a = "mwd" } = {}) {
  return Ms || (Ms = new fo({ systemId: a })), Ms;
}
const uS = "gmDnPresetEditor";
function dS(a = []) {
  const e = [], t = [], i = /* @__PURE__ */ new Set();
  if ((Array.isArray(a) ? a : []).forEach((n, r) => {
  ...
  return On(e, { strict: !0 });
}
function mS(a = []) {
  return On(a, { strict: !1 }).map((e) => ({
    label: e.label,
    dn: String(e.dn)
  }));
}
...
const yS = "lifeModuleCatalogEditor";
function bS(a = []) {
...
const kS = "personalActionCatalogEditor", zc = Object.freeze([
  { value: "false", label: "No" },
  { value: "true", label: "Yes" }
]);
function MS(a = []) {
...
const IS = "skillSpecializationEditor";
function po() {
  return hr().map((a) => ({
    value: a.code,
    label: a.label
...
function DS(a = []) {
  ...
  return xr(t, { strict: !0 });
}
function OS(a = {}) {
  const e = xr(a, { strict: !1 });
...
const BS = "statusConditionCatalogEditor";
function zS(a = []) {
  try {
...
const jS = {
  ...
  rowSchema: [
    ...
    { key: "manual", label: "Manual", type: "select", options: () => Hl },
    { key: "managed", label: "Managed", type: "select", options: () => Hl },
...
class WS {
  static register() {
    gS(), vS(), NS(), $S(), Vb(), KS(), game.settings.register(T, "useDestinyMechanics", {
...
function ta(a, e = "Unable to execute roll.") {
  var i, n;
...
function YS({
  ...
  for (const o of a.querySelectorAll(t)) {
    if (!Lm(o) || o.closest("prose-mirror") || o.disabled) continue;
    const l = String(o.getAttribute("name") ?? o.name ?? "").trim();
    if (!l || r.has(l)) continue;
    let c = VS(o);
    c === wr || (typeof i == "function" && (c = i(l, c)), (e ? foundry.utils.getProperty(e, l) : void 0) === c) || (s[l] = c);
  }
  return s;
}
const { HandlebarsApplicationMixin: QS } = foundry.applications.api, { HTMLField: JS } = foundry.data.fields;
function XS(a) {
  const e = new JS({ required: !1, blank: !0, initial: "" });
  return e.name = a, e;
}
var Kt, kn, Pi, Yi, Ui, ho, go;
const Ke = class Ke extends QS(foundry.applications.sheets.ActorSheetV2) {
  constructor() {
    super(...arguments);
    we(this, Ui);
    we(this, Kt, !1);
    /** Track active CSB tab per group across rerenders */
    we(this, kn, /* @__PURE__ */ new Map());
    // group -> tabId
    we(this, Pi, /* @__PURE__ */ new Map());
    ...
    if (this.isEditable) {
      if (j(this, Kt)) {
        this._commitEditsToActor().finally(() => {
          Pe(this, Kt, !j(this, Kt)), this.render({ force: !0 });
        });
        return;
      }
      Pe(this, Kt, !j(this, Kt)), this.render({ force: !0 });
  ...
  _restoreScrollPosition() {
    ...
    i(), requestAnimationFrame(i), Pe(this, Yi, null);
  }
  /**
  ...
  _onClickTab(t, i) {
    ...
    j(this, kn).set(o, r), C(this, Ui, ho).call(this, s, r);
  }
  _onClickAccordion(t, i) {
    ...
    if (!s || !r) return;
    const o = s.dataset.group || "default", c = (j(this, Pi).has(o) ? j(this, Pi).get(o) : s.dataset.default || null) === r ? null : r;
    j(this, Pi).set(o, c), C(this, Ui, go).call(this, s, c);
  }
  /**
  ...
  async _onRollAction(t, i) {
    ...
    try {
      ...
      return console.error("MWD | Failed to execute roll action", b), ta(b, "Unable to execute that roll."), null;
    }
  }
  ...
  _onRender(t, i) {
    ...
    if (n) {
      for (const l of n.querySelectorAll(".csb-tabs")) {
        const c = l.dataset.group || "default", u = j(this, kn).get(c), d = l.dataset.default || ((s = l.querySelector(".csb-tab-link[data-tab]")) == null ? void 0 : s.dataset.tab), m = u || d;
        m && C(this, Ui, ho).call(this, l, m);
      }
      for (const l of n.querySelectorAll(".csb-accordion")) {
        const c = l.dataset.group || "default", u = j(this, Pi).has(c) ? j(this, Pi).get(c) : l.dataset.default || null;
        C(this, Ui, go).call(this, l, u);
      }
  ...
  async _prepareContext(t) {
    ...
    return r.options.owner = r.owner, r.options.limited = r.limited, r.options.editable = r.editable, r.options.editing = r.editing, r.options.viewMode = !r.editing, r.skillsDisplay = td(((m = this.actor) == null ? void 0 : m.system) ?? {}), r.bio = {
      ...r.bio ?? {},
      fields: {
        history: XS("system.biography.history")
      }
    }, r.items ?? (r.items = {}), (f = this.actor) != null && f.items && typeof (de == null ? void 0 : de.classifyInto) == "function" && (de.classifyInto(r.items, this.actor.items), r.items.weapon = [
      ...r.items.mechWeapon ?? [],
  ...
  async _onMonitorSet(t, i) {
    ...
    const n = ((h = i == null ? void 0 : i.closest) == null ? void 0 : h.call(i, "[data-action='monitorSet']")) ?? ((y = (g = t == null ? void 0 : t.target) == null ? void 0 : g.closest) == null ? void 0 : y.call(g, "[data-action='monitorSet']")) ?? i, r = String(((b = n == null ? void 0 : n.dataset) == null ? void 0 : b.monitor) ?? "").trim(), s = Number((A = n == null ? void 0 : n.dataset) == null ? void 0 : A.value);
...
Kt = new WeakMap(), kn = new WeakMap(), Pi = new WeakMap(), Yi = new WeakMap(), Ui = new WeakSet(), /**
...
O(Ke, "DEFAULT_OPTIONS", foundry.utils.mergeObject(Xt(Ke, Ke, "DEFAULT_OPTIONS"), {
...
function sr(a) {
  ...
  const e = {
    ...a,
    template: a.template ?? ZS(a),
    classes: eA(a.classes),
    children: Array.isArray(a.children) ? a.children.map(sr) : []
  };
  return a.type === "tabs" && (e.tabs = Array.isArray(a.tabs) ? a.tabs.map((t) => ({
    ...t,
    children: Array.isArray(t.children) ? t.children.map(sr) : []
...
function Fc(a = {}) {
  return {
    ...a,
    root: sr(a.root ?? { type: "stack", children: [] })
  };
}
var Ni, Rr, _m;
class ua {
  static async get(e) {
    if (j(this, Ni).has(e)) {
      const n = await j(this, Ni).get(e);
      if (Number((n == null ? void 0 : n.version) ?? 0) > 0) return n;
      j(this, Ni).delete(e);
    }
    const t = C(this, Rr, _m).call(this, e);
    j(this, Ni).set(e, t);
    const i = await t;
    return Number((i == null ? void 0 : i.version) ?? 0) <= 0 && j(this, Ni).delete(e), i;
  }
}
Ni = new WeakMap(), Rr = new WeakSet(), _m = async function(e) {
  ...
  try {
    ...
    return console.error(`${Ce}LayoutRegistry.get FAILED`, { layoutId: e, url: t, error: i }), Fc({
      id: e,
      version: 0,
      root: { type: "stack", children: [] }
    });
  }
}, we(ua, Rr), we(ua, Ni, /* @__PURE__ */ new Map());
function wn(a, e = 0) {
  const t = Number(a);
  return Number.isFinite(t) ? t : e;
}
...
function iA({ armor: a = {}, structure: e = {} } = {}) {
  const t = [
    Hc("A", a),
    Hc("S", e)
  ];
...
async function oA({ attacker: a = null, ctx: e = {}, target: t = {} } = {}) {
  var x, K, q, H, W, _, F, V, Y, re, ce, ue, oe, Re, Ie, _e, rt, st, ot, qe, lt, Ze;
  const i = await $m(t), n = Math.max(0, Number(((H = (K = (x = e == null ? void 0 : e.attack) == null ? void 0 : x.weapon) == null ? void 0 : K.attackRatingBand) == null ? void 0 : H[(q = e == null ? void 0 : e.attack) == null ? void 0 : q.rangeBand]) ?? 0) || 0), r = Jr(i), s = r ? S.actorAttributes.handling : "reflexes", o = rA(t, i, s), l = o + o, c = String(((_ = (W = e == null ? void 0 : e.attack) == null ? void 0 : W.skill) == null ? void 0 : _.code) ?? ((V = (F = e == null ? void 0 : e.attack) == null ? void 0 : F.weapon) == null ? void 0 : V.skill) ?? "").trim(), u = String(((re = (Y = e == null ? void 0 : e.attack) == null ? void 0 : Y.skill) == null ? void 0 : re.label) ?? c ?? "Attack Skill").trim() || "Attack Skill", d = c ? Math.max(0, es(((ce = a == null ? void 0 : a.getSkillRating) == null ? void 0 : ce.call(a, c)) ?? ((Re = (oe = (ue = a == null ? void 0 : a.system) == null ? void 0 : ue.skills) == null ? void 0 : oe[c]) == null ? void 0 : Re.rating), 0)) : 0, m = r ? "piloting" : "tactics", f = r ? "Piloting" : "Tactics", p = sA(t, i, m), h = d - p, g = Math.abs(h), y = Math.max(0, Number(((Ie = t == null ? void 0 : t.activeArmor) == null ? void 0 : Ie.defenseBonus) ?? 0) || 0), b = String(((_e = e == null ? void 0 : e.attack) == null ? void 0 : _e.rangeBand) ?? "").trim() || "range", w = [{
    id: "weapon.attackRating",
    label: `Weapon AR (${((st = (rt = e == null ? void 0 : e.attack) == null ? void 0 : rt.weapon) == null ? void 0 : st.type) === "personalWeapon" || (qe = (ot = e == null ? void 0 : e.attack) == null ? void 0 : ot.weapon) != null && qe.isSynthetic ? Kr(b) : b})`,
    value: n
  }], v = [{
  ...
  h > 0 ? w.push({
    ...
    label: `${f} over ${u}`,
    value: g
  }), (Ze = (lt = e == null ? void 0 : e.attack) == null ? void 0 : lt.aim) != null && Ze.eligible && w.push({
    id: "state.aim",
    label: `Aim (${u})`,
    value: d
  }), v.push({
...
function lA(a = {}, e = {}) {
  ...
  const t = (a == null ? void 0 : a.attack) ?? {}, i = String(((h = (p = t == null ? void 0 : t.payload) == null ? void 0 : p.modifies) == null ? void 0 : h.damageType) ?? "").trim(), n = Math.max(0, Number(((g = t == null ? void 0 : t.weapon) == null ? void 0 : g.damage) ?? 0) || 0), r = !!(a != null && a.targetIsMachine), s = i || ((y = t == null ? void 0 : t.weapon) == null ? void 0 : y.damageType), o = r ? String(s ?? "kinetic").trim() || "kinetic" : Yt(s, "concussive"), l = Math.max(0, Number((t == null ? void 0 : t.totalAp) ?? ((b = t == null ? void 0 : t.weapon) == null ? void 0 : b.ap) ?? 0) || 0), c = e.outcome === "graze" ? n / 2 : e.outcome === "hit" ? n : 0, u = c + Number(e.netHits ?? 0), d = Go((t == null ? void 0 : t.currentExposure) ?? zi({
    tier: ((A = t == null ? void 0 : t.currentExposure) == null ? void 0 : A.initialTier) ?? ((w = t == null ? void 0 : t.currentExposure) == null ? void 0 : w.tier) ?? "none"
  }), {
    active: !!(t != null && t.evadeActive),
    locked: !!(t != null && t.evadeLocked)
  }), m = Ti((t == null ? void 0 : t.areaEffect) ?? ((v = t == null ? void 0 : t.payload) == null ? void 0 : v.areaEffect) ?? {}), f = m.kind === It.persistent ? u : ia(u, d.finalTier);
  return {
    baseDamage: n,
...
function Vi(a, e = {}, t = {}, { queued: i = !1, applied: n = !1, skipped: r = !1, reason: s = "" } = {}) {
  return r ? {
    ok: !0,
    skipped: !0,
    queued: !1,
...
async function uA({ attacker: a, ctx: e, target: t, outcome: i, damage: n } = {}) {
  var d, m;
  if ((i == null ? void 0 : i.outcome) === "miss")
    return Vi(null, t, n, { skipped: !0, reason: "Missed target." });
  ...
  try {
    ...
    return console.warn("MWD | Unable to resolve target for queued attack damage", t, f), Vi(null, t, n, { reason: "Unable to resolve attack target." });
  }
  const l = Jr(s) ? Zd({
    actor: s,
    rollTotal: Xd(),
    armorBefore: Kc(s, S.monitors.armor),
    structureBefore: Kc(s, S.monitors.structure)
  ...
  if (u != null && u.ok) {
    const f = Vi(u, t, n, { queued: !0, applied: !1 }), p = Wc({ attacker: a, ctx: e, damage: n, targetActor: s, hitLocation: l });
  ...
  return Vi(u, t, n, { reason: "Unable to preview attack damage." });
}
async function dA({ attacker: a, ctx: e, outcomeModel: t, target: i, previewState: n = {} } = {}) {
  var b, A;
  const r = await oA({ attacker: a, ctx: e, target: i }), s = await $m(i), o = Number((t == null ? void 0 : t.margin) ?? 0), l = Number(r.value ?? 0), c = o;
  ...
  const d = u === "hit" ? Math.max(0, c) : 0, m = (e == null ? void 0 : e.attack) ?? {}, f = cA(i), p = (n == null ? void 0 : n[f]) ?? {}, h = (i == null ? void 0 : i.exposure) ?? zi({ tier: "none" }), g = lA({
    ...e,
    targetIsMachine: Jr(s),
    attack: {
      ...m,
      currentExposure: h,
      areaEffect: (m == null ? void 0 : m.areaEffect) ?? ((A = m == null ? void 0 : m.payload) == null ? void 0 : A.areaEffect) ?? null,
      evadeActive: !!(p != null && p.evadeActive),
      evadeLocked: !!(h != null && h.evadeLocked)
    }
  }, { outcome: u, netHits: d }), y = await uA({
    attacker: a,
    ctx: e,
    target: i,
    outcome: { outcome: u },
...
async function Bm({ attacker: a, ctx: e, outcomeModel: t, previewState: i = {}, existingAttackResult: n = null } = {}) {
  var c, u, d, m, f, p;
  const r = nA(e), s = [];
  for (const h of r)
    s.push(await dA({ attacker: a, ctx: e, outcomeModel: t, target: h, previewState: i }));
...
function zm(a, e = 1) {
  var i;
  const t = je((i = a == null ? void 0 : a.difficulty) == null ? void 0 : i.dn, je(e, 1));
  return Math.max(0, t);
}
function fA(a, e) {
  return Math.max(0, je(a, 0) - je(e, 0));
}
function pA({ convert: a, remainder: e, rate: t = 4 } = {}) {
  const i = Math.max(0, je(e, 0)), n = Math.max(1, je(t, 4)), r = Math.max(0, je(a, 0)), s = Math.floor(r / n) * n;
  return Math.min(i, s);
}
function Al(a, { rate: e = 4, maxPerRoll: t = Number.POSITIVE_INFINITY } = {}) {
  const i = Math.max(1, je(e, 4)), n = Math.floor(Math.max(0, je(a, 0)) / i), r = Number.isFinite(t) ? Math.max(0, je(t, 0)) : Number.POSITIVE_INFINITY;
...
function Tl(a) {
  ...
  return {
    ...
    rate: Math.max(1, je(e == null ? void 0 : e.rate, 4)),
...
function Fm(a, e) {
  if (je(a, 0) !== 0) return !1;
  const { dice: t, ones: i } = hA(e);
  return t <= 0 ? !1 : i >= Math.ceil(t / 2);
}
function gA(a, e, t = 4) {
  return !!(a && je(e, 0) >= je(t, 4));
}
function Gc(a, e) {
  const t = je(e == null ? void 0 : e.successes, 0), i = zm(a, 1), n = t >= i, r = t - i, s = gA(n, r, 4), o = Fm(t, e == null ? void 0 : e.raw), l = Tl(a), c = l.maxPerRoll ?? 1, u = l.enabled && r >= l.rate ? (() => {
    const { amount: m, rate: f } = Al(r, { rate: l.rate, maxPerRoll: c }), p = vr(a);
...
function yA(a, e, t) {
  var m, f;
  const i = je(e == null ? void 0 : e.successes, 0), n = je(t == null ? void 0 : t.successes, 0), r = !!((m = a == null ? void 0 : a.opposed) != null && m.net), s = String(((f = a == null ? void 0 : a.opposed) == null ? void 0 : f.dnTies) ?? "stalemate");
  let o = null, l = !1;
  ...
  const c = Tl(a), u = c.maxPerRoll ?? 1, d = c.enabled && r && typeof o == "number" && o >= c.rate ? (() => {
    const { amount: p, rate: h } = Al(o, { rate: c.rate, maxPerRoll: u }), g = vr(a);
...
function bA(a, e) {
  var h, g, y;
  const t = je(e == null ? void 0 : e.successes, 0), i = zm(a, 1), n = t >= i, r = Fm(t, e == null ? void 0 : e.raw), s = fA(t, i), o = ((h = a == null ? void 0 : a.net) == null ? void 0 : h.convert) ?? ((g = a == null ? void 0 : a.allocation) == null ? void 0 : g.convert) ?? 0, l = Tl(a), c = l.rate, u = pA({ convert: o, remainder: s, rate: c }), d = s - u, m = l.enabled && u >= c ? (() => {
    const { amount: b } = Al(u, { rate: c, maxPerRoll: l.maxPerRoll }), A = vr(a);
    return b > 0 ? { amount: b, pool: A, reason: "convert4", details: { converted: u, rate: c } } : null;
  })() : null, f = r ? { amount: 1, pool: vr(a), reason: "critFail", details: { onesRule: "halfOrMoreOnes" } } : null, p = [];
...
function SA(a, e) {
  var o, l, c, u;
  const t = je(e == null ? void 0 : e.successes, 0), i = Cs((o = a == null ? void 0 : a.extended) == null ? void 0 : o.target, 1, 1e4), n = Cs((l = a == null ? void 0 : a.extended) == null ? void 0 : l.accumulated, 0, 1e4), r = Cs(n + t, 0, 1e4), s = r >= i;
  return {
    rollType: "extended",
    passed: s,
    successes: t,
...
function AA(a, e) {
  ...
  if (i.length) {
    ...
    e.metaRows.push({
      text: `Mods: ${i.map((A) => `${A.label} ${qc(A.value)}`).join(", ")} (Total ${qc(n)})`,
...
function TA(a, e) {
  var g, y, b, A, w, v, R, E, x, K, q, H, W, _, F, V, Y, re, ce, ue, oe, Re, Ie, _e, rt, st, ot, qe, lt, Ze, Ve, bt, vt, kt, Mt;
  const t = a ?? {}, i = (t == null ? void 0 : t.attackResult) ?? null;
  if (!i) return;
  const n = Array.isArray(i == null ? void 0 : i.results) ? i.results : [], r = (i == null ? void 0 : i.summary) ?? vA(n), s = n.some((N) => {
    var U;
    return !!((U = N == null ? void 0 : N.queuedMutation) != null && U.applied);
  }), o = n.filter(
    (N) => (N == null ? void 0 : N.queuedMutation) && !N.queuedMutation.applied
  ), l = !!((y = (g = t == null ? void 0 : t.attack) == null ? void 0 : g.capabilityReport) != null && y.isTemplated), c = Array.isArray((b = t == null ? void 0 : t.modifiers) == null ? void 0 : b.applied) ? t.modifiers.applied : [], u = Number(((A = t == null ? void 0 : t.modifiers) == null ? void 0 : A.total) ?? 0);
  if (c.length) {
  ...
  const d = (t == null ? void 0 : t.edge) ?? null, m = Array.isArray((w = t == null ? void 0 : t.roll) == null ? void 0 : w.failureDiceRefs) ? t.roll.failureDiceRefs : [], f = !!((v = d == null ? void 0 : d.availableActions) != null && v.canPostRerollFailures) && !s, p = Array.isArray((R = d == null ? void 0 : d.allowed) == null ? void 0 : R.postPools) ? d.allowed.postPools : [];
  ...
  if (e.outcomeText = n.length > 1 ? `ATTACK ${r.hits} HIT / ${r.grazes} GRAZE / ${r.misses} MISS` : h === "hit" ? "HIT!" : h === "graze" ? "GRAZE!" : "MISS!", e.metaRows.push({
    ...
    var et, dt, Ot, ie, Te, ct, ut, mt;
    const ge = ((et = t == null ? void 0 : t.areaEffectPreviewState) == null ? void 0 : et[N == null ? void 0 : N.previewKey]) ?? {}, ae = ((dt = N == null ? void 0 : N.damage) == null ? void 0 : dt.exposure) ?? (N == null ? void 0 : N.exposure) ?? null, De = String((ae == null ? void 0 : ae.initialLabel) ?? "NONE").trim() || "NONE", M = String((ae == null ? void 0 : ae.finalLabel) ?? De).trim() || De, P = Number(((Ot = N == null ? void 0 : N.damage) == null ? void 0 : Ot.incoming) ?? 0), Q = Number(((ie = N == null ? void 0 : N.damage) == null ? void 0 : ie.scaledIncoming) ?? P), ne = (N == null ? void 0 : N.queuedMutation) ?? null, te = !!(ne != null && ne.applied || (Te = N == null ? void 0 : N.damageResult) != null && Te.applied), be = (ge == null ? void 0 : ge.reactionPreview) ?? null, Be = [];
    if (!te && De !== "NONE" && ((ct = N == null ? void 0 : N.damageResult) != null && ct.ok) && !((ut = N == null ? void 0 : N.damageResult) != null && ut.skipped) && Be.push({
      action: "toggleEvade",
      ...
      for (const Ye of be.edgePools)
        Be.push({
          action: "toggleEvadeEdge",
          label: (ge == null ? void 0 : ge.edgePoolKey) === Ye.key ? `Edge: ${Ye.key}` : `Use ${Ye.key}`,
          dataset: {
            "preview-key": N.previewKey,
            "pool-key": Ye.key
          },
          cssClass: `mwd-target-row__action ${(ge == null ? void 0 : ge.edgePoolKey) === Ye.key ? "is-active" : ""}`
        });
    return ne && !te && Be.push({
      ...
      exposureLabel: De === M ? De : `${De} -> ${M}`,
      damageLabel: P === Q ? String(Q) : `${P} -> ${Q}`,
    ...
    for (const N of n) {
      const U = Number(((W = (H = N == null ? void 0 : N.cq) == null ? void 0 : H.ar) == null ? void 0 : W.total) ?? 0), ge = Number(((F = (_ = N == null ? void 0 : N.cq) == null ? void 0 : _.dr) == null ? void 0 : F.total) ?? 0);
      e.metaRows.push({
  ...
  if (!l)
    for (const [N, U] of n.entries()) {
      ...
      ge && (U == null ? void 0 : U.outcome) !== "miss" && e.footerRows.push({
        text: `${((re = U == null ? void 0 : U.target) == null ? void 0 : re.name) ?? "Target"}: ${ge.damageTypeLabel} ${Ma(ge.effectiveWeaponDamage)} weapon${ge.netHits ? ` + ${ge.netHits} net` : ""}`,
        title: ""
      });
      const ae = (U == null ? void 0 : U.damageResult) ?? null;
      if (ae != null && ae.ok && !(ae != null && ae.skipped)) {
        const De = (U == null ? void 0 : U.queuedMutation) ?? (ae == null ? void 0 : ae.queuedMutation) ?? null, M = !!(De != null && De.applied || ae != null && ae.applied);
        if (ae.mode === "machineAttackDamage") {
          const P = ae.machine ?? {}, Q = ae.hitLocation ?? {}, ne = ae.degradation ?? null;
          e.footerRows.push({
            text: `${((ce = U == null ? void 0 : U.target) == null ? void 0 : ce.name) ?? "Target"}: Location ${Q.locationLabel ?? "Location"}${Q.rollTotal ? ` (${Q.rollTotal})` : ""} | Armor ${Number(P.armorBefore ?? 0)} -> ${Number(P.armorAfter ?? 0)} | Structure ${Number(P.structureBefore ?? 0)} -> ${Number(P.structureAfter ?? 0)}`,
            title: ""
          }), ne != null && ne.summary && e.footerRows.push({
            text: `${((ue = U == null ? void 0 : U.target) == null ? void 0 : ue.name) ?? "Target"}: Shock ${Number(ne.summary.shockBefore ?? 0)} -> ${Number(ne.summary.shockAfter ?? 0)} | Threshold ${Number(ne.summary.threshold ?? 0)} | Reliability ${Number(ne.summary.reliability ?? 0)} | Reserve ${Number(ne.summary.reliabilitySpendableBefore ?? 0)} -> ${Number(ne.summary.reliabilitySpendableAfter ?? 0)}`,
            title: ""
          }), (oe = ae.critical) != null && oe.automatic ? e.footerRows.push({
            text: `${((Re = U == null ? void 0 : U.target) == null ? void 0 : Re.name) ?? "Target"}: Automatic critical pending`,
            title: ""
          }) : (Ie = ae.critical) != null && Ie.optional ? e.footerRows.push({
            text: `${((_e = U == null ? void 0 : U.target) == null ? void 0 : _e.name) ?? "Target"}: Chaos Edge can convert this location hit to a critical`,
            title: ""
          }) : e.footerRows.push({
            text: `${((rt = U == null ? void 0 : U.target) == null ? void 0 : rt.name) ?? "Target"}: Location hit is descriptive only`,
            title: ""
          });
          for (const te of ((st = ae.critical) == null ? void 0 : st.records) ?? [])
            e.footerRows.push({
              text: `${((ot = U == null ? void 0 : U.target) == null ? void 0 : ot.name) ?? "Target"}: Critical - ${te.label}${te.locationLabel ? ` (${te.locationLabel})` : ""}`,
              title: ""
            }), M && te.active !== !1 && te.remedyKey !== "none" && e.actions.push({
              action: "machineCritRemedy",
              label: `Remedy: ${te.label}`,
              dataset: {
                "machine-actor-uuid": ((qe = U == null ? void 0 : U.target) == null ? void 0 : qe.actorUuid) ?? "",
                "crit-id": te.id,
                "remedy-key": te.remedyKey,
                "gm-override": "true"
              },
              cssClass: "mwd-machine-crit-remedy"
            });
          if (De && !M && Array.isArray(ne == null ? void 0 : ne.spendOpportunities))
            for (const te of ne.spendOpportunities)
              te != null && te.canSpend && e.actions.push({
                action: "toggleMachineReliabilitySpend",
                label: te.selected ? `Clear Reliability Spend: ${te.location}` : `Spend Reliability: ${te.location}`,
                dataset: {
                  "result-index": String(N),
                  "spend-index": String(te.index)
                },
                cssClass: `mwd-toggle-machine-reliability ${te.selected ? "is-active" : ""}`
              });
        }
        De && !M && ((lt = ae == null ? void 0 : ae.critical) != null && lt.optional) && e.actions.push({
          action: "toggleMachineChaosCrit",
          label: (Ze = De.payload) != null && Ze.chaosCriticalSelected ? `Clear Chaos Critical: ${ae.actorName ?? ((Ve = U == null ? void 0 : U.target) == null ? void 0 : Ve.name) ?? "Target"}` : `Spend Chaos Edge: ${ae.actorName ?? ((bt = U == null ? void 0 : U.target) == null ? void 0 : bt.name) ?? "Target"}`,
          dataset: { "result-index": String(N) },
          cssClass: `mwd-toggle-machine-chaos ${(vt = De.payload) != null && vt.chaosCriticalSelected ? "is-active" : ""}`
        }), De && !M && e.actions.push({
          action: "applyAttackDamage",
          label: `Apply Damage: ${ae.actorName ?? ((kt = U == null ? void 0 : U.target) == null ? void 0 : kt.name) ?? "Target"}`,
          dataset: { "result-index": String(N) },
          cssClass: "mwd-apply-attack-damage"
        });
      } else ae != null && ae.reason && e.footerRows.push({
        text: `${((Mt = U == null ? void 0 : U.target) == null ? void 0 : Mt.name) ?? "Target"}: ${ae.reason}`,
        title: ""
      });
    }
}
...
async function pa({ resolved: a } = {}) {
  const e = a ?? {}, t = PA(e), i = RA[t.intent];
...
async function DA(a) {
  if (!(IA(a).length || !(a != null && a.toggleStatusEffect)))
    try {
      await Ur({
        actor: a,
        statusId: om,
...
function OA(a, { passed: e = !1, actorUuid: t = "", gmOverride: i = !1 } = {}) {
  return e ? {
    ...a,
    active: !1,
...
async function ts(a = {}, e = {}) {
  var b, A, w, v, R, E, x, K, q;
  const t = String(a.critId ?? "").trim(), i = !!(e.gmOverride ?? ((A = (b = globalThis.game) == null ? void 0 : b.user) == null ? void 0 : A.isGM)), n = await NA(a.machineActorUuid);
  if (!n) return { ok: !1, reason: "Machine actor could not be resolved." };
  const r = Array.isArray((v = (w = n.system) == null ? void 0 : w.mwd) == null ? void 0 : v.crits) ? n.system.mwd.crits.slice() : [], s = r.findIndex((H) => String((H == null ? void 0 : H.id) ?? "") === t && (H == null ? void 0 : H.active) !== !1);
  ...
  const u = Zr(
    ((x = (E = (R = globalThis.foundry) == null ? void 0 : R.utils) == null ? void 0 : E.deepClone) == null ? void 0 : x.call(E, n.system ?? {})) ?? structuredClone(n.system ?? {}),
    n.type
  ), d = String(o.locationKey ?? "").trim(), m = ((q = (K = u.mwd) == null ? void 0 : K.locations) == null ? void 0 : q[d]) ?? {}, f = Number((m == null ? void 0 : m.condition) ?? 0) || 0, p = sm(f), h = em(o, l), g = tm(o, l), y = hl(o);
  return {
    ok: !0,
    machineActor: n,
    crit: o,
...
async function _A(a = {}, e = {}) {
  ...
  return r[t.critIndex] = o, await t.machineActor.update({ "system.mwd.crits": r }), await DA(t.machineActor), {
    ok: !0,
    passed: i,
...
function xA() {
  Hooks.on("renderChatMessageHTML", (a, e) => {
    e.addEventListener("click", (t) => {
      ...
      n && (n === "edgePostReroll" && nT(t, a), n === "toggleEvade" && qA(t, a), n === "toggleEvadeEdge" && VA(t, a), n === "toggleHazardEvade" && eT(t, a), n === "toggleHazardEvadeEdge" && tT(t, a), n === "applyHazardTick" && iT(t, a), n === "toggleMachineChaosCrit" && JA(t, a), n === "toggleMachineReliabilitySpend" && XA(t, a), n === "machineCritRemedy" && ZA(t), n === "applyAttackDamage" && WA(t, a), n === "applyAllAttackDamage" && YA(t, a));
    });
  });
}
function $A(a = {}) {
...
function UA({ actor: a = null, token: e = null } = {}) {
  var r;
  const t = (e == null ? void 0 : e.document) ?? e ?? null, i = String(((r = t == null ? void 0 : t.texture) == null ? void 0 : r.src) ?? "").trim(), n = String((a == null ? void 0 : a.img) ?? "").trim();
  return i || n || "icons/svg/mystery-man.svg";
}
...
function jA({ summary: a = {}, actor: e = null, token: t = null } = {}) {
  const i = String((a == null ? void 0 : a.damageType) ?? "").trim(), n = Qt(i || "concussive") || "Damage", r = BA(a == null ? void 0 : a.track), s = Math.max(0, Number((a == null ? void 0 : a.finalDamage) ?? (a == null ? void 0 : a.appliedDelta) ?? 0) || 0), o = FA(s), l = s === 1 ? "1 point" : `${s} points`, c = String((a == null ? void 0 : a.actorName) ?? (e == null ? void 0 : e.name) ?? "Target").trim() || "Target", u = [];
  return a != null && a.beforeLabel && (a != null && a.afterLabel) && u.push({
    ...
    classes: ["mwd-damage-card", zA(i), o.key].join(" "),
    header: {
      left: "Damage Applied",
      right: r
    },
...
async function Hm(a = {}, e = null) {
  var r, s, o;
  const t = KA(a), i = Number(((r = a == null ? void 0 : a.outcome) == null ? void 0 : r.hits) ?? 0) || 0, n = ((s = a == null ? void 0 : a.outcomeModel) == null ? void 0 : s.edgeEarned) ?? null;
  return a.outcomeModel = Um(t, { successes: i, raw: (o = a == null ? void 0 : a.roll) == null ? void 0 : o.json }, null), a.outcomeModel.edgeEarned = n, t.intent === "attack" && e && t.attack && (a.attackResult = await Bm({
    attacker: e,
    ctx: t,
...
async function YA(a, e) {
  var c, u, d, m, f, p, h, g, y;
  a.preventDefault();
  const t = foundry.utils.deepClone((u = (c = e == null ? void 0 : e.flags) == null ? void 0 : c.mwd) == null ? void 0 : u.resolved);
  if (!t) return;
  const n = (Array.isArray((d = t == null ? void 0 : t.attackResult) == null ? void 0 : d.results) ? t.attackResult.results : []).map((b, A) => ({ result: b, index: A })).filter(({ result: b }) => (b == null ? void 0 : b.queuedMutation) && !b.queuedMutation.applied).map(({ index: b }) => b);
  if (!n.length) {
  ...
  const s = [], o = [];
  for (const b of n) {
    const A = await jm(t, b);
    A.ok && A.applied ? (r += 1, o.push(A)) : A.ok || s.push(A.reason ?? `Target ${b + 1} failed.`);
  }
  if (r <= 0) {
...
async function QA({ machineActor: a = null, operatorActorUuid: e = "" } = {}) {
  var r, s, o, l, c, u, d, m;
  ...
  const i = S.counters.edgePools.chaos, n = Number(((o = (s = t.actor).getRemainingEdge) == null ? void 0 : o.call(s, i)) ?? ((c = (l = t.actor).getEdgePoolValue) == null ? void 0 : c.call(l, i)) ?? 0);
...
async function XA(a, e) {
  ...
  const l = new Set(
    Array.isArray((A = o.payload) == null ? void 0 : A.reliabilitySpendSelections) ? o.payload.reliabilitySpendSelections.map((R) => Number(R)).filter(Number.isInteger) : []
  );
  l.has(n) ? l.delete(n) : l.add(n), o.payload.reliabilitySpendSelections = Array.from(l).sort((R, E) => R - E);
  const c = (w = o.target) != null && w.actorUuid ? await fromUuid(o.target.actorUuid) : null, u = (v = o.target) != null && v.tokenUuid ? await fromUuid(o.target.tokenUuid) : null, d = await Tt.apply({
    actor: c,
    token: u,
    payload: o.payload,
    options: {
...
async function ZA(a, e) {
  ...
  a.preventDefault();
  const t = a.target.closest("[data-mwd-action='machineCritRemedy']"), i = await vl({
...
async function Km(a, e) {
  const t = e != null && e.actorUuid ? await fromUuid(e.actorUuid) : null, i = e != null && e.tokenUuid ? await fromUuid(e.tokenUuid) : null, n = await Dd(e, { actor: t, token: i });
  return await a.update({
    content: n,
    "flags.mwd.hazardCard": e
  }), e;
}
async function Rl(a, e) {
  var i, n;
  const t = ll(foundry.utils.deepClone(((n = (i = a == null ? void 0 : a.flags) == null ? void 0 : i.mwd) == null ? void 0 : n.hazardCard) ?? {}));
  return t != null && t.actorUuid ? (await e(t), await Km(a, t), t) : null;
}
async function Pl(a, e, { active: t = !1, edgePoolKey: i = "" } = {}) {
  var s, o, l;
...
async function eT(a, e) {
  ...
  const t = await Rl(e, async (r) => {
    ...
    if (r.preview ?? (r.preview = {}), r.preview.evadeActive = s, r.preview.edgePoolKey = null, r.preview.finalTier = o.finalTier, r.damageAfter = ia(r.baseDamage ?? 0, o.finalTier), s) {
      const d = await is({
...
async function tT(a, e) {
  var r, s, o;
  a.preventDefault();
  const t = a.target.closest("[data-mwd-action='toggleHazardEvadeEdge']"), i = String(((r = t == null ? void 0 : t.dataset) == null ? void 0 : r.poolKey) ?? "").trim(), n = await Rl(e, async (l) => {
...
async function iT(a, e) {
  var u, d, m, f, p, h, g, y, b, A, w, v, R, E, x, K, q, H, W, _, F;
  a.preventDefault();
  ...
  if ((g = t.preview) != null && g.evadeActive) {
    ...
    if (!(V != null && V.ok)) {
      (A = (b = ui.notifications) == null ? void 0 : b.warn) == null || A.call(b, (V == null ? void 0 : V.reason) ?? "Unable to spend the Evade reaction.");
      return;
    }
  }
  const r = {
  ...
  if (!(s != null && s.ok)) {
    (R = (v = ui.notifications) == null ? void 0 : v.warn) == null || R.call(v, (s == null ? void 0 : s.reason) ?? "Unable to apply hazard damage.");
    return;
  }
  const o = z.getSnapshot(i, { token: n }), l = ((E = o == null ? void 0 : o.hazards) == null ? void 0 : E[t.regionId]) ?? {}, c = Ue(t.nextTier, t.exposure.finalTier);
  await z.setHazardState(i, {
    ...
    hazardState: {
      ...
      evadeLocked: !!(l != null && l.evadeLocked) || !!(((K = t.exposure) == null ? void 0 : K.initialTier) === "full" && ((q = t.preview) == null ? void 0 : q.finalTier) === "major" && ((H = t.preview) != null && H.evadeActive))
    }
  ...
  }), await z.clearPendingReaction(i, { token: n }), t.applied = !0, t.applyReason = "Applied", await Km(e, t), await kl({
    summary: {
      actorName: i.name,
      track: s.track,
...
async function aT(a, { token: e = null } = {}) {
  var r, s;
  ...
  if (i.sourceKind === "hazard") {
    const o = await Rl(n, async (l) => {
      ...
      l.preview ?? (l.preview = {}), l.preview.evadeActive = !0, l.preview.edgePoolKey = l.preview.edgePoolKey ?? i.edgePoolKey ?? null, l.preview.finalTier = c.finalTier, l.damageAfter = ia(l.baseDamage ?? 0, c.finalTier);
      const u = await is({
        actorUuid: l.actorUuid,
        tokenUuid: l.tokenUuid,
        edgePoolKey: l.preview.edgePoolKey ?? ""
...
async function nT(a, e) {
  var p, h, g, y, b, A, w, v, R, E, x, K, q, H, W, _, F, V, Y;
  a.preventDefault();
  ...
  if (Number(((w = (A = n == null ? void 0 : n.edge) == null ? void 0 : A.post) == null ? void 0 : w.spent) ?? 0) === 1) return;
  if (!(Array.isArray((R = (v = n == null ? void 0 : n.edge) == null ? void 0 : v.allowed) == null ? void 0 : R.postPools) ? n.edge.allowed.postPools : []).includes(i)) {
  ...
  if (s.length <= 0) {
    (H = (q = ui.notifications) == null ? void 0 : q.info) == null || H.call(q, "No failures to reroll.");
    return;
  }
  ...
  const l = Number(((V = n == null ? void 0 : n.roll) == null ? void 0 : V.target) ?? 5), u = (Y = (await new Roll(`${s.length}d6cs>=${l}`).evaluate()).dice) == null ? void 0 : Y[0], d = Array.isArray(u == null ? void 0 : u.results) ? u.results : [], m = d.filter((re) => re.success).length;
  n.outcome = n.outcome ?? {}, n.outcome.hits = Number(n.outcome.hits ?? 0) + m, n.edge = n.edge ?? {}, n.edge.post = { poolKey: i, spent: 1 }, n.edge.availableActions = {
    ...
    termIndex: null,
    dice: d.map((re, ce) => {
      const ue = Number(re.result), oe = !!re.success;
      return {
        ref: `post:${ce}`,
        face: ue,
        isSuccess: oe,
        isFailure: !oe,
        tooltip: oe ? `Post die ${ce + 1}: ${ue} (Success vs TN ${l})` : `Post die ${ce + 1}: ${ue} (Failure vs TN ${l})`
      };
    })
  }), await Hm(n, o);
...
async function as({ weapon: a, event: e = null, token: t = null } = {}) {
  ...
  try {
    ...
    if (!l)
      throw new Error("Attack requires an owned personal weapon.");
    const c = sT(l, t), { payload: u, hasAim: d } = rT(a, c), m = ((n = game.mwd) == null ? void 0 : n.roll) ?? ((s = (r = game.system) == null ? void 0 : r.mwd) == null ? void 0 : s.roll);
    if (!(m != null && m.execute))
    ...
    return console.error("MWD | Failed to launch weapon attack", l), ta(l, "Unable to attack with that weapon."), null;
  }
}
async function oT(a, { event: e = null } = {}) {
  var n, r;
  const t = String(a ?? "").trim();
  if (!t)
...
async function cT(a, e) {
  ...
  if (!t) return;
  const i = String((a == null ? void 0 : a.name) ?? "Weapon Attack").trim() || "Weapon Attack", n = lT(t);
...
function Gm(a, e, t) {
  return (e == null ? void 0 : e.type) !== Nl ? !0 : (cT(e, t), !1);
}
function qm() {
  Yc || (Yc = !0, Hooks.on("hotbarDrop", Gm));
}
const Qc = {
  HOTBAR_ATTACK_TYPE: Nl,
  getOwnedWeaponAttackDragData: Wm,
  launchOwnedWeaponAttack: as,
  attackWeaponByUuid: oT,
  handleWeaponAttackHotbarDrop: Gm,
  registerWeaponAttackHotbarHook: qm
};
function Ee(a, e = 0) {
  const t = Number(a);
  return Number.isFinite(t) ? t : e;
...
function Xc({
  ...
  var p, h, g, y, b, A, w;
  const c = Math.max(0, Math.trunc(Ee(((p = a == null ? void 0 : a.system) == null ? void 0 : p.quantity) ?? 1, 1))), u = Math.max(0, Math.trunc(Ee(((h = a == null ? void 0 : a.system) == null ? void 0 : h.rating) ?? 0, 0))), d = Si(((g = a == null ? void 0 : a.system) == null ? void 0 : g.tags) ?? []), m = String(((y = a == null ? void 0 : a.system) == null ? void 0 : y.category) ?? "").trim(), f = n[m] ?? m;
  return {
    id: a.id,
    itemType: t,
    isGear: t === "gear",
    ...
    detailRows: cr([
      ...
      { label: r, value: u },
      { label: "Source", value: ((A = a == null ? void 0 : a.system) == null ? void 0 : A.sourceReference) ?? "" },
      { label: "Category", value: f },
      { label: "Tags", value: d.join(", ") }
    ]),
    detailText: or((w = a == null ? void 0 : a.system) == null ? void 0 : w.description),
    quantity: c,
    canAdjustQuantity: o
  };
}
function pT({ defenseBonus: a = 0, mitigationByType: e = {} } = {}) {
  const t = [], i = Number(a ?? 0) || 0;
  i !== 0 && t.push(`Defense ${Jc(i)}`);
  for (const [n, r] of Object.entries(dT)) {
    const s = Number((e == null ? void 0 : e[n]) ?? 0) || 0;
    s !== 0 && t.push(`${r} ${Jc(s)}`);
  }
  return t.join(" | ");
}
function hT(a = {}, e = ["close", "near", "far", "extreme"]) {
  return e.map((t) => {
...
var $t, Ii, Qi, Wt, Da, Di, D, Vm, Ym, So, ur, Qm, Jm, Le, Ut, Ci, Xm, Ao, Zm, ef, tf, af, nf, rf, sf, Ht, va;
const pe = class pe extends Tn {
  constructor() {
    super(...arguments);
    we(this, D);
    we(this, $t, null);
  ...
  /** @override */
  async _prepareContext(t) {
    var W, _, F, V, Y, re, ce, ue, oe, Re, Ie, _e, rt, st, ot, qe, lt, Ze, Ve, bt, vt, kt, Mt, N, U, ge, ae, De;
    ...
    const r = ((F = (_ = this.actor).getEdgeCap) == null ? void 0 : F.call(_)) ?? Number(((re = (Y = (V = this.actor.system) == null ? void 0 : V.attributes) == null ? void 0 : Y.edge) == null ? void 0 : re.value) ?? 0), s = !!this.isEditable, o = { physical: "Physical", mental: "Mental", social: "Social" }, l = {
      grit: "Grit",
      insight: "Insight",
      legend: "Legend",
      chaos: "Chaos",
    ...
    i.edgeConsole = {
      cap: r,
      editable: s,
      capPips: Array.from({ length: Math.max(0, r) }, (M, P) => P + 1),
      groups: (c.groups ?? []).map((M) => ({
        id: M.id,
        label: o[M.id] ?? M.id,
        pools: (M.pools ?? []).map((P) => {
          const Q = Number(P.effectiveValue ?? 0), ne = Number(P.effectiveMax ?? 0), te = Array.from({ length: Math.max(0, ne) }, (Be, et) => {
            const dt = et + 1;
            return { n: dt, filled: dt <= Q };
          }), be = String(P.key ?? "").split(".").pop();
          return {
            key: P.key,
            label: l[be] ?? be ?? P.key,
            value: Q,
    ...
    for (const M of i.edgeConsole.groups ?? [])
      for (const P of M.pools ?? []) {
        const Q = String(P.key ?? "").split(".").pop();
        Q && d.set(Q, P), P.domain = M.id;
      }
    ...
    const m = this.actor.system ?? {}, f = m.monitors ?? {}, p = [
      ...
      const ne = foundry.utils.getProperty(M, P), te = Number(ne);
      return Number.isFinite(te) ? te : Q;
    };
    i.conditionMonitors = p.map((M) => {
      const P = (f == null ? void 0 : f[M.id]) ?? {}, Q = Math.max(0, h(P, "max", 0)), ne = Math.min(Math.max(0, h(P, "value", 0)), Q);
      return {
        id: M.id,
        label: M.label,
        kind: M.kind,
        ...
        value: ne,
        max: Q,
        segments: Array.from({ length: Q }, (te, be) => {
          const Be = be + 1;
          return { value: Be, filled: Be <= ne };
        }),
        status: M.status ? { label: M.status.label, value: h(P, M.status.path, 0) } : null
      };
    });
    const g = Number(((ue = (ce = this.actor.system) == null ? void 0 : ce.burn) == null ? void 0 : ue.value) ?? 0), y = 10, b = 6, A = Math.min(g, y);
    i.burnOverflow = Math.max(0, g - y), i.burnPenalty = Math.floor(g / 2), i.burnPips = Array.from({ length: y }, (M, P) => {
      ...
      overloaded: !!((Re = (oe = this.actor.system) == null ? void 0 : oe.burn) != null && Re.overloaded)
    };
    ...
    const v = z.buildActionModel(this.actor, w), R = new Set((v.menus ?? []).map((M) => M.id));
    j(this, $t) && !R.has(j(this, $t)) && Pe(this, $t, null), i.combatActions = {
      ...v,
      menus: (v.menus ?? []).map((M) => ({
        ...M,
        isOpen: M.id === j(this, $t)
      }))
    };
    const E = ((_e = (Ie = this.actor).getPersonalCombatLoadout) == null ? void 0 : _e.call(Ie)) ?? null;
    i.personalInventory = {
      warnings: [...(E == null ? void 0 : E.warnings) ?? []],
      weapons: ((E == null ? void 0 : E.weapons) ?? []).map((M) => {
        var Te, ct, ut, mt, Ye, Jt, vi;
        const P = C(this, D, va).call(this, "weapons", M.id), Q = String((M == null ? void 0 : M.category) ?? "").trim().toLowerCase() !== "melee", ne = !!((Te = M == null ? void 0 : M.sourceState) != null && Te.isTracked), te = String((M == null ? void 0 : M.payloadLabel) ?? "").trim() || "Unloaded", be = Q && ne ? `${Ee((ct = M == null ? void 0 : M.sourceState) == null ? void 0 : ct.current, 0)}/${Ee((ut = M == null ? void 0 : M.sourceState) == null ? void 0 : ut.max, 0)}` : "", Be = Q ? ne ? `${te} ${be}` : te : "", et = Q ? ne ? `Payload ${be}` : `Payload ${te}` : "", dt = hT(M.attackRatingBand), Ot = gT(M.attackRatingBand), ie = cr([
          ...
          { label: "Max Range", value: yT(((Ye = M.range) == null ? void 0 : Ye.max) ?? M.defaultRangeBand ?? "") },
        ...
        return {
          ...
          attackRoll: JSON.stringify({
            intent: "attack",
            weaponId: M.id,
            payloadId: ((vi = M == null ? void 0 : M.payloadState) == null ? void 0 : vi.activePayloadId) ?? "",
            edge: { pool: "physical.grit", allowed: ["pre", "post"] },
            tags: ["combat", "attack"]
          })
        };
      ...
      armor: ((E == null ? void 0 : E.armor) ?? []).map((M) => {
        var Be, et, dt, Ot, ie, Te, ct, ut, mt, Ye, Jt, vi, Wa, Ga;
        const P = ((Be = E == null ? void 0 : E.activeArmor) == null ? void 0 : Be.id) === M.id ? E.activeArmor : null, Q = C(this, D, va).call(this, "armor", M.id), ne = Ee(((dt = (et = P == null ? void 0 : P.traitState) == null ? void 0 : et.reinforced) == null ? void 0 : dt.max) ?? ((ie = (Ot = M == null ? void 0 : M.traitState) == null ? void 0 : Ot.reinforced) == null ? void 0 : ie.max), 0), te = ne > 0 ? `${Ee(((ct = (Te = P == null ? void 0 : P.traitState) == null ? void 0 : Te.reinforced) == null ? void 0 : ct.current) ?? ((mt = (ut = M == null ? void 0 : M.traitState) == null ? void 0 : ut.reinforced) == null ? void 0 : mt.current), 0)}/${ne}` : "", be = pT({
        ...
        return {
          id: M.id,
          accordionId: Q,
          isExpanded: j(this, Wt).has(Q),
          name: M.name,
          img: M.img,
          subtitle: (Ye = M.tags) != null && Ye.length ? M.tags.join(", ") : "Armor",
          summaryStats: on([
            { label: "Rating", value: Ee((P == null ? void 0 : P.ratingCurrent) ?? M.rating, 0), emphasis: "strong" },
            { label: "Res", value: Ee((P == null ? void 0 : P.baseMitigation) ?? (P == null ? void 0 : P.baseResistance), 0) },
            { label: "Def", value: Ee(M.defenseBonus, 0) },
            { label: "Dur", value: `${Ee(((Jt = P == null ? void 0 : P.durability) == null ? void 0 : Jt.current) ?? ((vi = M.durability) == null ? void 0 : vi.current), 0)}/${Ee(((Wa = P == null ? void 0 : P.durability) == null ? void 0 : Wa.max) ?? ((Ga = M.durability) == null ? void 0 : Ga.max), 0)}` }
          ]),
          detailTags: lr([
            M.equipped ? "Equipped" : "",
            M.isPrimary ? "Primary" : "",
      ...
      gear: (((rt = i.items) == null ? void 0 : rt.gear) ?? []).map((M) => {
        const P = C(this, D, va).call(this, "gear", M.id);
        return Xc({
          item: M,
          accordionId: P,
          itemType: "gear",
      ...
      consumables: (((st = i.items) == null ? void 0 : st.consumable) ?? []).map((M) => {
        const P = C(this, D, va).call(this, "consumables", M.id);
        return Xc({
          item: M,
          accordionId: P,
          itemType: "consumable",
      ...
      faction: ((qe = m.biography) == null ? void 0 : qe.faction) ?? "",
      age: ((lt = m.biography) == null ? void 0 : lt.age) ?? "",
      rank: ((Ze = m.biography) == null ? void 0 : Ze.rank) ?? "",
      height: ((Ve = m.biography) == null ? void 0 : Ve.height) ?? "",
      weight: ((bt = m.biography) == null ? void 0 : bt.weight) ?? "",
      xpTotal: ((kt = (vt = m.counters) == null ? void 0 : vt.xp) == null ? void 0 : kt.total) ?? 0,
    ...
    i.skillsDisplay = td(((ae = this.actor) == null ? void 0 : ae.system) ?? {}, {
    ...
    const K = ["positive", "negative", "narrative"], q = ["major", "minor"], H = [...((De = i.items) == null ? void 0 : De.quality) ?? []].sort((M, P) => {
      const Q = qt(M.system ?? {}), ne = qt(P.system ?? {}), te = K.indexOf(Q.category) - K.indexOf(ne.category);
      if (te !== 0) return te;
      const be = q.indexOf(Q.tier) - q.indexOf(ne.tier);
      return be !== 0 ? be : String(M.name ?? "").localeCompare(String(P.name ?? ""));
    });
    return i.qualityGroups = K.map((M) => ({
      id: M,
      label: Yn(M),
      records: H.filter((P) => qt(P.system ?? {}).category === M).map((P) => {
        var te, be, Be, et;
        const Q = qt(P.system ?? {}), ne = C(this, D, va).call(this, "quality", P.id);
        return {
          id: P.id,
          accordionId: ne,
          isExpanded: j(this, Wt).has(ne),
          name: P.name,
          img: P.img,
          subtitle: `${Qn(Q.tier)} ${Yn(Q.category)}`,
          summaryStats: on([
            { label: "Tier", value: Qn(Q.tier), emphasis: "strong" },
          ...
          detailRows: cr([
            { label: "Category", value: Yn(Q.category) },
            { label: "Tier", value: Qn(Q.tier) },
            { label: "Activation", value: Q.activation || "passive" },
            { label: "Prerequisites", value: String(((be = Q.prerequisites) == null ? void 0 : be.length) ?? 0) },
            { label: "Effects", value: String(((Be = Q.effects) == null ? void 0 : Be.length) ?? 0) },
            { label: "Tags", value: Si(Q.tags ?? []).join(", ") }
          ]),
          detailText: or((et = P.system) == null ? void 0 : et.description)
        };
      })
  ...
  _buildAssignedMech() {
    ...
    const t = this.actor.uuid, i = { light: "Light", medium: "Medium", heavy: "Heavy", assault: "Assault" }, n = (((r = game.actors) == null ? void 0 : r.contents) ?? []).filter(
      ...
      var _, F, V, Y, re, ce, ue, oe, Re, Ie, _e, rt, st, ot, qe;
      const o = s.type === "battlemech", l = ((F = (_ = s.system) == null ? void 0 : _.monitors) == null ? void 0 : F.structure) ?? {}, c = ((Y = (V = s.system) == null ? void 0 : V.monitors) == null ? void 0 : Y.armor) ?? {}, u = ((ce = (re = s.system) == null ? void 0 : re.mwd) == null ? void 0 : ce.heat) ?? {}, d = ((oe = (ue = s.system) == null ? void 0 : ue.mwd) == null ? void 0 : oe.heatStatus) ?? {}, m = ((Ie = (Re = s.system) == null ? void 0 : Re.mwd) == null ? void 0 : Ie.crits) ?? [], f = ((_e = s.system) == null ? void 0 : _e.quickActions) ?? {}, p = (lt, Ze, Ve, bt) => {
        var Mt;
        const vt = Math.max(0, Ee(bt.value, 0)), kt = Math.max(0, Ee(bt.max, 0));
        return {
          id: lt,
          label: Ze,
          kind: Ve,
          value: vt,
          max: kt,
          resistance: Ee((Mt = bt.resistance) == null ? void 0 : Mt.default, 0),
          segments: Array.from({ length: kt }, (N, U) => {
            const ge = U + 1;
            return { value: ge, filled: ge <= vt };
          })
        };
        ...
        segments: Array.from({ length: g }, (lt, Ze) => {
          const Ve = Ze + 1;
          return {
            value: Ve,
            filled: Ve <= h,
            breakpoint: Si([
              Ve === Ee(y.runningHot, 0) ? "runningHot" : "",
              Ve === Ee(y.overheated, 0) ? "overheated" : "",
              Ve === Ee(y.shutdown, 0) ? "shutdown" : ""
            ]).join(" ")
          };
        })
      } : null, A = xm(m), w = o ? [p("structure", "Structure", "wound", l), p("armor", "Armor", "armor", c)] : [p("structure", "Structure", "wound", l)], v = Array.isArray((rt = s.system) == null ? void 0 : rt.weaponGroups) && s.system.weaponGroups.length > 0, R = Array.isArray((st = s.system) == null ? void 0 : st.meleeProfiles) && s.system.meleeProfiles.length > 0, E = f.primaryWeaponGroup ?? null, x = o ? [
        ...
        { label: "Ranged", hint: "Prompt for a weapon group", handler: "mechAttack", disabled: !v, dataset: { attackKind: "ranged", mechId: s.id } },
        { label: "Melee", hint: "Prompt for a melee profile", handler: "mechAttack", disabled: !R, dataset: { attackKind: "melee", mechId: s.id } },
      ...
      ] : [], K = Math.max(0, Ee(c.max, 0)), q = Math.max(0, K - Ee(c.value, 0)), H = Math.max(0, Ee(l.max, 0)), W = Math.max(0, H - Ee(l.value, 0));
      return {
        id: s.id,
        uuid: s.uuid,
        name: s.name,
        ...
        isMech: o,
        weightLabel: i[(qe = (ot = s.system) == null ? void 0 : ot.mwd) == null ? void 0 : qe.weightClass] ?? "",
        summaryStats: on([
          ...o ? [{ label: "Armor", value: `${q} / ${K}` }] : [],
          { label: "Structure", value: `${W} / ${H}` },
          { label: "Heat", value: o ? `${h} / ${g}` : null },
          { label: "Status", value: A.count > 0 ? A.value : "OK" }
        ]),
        conditionMonitors: w,
        heat: b,
        critCount: m.length,
  ...
  async _onMechAttack(t, i) {
    ...
    try {
      ...
      ta(f, "Unable to launch BattleMech attack.");
    }
  }
  async _onMechRoll(t, i) {
    ...
    try {
      ...
      ta(p, "Unable to launch BattleMech check.");
    }
  }
  _onRender(t, i) {
    super._onRender(t, i), C(this, D, Ym).call(this), C(this, D, Jm).call(this), C(this, D, Xm).call(this), C(this, D, Vm).call(this);
  }
  async close(t = {}) {
    return C(this, D, So).call(this), C(this, D, Ao).call(this), j(this, Di) !== null && (Hooks.off("updateActor", j(this, Di)), Pe(this, Di, null)), super.close(t);
  }
  requestCombatDashboardRefresh() {
    C(this, D, Le).call(this, { force: !0 });
  }
  ...
  async _onToggleCombatMenu(t, i) {
    ...
    n && (Pe(this, $t, j(this, $t) === n ? null : n), C(this, D, Le).call(this, !1));
  }
  async _onToggleStatuses(t, i) {
    var s, o, l, c, u, d, m, f;
    if ((s = t == null ? void 0 : t.preventDefault) == null || s.call(t), (o = t == null ? void 0 : t.stopPropagation) == null || o.call(t), C(this, D, Ht).call(this, i, t, "Statuses are not available right now.") || !this.isEditable) return;
  ...
  async _onCombatSpend(t, i) {
    ...
    if ((c = t == null ? void 0 : t.preventDefault) == null || c.call(t), (u = t == null ? void 0 : t.stopPropagation) == null || u.call(t), C(this, D, Ht).call(this, i, t, "That combat action is not available right now.") || !this.isEditable) return;
    ...
    if (!(!n || !r || !s))
      try {
        const A = this.getPersistentActor() ?? this.actor, w = await z.spendResource(A, {
          token: ((g = this.getSheetTokenDocument) == null ? void 0 : g.call(this)) ?? z.getCurrentSceneTokenDocument(A) ?? z.getCurrentSceneTokenDocument(this.actor),
          resource: n,
          cost: r,
          actionId: s,
          actionLabel: o,
        ...
        C(this, D, Ut).call(this, { rerender: !1 }), C(this, D, Le).call(this, { force: !0 });
      } catch (A) {
  ...
  async _onCombatAction(t, i) {
    var r, s, o, l, c, u;
    if ((r = t == null ? void 0 : t.preventDefault) == null || r.call(t), (s = t == null ? void 0 : t.stopPropagation) == null || s.call(t), C(this, D, Ht).call(this, i, t, "That combat action is not available right now.") || !this.isEditable) return;
    const n = String(((o = i == null ? void 0 : i.dataset) == null ? void 0 : o.combatAction) ?? "").trim();
    if (n)
      try {
        const d = this.getPersistentActor() ?? this.actor, m = await C(this, D, Zm).call(this, n);
        if (!m) return;
  ...
  async _onCombatReduceBurn(t, i) {
    var n, r, s, o, l;
    if ((n = t == null ? void 0 : t.preventDefault) == null || n.call(t), (r = t == null ? void 0 : t.stopPropagation) == null || r.call(t), !C(this, D, Ht).call(this, i, t, "Burn recovery is not available right now.") && this.isEditable)
      try {
  ...
  async _onCombatAssist(t, i) {
    var n, r, s, o, l, c, u;
    if ((n = t == null ? void 0 : t.preventDefault) == null || n.call(t), (r = t == null ? void 0 : t.stopPropagation) == null || r.call(t), !C(this, D, Ht).call(this, i, t, "Assist is not available right now.") && this.isEditable)
      try {
        ...
        const p = await C(this, D, nf).call(this, f);
        if (!p) return;
  ...
  async _onCombatEvade(t, i) {
    var n, r, s, o, l;
    if ((n = t == null ? void 0 : t.preventDefault) == null || n.call(t), (r = t == null ? void 0 : t.stopPropagation) == null || r.call(t), !C(this, D, Ht).call(this, i, t, "Evade is not available right now.") && this.isEditable)
      try {
        const c = this.getPersistentActor() ?? this.actor, u = ((s = this.getSheetTokenDocument) == null ? void 0 : s.call(this)) ?? z.getCurrentSceneTokenDocument(c) ?? z.getCurrentSceneTokenDocument(this.actor), d = await aT(c, { token: u });
        if (!(d != null && d.ok)) {
  ...
  async _onCombatInterrupt(t, i) {
    var n, r, s, o, l, c, u, d;
    if ((n = t == null ? void 0 : t.preventDefault) == null || n.call(t), (r = t == null ? void 0 : t.stopPropagation) == null || r.call(t), !C(this, D, Ht).call(this, i, t, "Interrupt is not available right now.") && this.isEditable)
      try {
        ...
        if (!await C(this, D, ef).call(this, h)) return;
        ...
        await z.clearPreparedInterrupt(m, { token: f }), await C(this, D, sf).call(this, {
          actor: m,
          token: f,
          preparedInterrupt: h,
  ...
  async _onCombatOverloadCheck(t, i) {
    var s, o, l, c, u, d, m, f, p, h, g;
    if ((s = t == null ? void 0 : t.preventDefault) == null || s.call(t), (o = t == null ? void 0 : t.stopPropagation) == null || o.call(t), C(this, D, Ht).call(this, i, t, "Overload check is not available right now.") || !this.isEditable) return;
  ...
  async _onCombatAttack(t, i) {
    var m, f, p, h, g, y, b, A, w, v, R, E, x, K, q, H, W, _, F, V, Y, re, ce;
    if ((m = t == null ? void 0 : t.preventDefault) == null || m.call(t), (f = t == null ? void 0 : t.stopPropagation) == null || f.call(t), C(this, D, Ht).call(this, i, t, "Attack is not available right now.") || !this.isEditable) return;
    ...
    if (!c.hasCombatant) {
      (A = ui.notifications) == null || A.warn("No combatant on the current scene.");
      return;
    }
    ...
    if (!l && c.overloaded) {
      (R = ui.notifications) == null || R.warn("Overloaded actors can only recover Burn.");
      return;
    }
    if (!l) {
      const ue = 3 + Math.floor((Math.max(0, Number(((K = (x = (E = n.system) == null ? void 0 : E.attributes) == null ? void 0 : x.reflexes) == null ? void 0 : K.value) ?? 0)) + Math.max(0, Number(((W = (H = (q = n.system) == null ? void 0 : q.attributes) == null ? void 0 : H.willpower) == null ? void 0 : W.value) ?? 0))) / 2);
      if (Math.max(0, ue - Math.max(0, Number(((_ = c.state) == null ? void 0 : _.saSpentThisActivation) ?? 0))) < 2) {
    ...
    try {
      const ue = await ((re = (Y = (V = game.mwd) == null ? void 0 : V.roll) == null ? void 0 : Y.execute) == null ? void 0 : re.call(Y, { actor: n, payload: d, event: t }));
      if (C(this, D, Ut).call(this, { rerender: !1 }), !ue) {
        C(this, D, Le).call(this, !1);
        return;
      }
      u && await z.clearAim(n, { token: r });
      const oe = l ? await z.executeAction(n, {
        token: r,
      ...
      oe != null && oe.ok || (ce = ui.notifications) == null || ce.warn((oe == null ? void 0 : oe.reason) ?? `Unable to spend ${o} action.`), C(this, D, Le).call(this, { force: !0 });
    } catch (ue) {
      console.error(`MWD | Failed to launch ${o}`, ue), ta(ue, `Unable to launch ${o}.`);
    }
  }
  async _onAddSkillSpecialization(t, i) {
    ...
    if (!n) return;
    const r = this.getPersistentActor() ?? this.actor, s = Ys(r.system ?? {}, n), o = $r(r.system ?? {}, n), l = na(n).filter((h) => !o.includes(h.key));
  ...
  async _onRemoveSkillSpecialization(t, i) {
    ...
    if (!n || !r) return;
    const s = this.getPersistentActor() ?? this.actor, o = gr(
  ...
  async _onDeleteOwnedItem(t, i) {
    ...
    const n = C(this, D, Ci).call(this, i, t);
    if (!n) return;
    await (this.getPersistentActor() ?? this.actor).deleteEmbeddedDocuments("Item", [n.id]), C(this, D, Le).call(this, { force: !0 });
  }
  async _onToggleInventoryAccordion(t, i) {
    ...
    n && (j(this, Wt).has(n) ? j(this, Wt).delete(n) : j(this, Wt).add(n), C(this, D, Le).call(this, !1));
  }
  async _onToggleOwnedItemEquipped(t, i) {
    var s, o, l, c;
    if ((s = t == null ? void 0 : t.preventDefault) == null || s.call(t), (o = t == null ? void 0 : t.stopPropagation) == null || o.call(t), !this.isEditable) return;
    ...
    if (!n) return;
    const r = this.getPersistentActor() ?? this.actor;
    await ((c = r.setOwnedItemEquipped) == null ? void 0 : c.call(r, n.id, !((l = n.system) != null && l.equipped))), C(this, D, Le).call(this, { force: !0 });
  }
  async _onSetOwnedItemPrimary(t, i) {
    var s, o, l, c;
    if ((s = t == null ? void 0 : t.preventDefault) == null || s.call(t), (o = t == null ? void 0 : t.stopPropagation) == null || o.call(t), !this.isEditable) return;
    ...
    if (!n) return;
    const r = this.getPersistentActor() ?? this.actor;
    await ((c = r.setOwnedItemPrimary) == null ? void 0 : c.call(r, n.id, !((l = n.system) != null && l.isPrimary))), C(this, D, Le).call(this, { force: !0 });
  }
  async _onAdjustGearQuantity(t, i) {
    ...
    if (!r) return;
    const o = (this.getPersistentActor() ?? this.actor).items.get(n.id) ?? n, l = Math.max(0, Math.trunc(Number(((A = o.system) == null ? void 0 : A.quantity) ?? 1) || 0) + r);
    await o.update({ "system.quantity": l }), C(this, D, Le).call(this, { force: !0 });
  }
  async _onAttackWeapon(t, i) {
    var l, c, u, d;
    if ((l = t == null ? void 0 : t.preventDefault) == null || l.call(t), (c = t == null ? void 0 : t.stopPropagation) == null || c.call(t), C(this, D, Ht).call(this, i, t, "Equip that weapon before attacking.")) return;
    const n = C(this, D, Ci).call(this, i, t);
    ...
    await as({ weapon: n, event: t, token: s }) && C(this, D, Le).call(this, { force: !0 });
  }
};
$t = new WeakMap(), Ii = new WeakMap(), Qi = new WeakMap(), Wt = new WeakMap(), Da = new WeakMap(), Di = new WeakMap(), D = new WeakSet(), Vm = function() {
  if (j(this, Di) !== null) return;
  const t = this.actor.uuid;
  Pe(this, Di, Hooks.on("updateActor", (i) => {
    var n, r;
    i.type !== "battlemech" && i.type !== "vehicle" || String(((r = (n = i.system) == null ? void 0 : n.pilot) == null ? void 0 : r.uuid) ?? "").trim() === t && this.render();
  }));
}, Ym = function() {
  C(this, D, So).call(this), j(this, $t) && (Pe(this, Ii, (t) => {
    var r;
  ...
  }), document.addEventListener("click", j(this, Ii)));
}, So = function() {
  j(this, Ii) && (document.removeEventListener("click", j(this, Ii)), Pe(this, Ii, null));
}, ur = function() {
  const t = this._getRootElement();
  return t ? t.querySelector(".mwd-scroll-area") ?? t.querySelector(".csb-tab-panels") : null;
}, Qm = function() {
  const t = C(this, D, ur).call(this);
  if (!(t instanceof HTMLElement)) {
    Pe(this, Qi, null);
    return;
  }
  ...
  const t = j(this, Qi);
  if (!t) return;
  const i = C(this, D, ur).call(this);
  i instanceof HTMLElement && (i.scrollTop = t.top, i.scrollLeft = t.left, requestAnimationFrame(() => {
    const n = C(this, D, ur).call(this);
    n instanceof HTMLElement && (n.scrollTop = t.top, n.scrollLeft = t.left);
  }), Pe(this, Qi, null));
}, Le = function(t = !1) {
  C(this, D, Qm).call(this), this.render(t);
}, Ut = function({ rerender: t = !0 } = {}) {
  j(this, $t) && (Pe(this, $t, null), t && C(this, D, Le).call(this, !1));
}, Ci = function(t, i) {
  var r, s, o, l, c, u, d, m;
  const n = String(
    ((r = t == null ? void 0 : t.dataset) == null ? void 0 : r.itemId) ?? ((l = (o = (s = t == null ? void 0 : t.closest) == null ? void 0 : s.call(t, "[data-item-id]")) == null ? void 0 : o.dataset) == null ? void 0 : l.itemId) ?? ((m = (d = (u = (c = i == null ? void 0 : i.target) == null ? void 0 : c.closest) == null ? void 0 : u.call(c, "[data-item-id]")) == null ? void 0 : d.dataset) == null ? void 0 : m.itemId) ?? ""
  ...
  var t;
  (t = j(this, Da)) == null || t.abort(), Pe(this, Da, null);
}, Zm = async function(t) {
  if (t !== "prepare") return {};
  ...
  return C(this, D, tf).call(this, t == null ? void 0 : t.combat).filter((r) => r && String(r.id ?? "").trim() !== i).map((r) => {
    var c;
  ...
  var s;
  const i = C(this, D, af).call(this, t);
  if (!i.length)
...
}, rf = async function({ actor: t, token: i = null, target: n = null, costLabel: r = "" } = {}) {
...
}, sf = async function({ actor: t, token: i = null, preparedInterrupt: n = null, costLabel: r = "" } = {}) {
...
}, Ht = function(t, i, n = "That action is not available right now.") {
  var o, l, c, u, d;
  ...
  sheet: {
    get template() {
      return `${Z}/v2/actor/character-sheet.hbs`;
    }
  }
}), O(pe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(Xt(pe, pe, "DEFAULT_OPTIONS"), {
  ...
  actions: {
    ...Xt(pe, pe, "DEFAULT_OPTIONS").actions,
    ...
    combatAction: pe.prototype._onCombatAction,
    combatSpend: pe.prototype._onCombatSpend,
    combatAssist: pe.prototype._onCombatAssist,
    combatEvade: pe.prototype._onCombatEvade,
    combatInterrupt: pe.prototype._onCombatInterrupt,
    ...
    adjustGearQuantity: pe.prototype._onAdjustGearQuantity,
    attackWeapon: pe.prototype._onAttackWeapon,
    openAssignedMech: pe.prototype._onOpenAssignedMech,
    mechAttack: pe.prototype._onMechAttack,
    mechRoll: pe.prototype._onMechRoll
  }
}, { inplace: !1 }));
let bo = pe;
function bT(a, e, t = "") {
...
class of extends Tn {
  ...
  async _prepareContext(e) {
    ...
    return t.layout = await ua.get("npc"), t.actorSheet = {
      ...
      monitorFields: [
        ka(i, "system.monitors.physical.value", "Physical"),
        ka(i, "system.monitors.physical.max", "Physical Max"),
        ka(i, "system.monitors.fatigue.value", "Fatigue"),
        ka(i, "system.monitors.fatigue.max", "Fatigue Max"),
        ka(i, "system.monitors.armor.value", "Armor"),
      ...
      notesField: ST(i, "system.biography", "Notes", { rows: 12 })
    }, t;
  }
}
O(of, "PARTS", {
  sheet: {
    template: `${Z}/v2/actor/npc-sheet.hbs`,
    scrollable: [".sheet-body"]
  }
});
const { ApplicationV2: TT, HandlebarsApplicationMixin: wT } = foundry.applications.api, dn = class dn extends wT(TT) {
  static get DEFAULT_OPTIONS() {
    return foundry.utils.mergeObject(super.DEFAULT_OPTIONS, {
      id: "select-actor",
...
O(dn, "PARTS", {
  body: {
    template: `${Z}/dialog/select-actor.hbs`
  }
});
let To = dn;
function at(a, e = 0) {
...
function CT(a = {}) {
  return ["close", "near", "far", "extreme", "max"].filter((i) => (a == null ? void 0 : a[i]) !== void 0 && (a == null ? void 0 : a[i]) !== null && String(a[i]).trim() !== "").map((i) => {
    const n = a[i];
    return i === "max" ? `Max ${qi(n)}` : `${qi(i)} ${at(n, 0)}`;
  }).join(" | ");
}
...
const We = class We extends Tn {
  ...
  async _prepareContext(t) {
    ...
    return i._mwdThemeClass = ((o = (s = (r = (n = game.system) == null ? void 0 : n.mwd) == null ? void 0 : r.styles) == null ? void 0 : s.selectCssClass) == null ? void 0 : o.call(s)) ?? "", i.layout = await ua.get(this.constructor.LAYOUT_ID ?? We.LAYOUT_ID), i.vehicleSheet = {
  ...
  _buildSummaryStats() {
    var r, s, o, l, c, u, d, m, f, p;
    const t = ((r = this.actor.system) == null ? void 0 : r.attributes) ?? {}, i = ((o = (s = this.actor.system) == null ? void 0 : s.monitors) == null ? void 0 : o.structure) ?? {}, n = vm({
      actorType: this.actor.type,
      movement: (l = this.actor.system) == null ? void 0 : l.movement,
      legacyMoves: (c = this.actor.system) == null ? void 0 : c.moves
    });
    return Es([
      { label: "Handling", value: at((u = t.handling) == null ? void 0 : u.value, 0), emphasis: "strong" },
      { label: "Move", parts: n },
      { label: "System", value: at((d = t.system) == null ? void 0 : d.value, 0) },
      { label: "Chassis", value: at((m = t.chassis) == null ? void 0 : m.value, 0) },
      { label: "Reliability", value: at(((f = t.reliability) == null ? void 0 : f.value) ?? ((p = t.condition) == null ? void 0 : p.value), 0) },
      { label: "Structure", value: `${at(i.value, 0)} / ${at(i.max, 0)}` }
    ]);
  }
  _buildAlerts() {
    return [];
  ...
  _buildAttributeCards() {
    ...
    return Object.entries(ET).map(([n, r]) => {
      var s;
      return {
        key: n,
        label: r,
        value: at((s = t == null ? void 0 : t[n]) == null ? void 0 : s.value, 0),
  ...
  _buildDegradationPanel() {
    var c, u, d, m, f, p;
    const t = ((c = this.actor.system) == null ? void 0 : c.attributes) ?? {}, i = ((u = this.actor.system) == null ? void 0 : u.mwd) ?? {}, n = at(((d = t.reliability) == null ? void 0 : d.value) ?? ((m = t.condition) == null ? void 0 : m.value), 0), r = nm(n), s = at((f = i.shock) == null ? void 0 : f.value, 0), o = at((p = i.reliabilitySpendable) == null ? void 0 : p.value, n), l = Object.entries(i.locations ?? {}).map(([h, g]) => ({
      key: h,
      label: An(h),
      stress: at(g == null ? void 0 : g.stress, 0),
      conditionLabel: rm((g == null ? void 0 : g.condition) ?? 0),
      conditionModifier: sm((g == null ? void 0 : g.condition) ?? 0),
      destroyed: !!(g != null && g.destroyed),
      enabled: (g == null ? void 0 : g.enabled) !== !1
    }));
    return {
      reliability: n,
      spendable: o,
  ...
  async _onCreateOwnedItem(t, i) {
    ...
    const n = String(((u = i == null ? void 0 : i.dataset) == null ? void 0 : u.itemType) ?? "").trim();
    if (!n) return;
    const r = this.getPersistentActor() ?? this.actor, s = iu[n] ?? qi(n), o = r.items.filter((d) => d.type === n).length;
    await r.createEmbeddedDocuments("Item", [{
      name: `${s} ${o + 1}`,
      type: n
    }]), this.render({ force: !0 });
  ...
  async _onToggleInventoryAccordion(t, i) {
    ...
    n && (j(this, Ji).has(n) ? j(this, Ji).delete(n) : j(this, Ji).add(n), this.render({ force: !1 }));
  }
  _buildActiveCrits() {
    var r;
    ...
    return ym(t).map((s) => {
      var m;
      const o = In(s.remedyKey), l = n.get(String(s.locationKey ?? "").trim()) ?? null, c = String(s.remedySkillKey ?? o.skillKey ?? "").trim(), u = ((m = Dt(c)) == null ? void 0 : m.label) ?? qi(c), d = at(s.remedyBaseDn ?? o.baseDn, 0) + at((l == null ? void 0 : l.conditionModifier) ?? 0, 0);
      return {
        id: s.id,
        label: s.label ?? qi(s.key),
        locationLabel: s.locationLabel ?? qi(s.locationKey),
        detail: lf([
  ...
  async _onMachineWeaponAttack(t, i) {
    ...
    if (!(o != null && o.execute))
      return (A = ui.notifications) == null || A.error("MWD roll system not initialized."), !1;
    ...
    if (c) {
      const R = ((w = z.getSnapshot) == null ? void 0 : w.call(z, n, { token: l })) ?? null;
      if (R != null && R.hasCombatant) {
  ...
  async _onMachineCritRemedy(t, i) {
    ...
    (o = t == null ? void 0 : t.preventDefault) == null || o.call(t), (l = t == null ? void 0 : t.stopPropagation) == null || l.call(t);
    const n = this.getPersistentActor() ?? this.actor, r = await vl({
...
Ji = new WeakMap(), Mn = new WeakSet(), wo = function(t, i) {
  var r, s, o, l, c, u, d, m;
  const n = String(
    ((r = t == null ? void 0 : t.dataset) == null ? void 0 : r.itemId) ?? ((l = (o = (s = t == null ? void 0 : t.closest) == null ? void 0 : s.call(t, "[data-item-id]")) == null ? void 0 : o.dataset) == null ? void 0 : l.itemId) ?? ((m = (d = (u = (c = i == null ? void 0 : i.target) == null ? void 0 : c.closest) == null ? void 0 : u.call(c, "[data-item-id]")) == null ? void 0 : d.dataset) == null ? void 0 : m.itemId) ?? ""
  ).trim();
  return n ? this.actor.items.get(n) ?? null : null;
}, O(We, "LAYOUT_ID", "vehicle"), O(We, "PARTS", {
  sheet: {
    get template() {
      return `${Z}/v2/actor/vehicle-sheet.hbs`;
    }
  }
}), O(We, "DEFAULT_OPTIONS", foundry.utils.mergeObject(Xt(We, We, "DEFAULT_OPTIONS"), {
  ...
  actions: {
    ...Xt(We, We, "DEFAULT_OPTIONS").actions,
    createOwnedItem: We.prototype._onCreateOwnedItem,
    editOwnedItem: We.prototype._onEditOwnedItem,
    deleteOwnedItem: We.prototype._onDeleteOwnedItem,
    toggleInventoryAccordion: We.prototype._onToggleInventoryAccordion,
    machineWeaponAttack: We.prototype._onMachineWeaponAttack,
    toggleStatuses: We.prototype._onToggleStatuses,
    machineCritRemedy: We.prototype._onMachineCritRemedy,
    assignPilot: We.prototype._onAssignPilot,
    removePilot: We.prototype._onRemovePilot,
    openPilot: We.prototype._onOpenPilot
  }
}, { inplace: !1 }));
let kr = We;
function St(a, e = 0) {
...
const jt = class jt extends kr {
  ...
  _buildSummaryStats() {
    var p, h, g, y, b, A, w, v, R, E, x, K, q, H, W, _;
    const t = ((h = (p = this.actor.system) == null ? void 0 : p.monitors) == null ? void 0 : h.armor) ?? {}, i = ((y = (g = this.actor.system) == null ? void 0 : g.monitors) == null ? void 0 : y.structure) ?? {}, n = ((A = (b = this.actor.system) == null ? void 0 : b.monitors) == null ? void 0 : A.heat) ?? {}, r = ((v = (w = this.actor.system) == null ? void 0 : w.mwd) == null ? void 0 : v.heat) ?? {}, s = Math.max(0, St(n.value ?? r.current, 0)), o = Math.max(0, St(n.max ?? r.max ?? r.hardMax, 0)), l = Tr(r.thresholds ?? {}, o), c = lo(oo(s, l, o)), u = c.toUpperCase(), d = iA({ armor: t, structure: i }), m = xm(((E = (R = this.actor.system) == null ? void 0 : R.mwd) == null ? void 0 : E.crits) ?? []), f = vm({
      actorType: this.actor.type,
      movement: (x = this.actor.system) == null ? void 0 : x.movement,
      legacyMoves: (K = this.actor.system) == null ? void 0 : K.moves
    });
    return Rs([
      { label: "Weight", value: ii(((H = (q = this.actor.system) == null ? void 0 : q.mwd) == null ? void 0 : H.weightClass) ?? "medium"), emphasis: "strong" },
      { label: "Move", parts: f },
  ...
  _buildHeatModel() {
    var l, c, u, d;
    const t = ((c = (l = this.actor.system) == null ? void 0 : l.monitors) == null ? void 0 : c.heat) ?? {}, i = ((d = (u = this.actor.system) == null ? void 0 : u.mwd) == null ? void 0 : d.heat) ?? {}, n = Math.max(0, St(t.value ?? i.current, 0)), r = Math.max(0, St(t.max ?? i.max ?? i.hardMax, 0)), s = Tr(i.thresholds ?? {}, r), o = oo(n, s, r);
    return {
      label: "Heat",
      current: n,
      max: r,
  ...
  _buildHardpoints() {
    var s, o, l, c, u;
    const t = ((o = (s = this.actor.system) == null ? void 0 : s.mwd) == null ? void 0 : o.loadout) ?? {}, i = ((l = k == null ? void 0 : k.mwd) == null ? void 0 : l.hardpointType) ?? {}, n = ((c = k == null ? void 0 : k.mwd) == null ? void 0 : c.hardpointSize) ?? {}, r = ((u = k == null ? void 0 : k.mwd) == null ? void 0 : u.hardpointLocation) ?? {};
  ...
  async _onMechAttack(t, i) {
    ...
    try {
      if (r === "group" && s)
        await C(this, Cn, ko).call(this, n, s);
      else if (r === "primary") {
        const h = (((d = n.system) == null ? void 0 : d.weaponGroups) ?? []).find((g) => g == null ? void 0 : g.isPrimary) ?? null;
        h != null && h.id ? await C(this, Cn, ko).call(this, n, h.id) : await ((m = n.rollRangedAttack) == null ? void 0 : m.call(n));
      } else r === "melee" ? await ((f = n.rollMeleeAttack) == null ? void 0 : f.call(n)) : await ((p = n.rollRangedAttack) == null ? void 0 : p.call(n));
    } catch (h) {
      console.error("MWD | Failed to launch BattleMech attack", h), ta(h, "Unable to launch that BattleMech attack.");
    }
  }
  async _onMechRoll(t, i) {
    var s, o, l, c, u, d;
    ...
    try {
      ...
      console.error("MWD | Failed to launch BattleMech check", m), ta(m, "Unable to launch that BattleMech check.");
    }
  }
};
Cn = new WeakSet(), ko = async function(t, i) {
  var c, u, d, m, f, p, h, g, y;
  ...
  if (await s.execute({
    ...
    if (b != null && b.hasCombatant) {
      const A = await z.spendResource(t, {
        token: o,
        resource: "sa",
        cost: 2,
        actionId: "attack",
      ...
      A != null && A.ok || (y = ui.notifications) == null || y.warn((A == null ? void 0 : A.reason) ?? "Unable to record attack action.");
    }
  }
}, O(jt, "LAYOUT_ID", "battlemech"), O(jt, "PARTS", {
  sheet: {
    get template() {
      return `${Z}/v2/actor/battlemech-sheet.hbs`;
    }
  }
}), O(jt, "DEFAULT_OPTIONS", foundry.utils.mergeObject(Xt(jt, jt, "DEFAULT_OPTIONS"), {
  classes: ["battlemech-sheet", T, "actor-sheet-v2", "mwd-battlemech-sheet", "mwd-sheet"],
  position: { width: 980, height: 940 },
  actions: {
    ...Xt(jt, jt, "DEFAULT_OPTIONS").actions,
    mechAttack: jt.prototype._onMechAttack,
    mechRoll: jt.prototype._onMechRoll
  }
}, { inplace: !1 }));
let vo = jt;
function RT() {
  ...
  a.registerSheet(T, bo, {
    ...
    makeDefault: !0,
    label: "Vehicle (V2)"
  }), a.registerSheet(T, vo, {
    types: ["battlemech"],
    makeDefault: !0,
    label: "BattleMech (V2)"
  });
}
const { HandlebarsApplicationMixin: PT } = foundry.applications.api, { HTMLField: ru, StringField: NT } = foundry.data.fields, Ps = /* @__PURE__ */ new Set(["system.notes", "system.description"]), IT = /* @__PURE__ */ new Set(["name"]), DT = Object.freeze({
  [S.itemType.personalWeapon]: `${Z}/v2/item/personal-weapon-root.hbs`,
  [S.itemType.mechWeapon]: `${Z}/v2/item/mech-weapon-root.hbs`,
  [S.itemType.armor]: `${Z}/v2/item/armor-root.hbs`
});
function Ns(a, e) {
...
function OT(a = {}) {
  return {
    ...a,
    sourceReference: a.sourceReference ?? Ns(NT, "system.sourceReference"),
    notes: a.notes ?? Ns(ru, "system.notes"),
    description: a.description ?? Ns(ru, "system.description")
  };
}
function LT(a = {}) {
  return Object.fromEntries(
...
var Xi, Oi, Zi, Oa, si, ln, Mo;
const Xe = class Xe extends PT(foundry.applications.sheets.ItemSheetV2) {
  constructor() {
    super(...arguments);
    we(this, si);
    we(this, Xi, /* @__PURE__ */ new Map());
  ...
  static get DEFAULT_OPTIONS() {
    return foundry.utils.mergeObject(super.DEFAULT_OPTIONS, {
      ...
      actions: {
        editImage: Xe._onEditImage,
        tab: Xe.prototype._onClickTab,
        accordion: Xe.prototype._onClickAccordion,
        checkbarElement: Xe._onClickCheckbar,
        modifierAdd: Xe._onModifierAdd,
        modifierDelete: Xe._onModifierDelete,
        modifierValueChange: Xe._onModifierValueChange,
        modifierConditionChange: Xe._onModifierConditionChange,
        modifierSelectionChange: Xe._onModifierSelectionChange,
        effectCreate: Xe._onEffectCreate,
        effectEdit: Xe._onEffectEdit,
        effectDelete: Xe._onEffectDelete,
        effectToggleDisabled: Xe._onEffectToggleDisabled
      },
      form: {
        submitOnChange: !1,
        closeOnSubmit: !1,
        handler: Xe.prototype._onSubmitForm
      }
    }, { inplace: !1 });
  }
  static get defaultOptions() {
   ...
   */
  async _prepareContext(t) {
    var E, x, K, q, H, W, _, F, V;
    const i = await super._prepareContext(t), n = ((x = (E = game.system.mwd.modifiers) == null ? void 0 : E.getEnums) == null ? void 0 : x.call(E)) ?? {}, r = foundry.utils.deepClone((i == null ? void 0 : i.options) ?? {}), s = OT((i == null ? void 0 : i.fields) ?? ((q = (K = this.item.system) == null ? void 0 : K.schema) == null ? void 0 : q.fields) ?? {}), o = ((W = (H = this.item.actor) == null ? void 0 : H.getAttributes) == null ? void 0 : W.call(H, this.item)) ?? [], l = this._getCanonicalItemType(), c = !this.item.actor, u = !!this.item.actor, d = $e.itemType.singular[l] ?? l, m = this._getEffectEntries(), f = m.filter((Y) => Y.syncedCount > 0).length, p = this.constructor.LAYOUT_ID, h = this.item.actor ? (Y) => o.includes(Y) : (Y) => !0, g = l === S.itemType.skill, b = ["mwd", "item-sheet", this.isEditable ? "editable" : "locked"], A = b.join(" ");
    r.classes = b, r.cssClass = A;
    const w = async (Y, { secrets: re = this.item.isOwner } = {}) => foundry.applications.ux.TextEditor.implementation.enrichHTML(Y ?? "", {
      async: !0,
      secrets: re,
      ...
      fields: s,
      enriched: v,
      enrichedDescription: ((_ = v == null ? void 0 : v.system) == null ? void 0 : _.description) ?? "",
      options: {
        ...r,
        isGM: game.user.isGM,
    ...
    return p && (R.layout = await ua.get(p)), R;
  }
  /**
  ...
  _onClickTab(t, i) {
    ...
    o && (j(this, Xi).set(s, o), C(this, si, ln).call(this, this._getRootElement(), s, o));
  }
  _onClickAccordion(t, i) {
    var u, d, m;
    const n = ((u = i == null ? void 0 : i.closest) == null ? void 0 : u.call(i, ".csb-accordion__trigger[data-section]")) ?? ((m = (d = t == null ? void 0 : t.target) == null ? void 0 : d.closest) == null ? void 0 : m.call(d, ".csb-accordion__trigger[data-section]"));
    ...
    const r = n.dataset.section, s = n.closest(".csb-accordion");
    if (!s || !r) return;
    const o = s.dataset.group || "default", c = (j(this, Oi).has(o) ? j(this, Oi).get(o) : s.dataset.default || null) === r ? null : r;
    j(this, Oi).set(o, c), C(this, si, Mo).call(this, s, c);
  }
  _onRender(t, i) {
    var s, o, l, c;
    ...
    for (const u of n.querySelectorAll(".sheet-tabs")) {
      ...
      for (const g of m)
        g.addEventListener("click", (y) => {
          ...
          b && (j(this, Xi).set(d, b), C(this, si, ln).call(this, n, d, b));
        });
      const f = j(this, Xi).get(d), p = u.dataset.default || ((l = m[0]) == null ? void 0 : l.dataset.tab), h = f || p;
    ...
    for (const u of n.querySelectorAll(".csb-tabs")) {
      ...
      if (!m.length) continue;
      const f = j(this, Xi).get(d), p = u.dataset.default || ((c = m[0]) == null ? void 0 : c.dataset.tab), h = f || p;
      h && C(this, si, ln).call(this, n, d, h);
    }
    for (const u of n.querySelectorAll(".csb-accordion")) {
      const d = u.dataset.group || "default", m = j(this, Oi).has(d) ? j(this, Oi).get(d) : u.dataset.default || null;
      C(this, si, Mo).call(this, u, m);
    }
    for (const u of n.querySelectorAll("prose-mirror[name]")) {
      const d = u.getAttribute("name") ?? "";
      Ps.has(d) && u.addEventListener("change", (m) => {
    ...
    if (this.isEditable)
      for (const u of n.querySelectorAll("input[name], select[name], textarea[name]")) {
        ...
        u instanceof HTMLInputElement && !IT.has(d) && !["checkbox", "radio"].includes(u.type) ? u.addEventListener("input", (m) => {
  ...
  async _updateRichTextField(t) {
    ...
    if (!this.isEditable || !Ps.has(i)) return;
  ...
  _queueNamedFieldSync(t, i = {}) {
    var o;
    if (!this.isEditable) return;
    const n = String(((o = t == null ? void 0 : t.getAttribute) == null ? void 0 : o.call(t, "name")) ?? "").trim() || foundry.utils.randomID(), r = j(this, Oa).get(n);
    r && clearTimeout(r);
    const s = setTimeout(() => {
      j(this, Oa).delete(n), this._syncNamedField(t, i);
    }, 180);
    j(this, Oa).set(n, s);
  }
  ...
  async _syncNamedField(t, i = {}) {
    if (!this.isEditable) return;
    const n = this._getNamedFieldUpdate(t), r = LT({
      ...n ?? {},
      ...i && typeof i == "object" ? i : {}
    });
  ...
  _restoreScrollPositions() {
    ...
    i(), requestAnimationFrame(i), Pe(this, Zi, null);
  }
  /**
...
Xi = new WeakMap(), Oi = new WeakMap(), Zi = new WeakMap(), Oa = new WeakMap(), si = new WeakSet(), ln = function(t, i, n) {
...
O(Co, "LAYOUT_ID", "contact"), O(Co, "PARTS", {
  sheet: {
    template: `${Z}/v2/item/contact.hbs`,
    scrollable: [".sheet-body"]
  }
});
...
function $T(a) {
  return a === "consumable" ? xT : _T;
}
class Eo extends ci {
  async _prepareContext(e) {
    var s;
    const t = await super._prepareContext(e), i = this._getCanonicalItemType(), n = this.item.system ?? {}, r = $T(i);
    return t.system = {
      ...n,
...
class Ro extends ci {
  async _prepareContext(e) {
    var s, o;
    const t = await super._prepareContext(e), i = qt(this.item.system ?? {}), n = Ad(), r = Array.isArray((s = t.ENUMS) == null ? void 0 : s.skills) ? t.ENUMS.skills.map((l) => ({
    ...
    return t.system = {
      ...
      effects: (Array.isArray(i.effects) ? i.effects : []).map((l) => ({
        ...l,
        showSkillPicker: Sd(l) || Array.isArray(l.skillKeys) && l.skillKeys.length > 0,
      ...
      summaryChips: [
        { label: "Category", value: Yn(i.category) },
        { label: "Tier", value: Qn(i.tier) },
...
O(Ro, "LAYOUT_ID", "quality"), O(Ro, "PARTS", {
  sheet: {
    template: `${Z}/v2/item/quality.hbs`,
    scrollable: [".sheet-body"]
  }
});
class Po extends ci {
...
O(Po, "LAYOUT_ID", "asset-module"), O(Po, "PARTS", {
  sheet: {
    template: `${Z}/v2/item/assetModule.hbs`,
    scrollable: [".sheet-body"]
  }
});
class No extends ci {
  ...
  _getSummaryChips() {
    const e = yn(this.item.system ?? {}), t = xi(e.catalogId), n = Yr(t, e.selectedGrants, { legacySelectedSkill: e.selectedSkill }).map((s) => s.choice).filter(Boolean).map((s) => gn(s, { includeBonusText: !0 })).join(", "), r = this.item.actor ? Bi(this.item.actor).stateByItemId.get(this.item.id) ?? null : null;
    return [
  ...
  async _prepareContext(e) {
    const t = await super._prepareContext(e), i = yn(this.item.system ?? {}), n = i.moduleType, r = xi(i.catalogId), s = n ? fl(n) : [], o = jd(r, i.selectedGrants, { legacySelectedSkill: i.selectedSkill }), l = this.item.actor ? Bi(this.item.actor).stateByItemId.get(this.item.id) ?? null : null;
    return t.lifeModuleEditor = {
      moduleType: n,
      moduleTypeLabel: Ba(n),
      moduleTypes: Bd().map((c) => ({
        ...c,
        selected: c.value === n
      })),
...
O(No, "LAYOUT_ID", "life-module"), O(No, "PARTS", {
  sheet: {
    template: `${Z}/v2/item/lifeModule.hbs`,
    scrollable: [".sheet-body"]
  }
});
class Io extends ci {
...
function uf(a) {
  return String((a == null ? void 0 : a.canonicalType) ?? (a == null ? void 0 : a.type) ?? "").trim() === FT;
}
function HT(a, e = "") {
  var i;
  const t = String(e ?? "").trim();
...
function jT(a, e) {
  var d, m, f, p, h, g, y;
  const t = ni(e), i = HT(a, (d = t.link) == null ? void 0 : d.itemId), n = vp({
    source: t,
...
class ns extends ci {
  ...
  async _prepareContext(e) {
    ...
    const n = Array.isArray((l = t.ENUMS) == null ? void 0 : l.skills) ? t.ENUMS.skills : [], r = (c = this.item.system) == null ? void 0 : c.skill, s = (u = this.item.system) == null ? void 0 : u.damageType, o = i === "personalWeapon" ? Do(
      n.filter((h) => BT.includes(h.value)),
      r,
      (h) => {
        var g;
    ...
    return t.weaponProfile = ((m = (d = this.item).getCombatProfile) == null ? void 0 : m.call(d)) ?? null, t.weaponEditor = {
      ...
      damageTypes: Do(
        i === "personalWeapon" ? [...fr] : [...zT],
        s,
        (h) => i === "personalWeapon" ? Qt(h) : h
      ),
      ranges: zt.RANGE_ORDER.map((h) => ({
        value: h,
        label: i === "personalWeapon" ? Ar(h) : h.charAt(0).toUpperCase() + h.slice(1)
      })),
      rangeBandLabels: Object.fromEntries(zt.RANGE_ORDER.map((h) => [
        h,
        i === "personalWeapon" ? Ar(h) : h.charAt(0).toUpperCase() + h.slice(1)
      ])),
      weaponCapabilityOptions: Df,
      payloadCapabilityOptions: Of,
      ammoDamageTypes: [{ value: "", label: "Use Weapon Default" }, ...fr],
      payloadTemplateShapes: Tu,
      payloadTemplatePlacements: wu,
      areaEffectKinds: [
      ...
      consumptionSources: Array.isArray((f = this.item.system) == null ? void 0 : f.consumptionSources) ? this.item.system.consumptionSources.map((h) => jT(this.item, h)) : []
    }, t.itemSheet = {
      ...t.itemSheet ?? {},
...
const Ra = class Ra extends ns {
  static get DEFAULT_OPTIONS() {
    return foundry.utils.mergeObject(super.DEFAULT_OPTIONS, {
      ...
      actions: {
        ...super.DEFAULT_OPTIONS.actions,
        attackWeapon: Ra._onAttackWeapon,
        reloadWeaponPayload: Ra._onReloadWeaponPayload
      }
    }, { inplace: !1 });
  }
  async _prepareContext(e) {
...
O(Ra, "LAYOUT_ID", "personal-weapon"), O(Ra, "PARTS", {
  sheet: {
    template: `${Z}/v2/item/personal-weapon-root.hbs`,
    scrollable: [".sheet-body"]
  }
});
let Oo = Ra;
...
O(Lo, "LAYOUT_ID", "mech-weapon"), O(Lo, "PARTS", {
  sheet: {
    template: `${Z}/v2/item/mech-weapon-root.hbs`,
    scrollable: [".sheet-body"]
  }
});
const KT = {
...
function WT({ defenseBonus: a = 0, mitigationByType: e = {} } = {}) {
  const t = [], i = Number(a ?? 0) || 0;
  i !== 0 && t.push(`Defense ${ou(i)}`);
  const n = li(e);
  for (const [r, s] of Object.entries(KT)) {
...
class _o extends ci {
  ...
  async _prepareContext(e) {
    var l, c, u, d, m, f, p, h, g, y, b, A, w, v, R, E;
    ...
    return t.armorState = o, t.isActiveArmor = s === i.id, t.effectiveDurabilityCurrent = Number(
      ...
      (o == null ? void 0 : o.currentArmorRating) ?? (o == null ? void 0 : o.ratingCurrent) ?? Math.min(
        ...
        Number(((w = (A = i.system) == null ? void 0 : A.durability) == null ? void 0 : w.current) ?? ((R = (v = i.system) == null ? void 0 : v.durability) == null ? void 0 : R.max) ?? ((E = i.system) == null ? void 0 : E.rating) ?? 0)
      )
  ...
  _getSummaryChips(e = null) {
    var r, s, o, l, c, u, d, m, f, p, h, g, y, b, A;
    ...
    return n > 0 && i.push({
      label: "Reinforced",
      value: `${Number(((y = (g = e == null ? void 0 : e.traitState) == null ? void 0 : g.reinforced) == null ? void 0 : y.current) ?? ((A = (b = t == null ? void 0 : t.traitState) == null ? void 0 : b.reinforced) == null ? void 0 : A.current) ?? 0)}/${n}`
    }), i;
  }
...
O(_o, "LAYOUT_ID", "armor"), O(_o, "PARTS", {
  sheet: {
    template: `${Z}/v2/item/armor-root.hbs`,
    scrollable: [".sheet-body"]
  }
});
function GT() {
  ...
  a.registerSheet(T, Co, { types: ["contact"], makeDefault: !0, label: "Contact (V2)" }), a.registerSheet(T, Eo, { types: ["gear", "consumable"], makeDefault: !0, label: "Gear / Consumable (V2)" }), a.registerSheet(T, Ro, { types: ["quality"], makeDefault: !0, label: "Quality (V2)" }), a.registerSheet(T, Po, { types: ["assetModule"], makeDefault: !0, label: "Asset Module (V2)" }), a.registerSheet(T, No, { types: ["lifeModule"], makeDefault: !0, label: "Life Module (V2)" }), a.registerSheet(T, Io, { types: ["skill"], makeDefault: !0, label: "Skill (V2)" }), a.registerSheet(T, Oo, { types: ["personalWeapon", "weapon"], makeDefault: !0, label: "Personal Weapon (V2)" }), a.registerSheet(T, Lo, { types: ["mechWeapon"], makeDefault: !0, label: "Mech Weapon (V2)" }), a.registerSheet(T, _o, { types: ["armor"], makeDefault: !0, label: "Armor (V2)" });
}
const lu = [
...
async function YT() {
  ...
  try {
    ...
    console.log(`${Ce}preloadTemplatesV2 OK`, { loaded: lu.length });
  } catch (i) {
...
function JT(a = {}) {
  ...
  return {
    physical: { penalty: cu(n) },
    fatigue: { penalty: cu(r) },
    armor: { resistance: QT(s) }
  };
}
const Is = {
  penaltyPer3Damage: (a) => {
...
class ew extends Actor {
  /** @override */
  async _preCreate(e, t, i) {
    super._preCreate && await super._preCreate(e, t, i);
    const n = await Gd("Actor", (e == null ? void 0 : e.type) ?? this.type), r = {};
  ...
  prepareBaseData() {
    ...
    if (super.prepareBaseData(), this.isCharacterLike()) {
      const i = this.system ?? {};
      if (Wp(i), i.speed = Math.max(0, Math.trunc(Number(i.speed ?? 12) || 12)), (e = i.skills) != null && e.skills && typeof i.skills.skills == "object") {
  ...
  async setMonitorValue(e, t, { source: i = "unknown" } = {}) {
    ...
    if (e === "heat" && this.type === "battlemech") {
      const y = Number(foundry.utils.getProperty(this, "system.monitors.heat.max")), b = Number(foundry.utils.getProperty(this, "system.mwd.heat.max")), A = Number(foundry.utils.getProperty(this, "system.mwd.heat.hardMax")), w = Math.max(
        0,
        Number.isFinite(y) && y > 0 ? y : Number.isFinite(b) && b > 0 ? b : Number.isFinite(A) ? A : 0
    ...
    if (e === "armor" && this.isCharacterLike()) {
      ...
      const w = Math.max(0, Number(((f = A.system) == null ? void 0 : f.rating) ?? 0) || 0), v = Math.max(0, Number(((h = (p = A.system) == null ? void 0 : p.durability) == null ? void 0 : h.max) ?? 0) || 0), R = v > 0 ? v : w, E = Math.min(Math.max(0, Number(t) || 0), R);
      return this.updateEmbeddedDocuments("Item", [{
        _id: A.id,
        "system.durability.max": R,
    ...
    if (u != null && u.derived)
      for (const [y, b] of Object.entries(u.derived)) {
        const A = Is == null ? void 0 : Is[b.fn];
        if (typeof A != "function") continue;
        const w = XT(this, e, b.source, o);
        l[`${n}.derived.${y}`] = A(w);
      }
  ...
  _prepareMonitors() {
    var o, l, c, u, d, m, f, p;
    const e = this.system.monitors ?? {}, t = JT(e);
  ...
  _preparePersonalCombatDerived() {
    ...
    t.max = n, t.value = Math.min(n, r), t.resistance = {
      ...
      byType: {}
    }, t.resistanceBonusByType = i != null && i.isDestroyed ? {} : (i == null ? void 0 : i.mitigationByType) ?? (i == null ? void 0 : i.typedMitigation) ?? {}, t.derived ?? (t.derived = {}), t.derived.resistance = Number((i == null ? void 0 : i.baseMitigation) ?? (i == null ? void 0 : i.baseResistance) ?? 0), t.effect = i != null && i.isDestroyed ? "Destroyed" : i ? ZT(i.mitigationByType ?? i.typedMitigation) : "", (u = this.system).derived ?? (u.derived = {}), this.system.derived.personalCombat = {
...
async function tw({ actor: a, payload: e } = {}) {
  var g, y, b, A, w, v;
...
const ow = 90;
var bu;
const lw = Number(((bu = CONST == null ? void 0 : CONST.REGION_VISIBILITY) == null ? void 0 : bu.ALWAYS) ?? 2) || 2;
function Mr() {
  var a, e;
...
function Cr(a) {
  ...
  const t = Number((a == null ? void 0 : a.x) ?? ((o = a == null ? void 0 : a.document) == null ? void 0 : o.x) ?? 0), i = Number((a == null ? void 0 : a.y) ?? ((l = a == null ? void 0 : a.document) == null ? void 0 : l.y) ?? 0), n = Number((a == null ? void 0 : a.w) ?? (a == null ? void 0 : a.width) ?? ((c = a == null ? void 0 : a.document) == null ? void 0 : c.width) ?? 1) * Mr(), r = Number((a == null ? void 0 : a.h) ?? (a == null ? void 0 : a.height) ?? ((u = a == null ? void 0 : a.document) == null ? void 0 : u.height) ?? 1) * Mr();
  return { x: t + n / 2, y: i + r / 2 };
}
function uw(a) {
  var i, n, r, s;
  const e = Number((a == null ? void 0 : a.w) ?? ((i = a == null ? void 0 : a.object) == null ? void 0 : i.w) ?? 0) || Number(((n = a == null ? void 0 : a.document) == null ? void 0 : n.width) ?? 1) * Mr(), t = Number((a == null ? void 0 : a.h) ?? ((r = a == null ? void 0 : a.object) == null ? void 0 : r.h) ?? 0) || Number(((s = a == null ? void 0 : a.document) == null ? void 0 : s.height) ?? 1) * Mr();
  return Math.max(e, t) / 2;
}
function dw() {
  var t;
...
function pw({ template: a = {}, actor: e = null } = {}) {
  const t = String((a == null ? void 0 : a.placement) ?? "").trim().toLowerCase(), i = Ka(e), n = mw(), r = i ? Cr(i) : null, s = n ? Cr(n) : null;
  return t === "origin" && r ? r : t === "targeted" && s ? s : t === "placed" && r && s ? fw(r, s) : dw();
}
function hw({ attack: a = {}, actor: e = null } = {}) {
  const t = (a == null ? void 0 : a.template) ?? null, i = String((t == null ? void 0 : t.shape) ?? "").trim().toLowerCase();
  if (!i) return null;
  const n = pw({ template: t, actor: e });
  return He({
    shape: i,
    x: n.x,
    y: n.y,
...
function bw() {
  const a = gw(), e = new PIXI.Container();
...
function ww({ geometry: a = null, pointer: e = null, attack: t = {}, actor: i = null } = {}) {
  var l;
  const n = He(a);
  if (!n) return null;
  const r = oi(n) ?? null;
  ...
  if (o && (r.x = e.x, r.y = e.y), ["line", "cone", "rect"].includes(String(r.shape ?? "").trim().toLowerCase())) {
    const c = Ka(i), u = c ? Cr(c) : null, d = o ? u ?? { x: Number(n.x ?? 0), y: Number(n.y ?? 0) } : { x: Number(r.x ?? 0), y: Number(r.y ?? 0) };
    r.direction = Tw(d, e);
  }
  return He(r);
}
function vw(a, e = null) {
  if (!a) return;
  df(a);
  const t = He(e);
  if (!t) return;
  const i = Aw(), n = new PIXI.Graphics();
...
function Mw(a, e = []) {
  if (a) {
    df(a);
    for (const t of e) {
      const i = Cr(t.token), n = Math.max(20, uw(t.token) + 12), r = kw(t.exposureTier), s = new PIXI.Graphics();
...
function mf(a, e = {}) {
  var r, s, o, l, c, u, d, m, f, p, h, g, y, b, A, w;
  ...
  return {
    ...
    exposure: zi({
      ...
      evadeUsed: !!((A = e == null ? void 0 : e.exposure) != null && A.evadeUsed),
...
function Cw({ attack: a = {}, geometry: e = null, attacker: t = null } = {}) {
  var o;
  const i = (a == null ? void 0 : a.template) ?? null, n = He(e);
  if (!i || !n) return [];
  const r = Ka(t), s = (r == null ? void 0 : r.id) ?? null;
  return (((o = canvas.tokens) == null ? void 0 : o.placeables) ?? []).filter((l) => l == null ? void 0 : l.actor).filter((l) => l.id !== s || (i == null ? void 0 : i.placement) === "origin").filter((l) => Ir(n, l)).map((l) => {
    const c = Du({ geometry: n, token: l });
    return mf(l, {
      exposureTier: c,
      areaEffect: {
...
function Ew({ attack: a = {}, geometry: e = null, attacker: t = null } = {}) {
  var o;
  const i = (a == null ? void 0 : a.template) ?? null, n = Ka(t), r = (n == null ? void 0 : n.id) ?? null, s = He(e);
  return !i || !s ? [] : (((o = canvas.tokens) == null ? void 0 : o.placeables) ?? []).filter((l) => l == null ? void 0 : l.actor).filter((l) => l.id !== r || (i == null ? void 0 : i.placement) === "origin").filter((l) => Ir(s, l)).map((l) => ({
    token: l,
    exposureTier: Du({ geometry: s, token: l })
  }));
}
function Rw({ geometry: a = null, attack: e = {}, attacker: t = null } = {}) {
  var m, f, p, h;
  const i = (e == null ? void 0 : e.template) ?? null, n = He(a);
  if (!i || !n) return [];
  const r = Ka(t), s = (r == null ? void 0 : r.id) ?? null, o = Number(((m = CONST == null ? void 0 : CONST.TOKEN_DISPOSITIONS) == null ? void 0 : m.HOSTILE) ?? -1), l = Number(((f = CONST == null ? void 0 : CONST.TOKEN_DISPOSITIONS) == null ? void 0 : f.FRIENDLY) ?? 1), c = Number(((p = CONST == null ? void 0 : CONST.TOKEN_DISPOSITIONS) == null ? void 0 : p.NEUTRAL) ?? 0), u = uu(r), d = (g) => {
    const y = uu(g);
    return r ? u === l ? y === o : u === o ? y === l : u === c ? y === o : y !== u : !0;
  };
  return (((h = canvas.tokens) == null ? void 0 : h.placeables) ?? []).filter((g) => g == null ? void 0 : g.actor).filter((g) => g.id !== s || (i == null ? void 0 : i.placement) === "origin").filter((g) => Ir(n, g)).filter(d).map((g) => String(g.id ?? "").trim()).filter(Boolean);
}
function Pw(a = {}) {
  var i;
...
async function Iw({ actor: a = null, attack: e = {}, templateGeometry: t = null } = {}) {
  var o, l, c, u, d, m;
...
async function Dw({ actor: a, attack: e } = {}) {
  if (!(canvas != null && canvas.scene))
    throw Gi("Templated attacks require an active scene canvas.", { severity: "warn" });
  const t = (e == null ? void 0 : e.template) ?? null;
  if (!(t != null && t.shape) || !(Number(t == null ? void 0 : t.size) > 0))
    throw Gi("Templated attack is missing valid template configuration.", { severity: "warn" });
  if (!Lf.includes(t.shape))
    throw Gi(`Template shape "${t.shape}" is normalized but not supported in v1.`, { severity: "warn" });
  const i = Ka(a);
  if (t.placement === "origin" && !i)
    throw Gi("Origin-placed templated attacks require the attacker to have a token on the current scene.", { severity: "warn" });
  const n = hw({ attack: e, actor: a });
  if (!n)
    throw Gi("Unable to initialize template placement for this attack.", { severity: "warn" });
  const r = bw();
  let s = oi(n), o = "";
  const l = (d = null) => JSON.stringify({
    ...
    vw(r.templateLayer, s), Mw(r.markerLayer, Ew({ attack: e, geometry: s, attacker: a }));
  }, u = (d) => {
    const m = xo(d);
    if (!m) return;
    const f = ww({
  ...
  try {
    if (o = l(s), c(), window.addEventListener("pointermove", u), !await Nw({
      attack: {
        ...e,
        actor: a
      }
    ...
    window.removeEventListener("pointermove", u), Sw(r);
  }
}
function Ow(a = {}) {
  var e;
  return Array.isArray(a == null ? void 0 : a.targetSnapshots) ? a.targetSnapshots : Array.from(((e = game.user) == null ? void 0 : e.targets) ?? []).map(mf).filter(Boolean);
}
function Lw(a, e = {}) {
...
function $w({ actor: a, payload: e, weapon: t, targets: i = [] } = {}) {
  ...
  const s = Lw(a, e), o = _w(i[0]), l = xw(s, o), c = ug(l, (t == null ? void 0 : t.range) ?? {}, (t == null ? void 0 : t.defaultRangeBand) ?? "close");
...
function Fw(a, e) {
  ...
  }).filter(Boolean), o = s[0] ?? {}, l = s.reduce((g, y) => zw(g, y.attackRatingBand), {}), c = s.reduce((g, y) => g + (Number(y.damage ?? 0) || 0), 0), u = Math.max(0, ...s.map((g) => Number(g.ap ?? 0) || 0)), d = String(o.skill ?? "gunnery").trim() || "gunnery";
  return {
    id: i.id,
    uuid: a.uuid ?? null,
...
async function Hw({ actor: a, payload: e } = {}) {
  var R, E, x, K, q, H, W, _, F, V, Y, re, ce, ue, oe, Re, Ie, _e;
  if (!a) throw new Error("resolveAttack requires actor");
  const t = Uw(a, e);
  if (!t) throw new Error("Unable to resolve weapon profile.");
  if (Array.isArray((R = t == null ? void 0 : t.capabilityReport) == null ? void 0 : R.errors) && t.capabilityReport.errors.length > 0)
    throw Gi(
  ...
  const i = Dt(t.skill) ?? {
    ...
    attribute: "reflexes",
    domains: ["physical"]
  }, n = String(i.attribute ?? "reflexes").trim() || "reflexes", r = ((x = a.getAttributeValue) == null ? void 0 : x.call(a, n)) ?? Number(((H = (q = (K = a.system) == null ? void 0 : K.attributes) == null ? void 0 : q[n]) == null ? void 0 : H.value) ?? 0), s = ((W = a.getSkillRating) == null ? void 0 : W.call(a, t.skill)) ?? Number(((V = (F = (_ = a.system) == null ? void 0 : _.skills) == null ? void 0 : F[t.skill]) == null ? void 0 : V.rating) ?? 0), o = Number(((ce = (re = (Y = a.system) == null ? void 0 : Y.skills) == null ? void 0 : re[t.skill]) == null ? void 0 : ce.bonus) ?? 0), l = new Set($r(a.system ?? {}, t.skill)), c = Jo(t.skill, e == null ? void 0 : e.specializationKey), u = c && l.has(c.key) ? c : null, d = u ? Vo : 0, m = Number(((ue = t == null ? void 0 : t.effects) == null ? void 0 : ue.accuracyMod) ?? 0) || 0, f = o + m, p = Ow(e), h = $w({ actor: a, payload: e, weapon: t, targets: p }), g = (t == null ? void 0 : t.type) === "personalWeapon" || t != null && t.isSynthetic ? Kr(h) : h, y = Number(((oe = t == null ? void 0 : t.attackRatingBand) == null ? void 0 : oe[h]) ?? 0) || 0, b = !!((Re = t == null ? void 0 : t.capabilityReport) != null && Re.isTemplated), A = (Ie = e == null ? void 0 : e.aim) != null && Ie.active ? {
    active: !0,
  ...
  if (!b && p.length === 0)
    throw Gi("Target at least one token to attack.", { severity: "warn" });
  const w = Number(t.ap ?? 0) + Number(((_e = t == null ? void 0 : t.effects) == null ? void 0 : _e.ap) ?? 0), v = Number.isFinite(Number(e == null ? void 0 : e.dn)) ? Number(e.dn) : (t == null ? void 0 : t.type) === "personalWeapon" || t != null && t.isSynthetic ? cg(h, 1) : 1;
  return {
    intent: "attack",
    rollType: "simple",
    title: `${t.name} Attack`,
...
async function jw({ actor: a, payload: e, event: t } = {}) {
  return {
    title: "Defense",
    intent: "defense",
    domainTags: ["combat"],
...
async function Kw({ actor: a, payload: e, event: t } = {}) {
  return {
    title: "Resistance",
    intent: "resistance",
    domainTags: ["combat"],
...
function Os(a, e) {
  var t, i, n;
  return Math.max(0, Ww((n = (i = (t = a == null ? void 0 : a.system) == null ? void 0 : t.attributes) == null ? void 0 : i[e]) == null ? void 0 : n.value, 0));
}
function Gw(a) {
  return (a == null ? void 0 : a.type) === S.actorTypes.vehicle || (a == null ? void 0 : a.type) === S.actorTypes.battlemech;
}
function qw({ machineActor: a = null, pilotActor: e = null } = {}) {
  const t = Os(a, S.actorAttributes.handling), i = Os(a, S.actorAttributes.system), n = Os(e, S.actorAttributes.reflexes), r = i > t ? S.actorAttributes.system : S.actorAttributes.handling, s = i > t ? "System" : "Handling", o = Math.max(t, i);
  return {
    handling: t,
    system: i,
...
async function Vw({ actor: a } = {}) {
  var i, n, r, s, o, l, c;
  if (Gw(a)) {
    const u = await wl({ machineActor: a }), d = qw({
      machineActor: a,
      pilotActor: u.actor
...
async function Jw({ actor: a, payload: e } = {}) {
  var l, c, u, d, m, f, p;
  const t = await vl(e, {
  ...
  const r = t.actor ?? a ?? i.operatorActor ?? i.machineActor, s = $o((d = (u = (c = (l = i.machineActor) == null ? void 0 : l.system) == null ? void 0 : c.attributes) == null ? void 0 : u.reliability) == null ? void 0 : d.value, 0), o = Qw(r, i.skillKey);
  return {
    intent: "machineRemedy",
    rollType: "simple",
...
async function Ls({ actor: a, payload: e, event: t } = {}) {
  ...
  return Zw(r, { intent: i });
}
function Zw(a, { intent: e } = {}) {
...
class e0 {
  ...
  register(e) {
    ...
    j(this, La).has(e.id) || j(this, La).set(e.id, e);
  }
  async collectAll(e) {
    const t = [];
    for (const i of j(this, La).values()) {
...
function i0(a) {
  const e = t0(a == null ? void 0 : a.value);
...
function a0({
  ...
  const m = foundry.utils.randomID(), f = (K = i.dice) == null ? void 0 : K[0], h = (Array.isArray(f == null ? void 0 : f.results) ? f.results : []).map((_, F) => {
    const V = `pool:${F}`, Y = Number(_.result), re = !!_.success;
    return {
      ref: V,
      face: Y,
      isSuccess: re,
      isFailure: !re,
      tooltip: re ? `Die ${F + 1}: ${Y} (Success vs TN ${Number(n ?? 5)})` : `Die ${F + 1}: ${Y} (Failure vs TN ${Number(n ?? 5)})`
    };
    ...
    const V = Number(_.value ?? 0), Y = `mod:${r0(_.label ?? "mod")}:${F}`;
    return {
      id: _.id ?? Y,
      ...
      tooltip: _.tooltip ?? `${_.label ?? "Modifier"} ${mu(V)}`
    };
  }), A = b.map((_) => _.id), v = (Array.isArray(t == null ? void 0 : t.breakdown) ? t.breakdown : []).map((_) => ({
  ...
  v.push({
    ...
    value: Number(o ?? 0),
    modIds: A,
    tooltip: b.length ? b.map((_) => `${_.label}: ${mu(_.value)}`).join(`
`) : "No roll-time modifiers."
  ...
  const R = Number.isFinite(Number(l)) ? Number(l) : h.filter((_) => _.isSuccess).length, E = Number.isFinite(Number(c)) ? Number(c) : h.filter((_) => _.face === 1).length, x = n0(u, { payload: e });
  return {
    version: 2,
    id: m,
    actorUuid: a.uuid,
    ...
    ctxSnapshot: {
      ...
      edge: {
        pool: ((H = t == null ? void 0 : t.edge) == null ? void 0 : H.pool) ?? null,
...
function n0(a, { payload: e } = {}) {
  var p, h, g, y, b, A, w, v, R, E, x, K, q, H;
  const t = !!((p = e == null ? void 0 : e.edge) != null && p.enabled), i = (a == null ? void 0 : a.domain) ?? null, n = (a == null ? void 0 : a.pools) ?? null, r = ((h = a == null ? void 0 : a.pre) == null ? void 0 : h.poolKey) ?? ((y = (g = e == null ? void 0 : e.edge) == null ? void 0 : g.pre) == null ? void 0 : y.poolKey) ?? (t ? ((b = e == null ? void 0 : e.edge) == null ? void 0 : b.poolKey) ?? null : null), s = Number(((A = a == null ? void 0 : a.pre) == null ? void 0 : A.spent) ?? ((v = (w = e == null ? void 0 : e.edge) == null ? void 0 : w.pre) == null ? void 0 : v.spent) ?? (t ? 1 : 0)) ? 1 : 0, o = ((R = a == null ? void 0 : a.post) == null ? void 0 : R.poolKey) ?? ((x = (E = e == null ? void 0 : e.edge) == null ? void 0 : E.post) == null ? void 0 : x.poolKey) ?? null, l = Number(((K = a == null ? void 0 : a.post) == null ? void 0 : K.spent) ?? ((H = (q = e == null ? void 0 : e.edge) == null ? void 0 : q.post) == null ? void 0 : H.spent) ?? 0) ? 1 : 0, c = (n == null ? void 0 : n.a) ?? null, u = (n == null ? void 0 : n.b) ?? null, d = [c, u].filter(Boolean);
...
const { ApplicationV2: s0, HandlebarsApplicationMixin: o0 } = foundry.applications.api;
function l0(a, e = -3, t = 3) {
  const i = [], n = "../img/dice";
  for (let r = e; r <= t; r++) {
...
function pu(a, e, t) {
  const i = String(t ?? "").trim(), n = i ? Hp(e, i) : "";
  if (i && n) {
...
var Lt;
const Ge = class Ge extends o0(s0) {
  constructor({ actor: t, baseContext: i, initialState: n = null, options: r = {} }) {
    ...
    const s = foundry.utils.deepClone(this._mwd.baseContext.payload ?? {}), o = fu(s.manualModifiers);
  ...
  async wait() {
    return new Promise((t) => {
      Pe(this, Lt, t), this.render(!0);
    });
  }
  async close(t = {}) {
    if (j(this, Lt)) {
      const i = j(this, Lt);
      Pe(this, Lt, null), i(null);
    }
  ...
  /* --------------------------- */
  async _prepareContext(t) {
    var K, q, H, W, _, F, V, Y, re, ce, ue, oe, Re, Ie, _e, rt, st, ot, qe, lt, Ze, Ve, bt, vt, kt, Mt, N, U, ge, ae, De, M, P, Q, ne, te, be, Be, et, dt, Ot;
    const i = this._mwd.baseContext ?? {}, n = this._mwd.state ?? {}, r = Number.isFinite(Number((K = n == null ? void 0 : n.payload) == null ? void 0 : K.dn)) ? Number(n.payload.dn) : Number.isFinite(Number((H = (q = i == null ? void 0 : i.resolved) == null ? void 0 : q.dn) == null ? void 0 : H.total)) ? Number(i.resolved.dn.total) : Number.isFinite(Number(i == null ? void 0 : i.dn)) ? Number(i.dn) : Number.isFinite(Number((_ = (W = i == null ? void 0 : i.resolved) == null ? void 0 : W.difficulty) == null ? void 0 : _.dn)) ? Number(i.resolved.difficulty.dn) : 1, s = (i == null ? void 0 : i.intent) ?? "skill";
    let o, l;
    const c = Array.isArray(n.manual) ? n.manual.reduce((ie, Te) => ie + Number((Te == null ? void 0 : Te.value) || 0), 0) : 0;
    if (s === "edge") {
      const ie = (i == null ? void 0 : i.resolved) ?? {}, Te = Array.isArray(ie.breakdown) ? ie.breakdown : [], ct = (mt) => {
        var Ye;
        return Number(((Ye = Te.find((Jt) => Jt.id === mt)) == null ? void 0 : Ye.value) ?? 0);
      }, ut = Number(((F = ie == null ? void 0 : ie.pool) == null ? void 0 : F.attribute) ?? 0);
      o = {
        pool: ut,
        rating: ct("rating"),
        cap: ct("cap"),
      ...
      o = {
        ...
        bonus: Number(((ce = i == null ? void 0 : i.dice) == null ? void 0 : ce.bonus) ?? 0),
        specialization: Number(((ue = i == null ? void 0 : i.dice) == null ? void 0 : ue.specialization) ?? 0),
        modifiers: Number(((oe = i == null ? void 0 : i.dice) == null ? void 0 : oe.modifiers) ?? 0)
      };
      const ie = o.modifiers + c, Te = o.attribute + o.skill + o.bonus + o.specialization;
      l = Math.max(0, Te + ie);
    }
    const u = Array.isArray((Re = i == null ? void 0 : i.resolved) == null ? void 0 : Re.domains) ? i.resolved.domains : [], d = u.includes("physical") ? "physical" : u.includes("mental") ? "mental" : u.includes("social") ? "social" : null, f = (d === "physical" ? ["grit", "chaos"] : d === "mental" ? ["insight", "rumor"] : d === "social" ? ["legend", "credibility"] : []).map((ie) => {
      var Te, ct, ut, mt;
      return {
        key: ie,
        label: ie.charAt(0).toUpperCase() + ie.slice(1),
        available: Number(((ut = (ct = (Te = this.actor) == null ? void 0 : Te.getEdgePool) == null ? void 0 : ct.call(Te, ie)) == null ? void 0 : ut.effectiveValue) ?? 0),
        selected: ie === (((mt = n.edge) == null ? void 0 : mt.prePoolKey) ?? null)
      };
    }), p = f.find((ie) => ie.selected), h = (p == null ? void 0 : p.label) ?? null, g = ((Ie = i == null ? void 0 : i.resolved) == null ? void 0 : Ie.attack) ?? null, y = String(
      ((_e = g == null ? void 0 : g.skill) == null ? void 0 : _e.code) ?? ((st = (rt = i == null ? void 0 : i.resolved) == null ? void 0 : rt.specialization) == null ? void 0 : st.skillKey) ?? ((qe = (ot = i == null ? void 0 : i.resolved) == null ? void 0 : ot.data) == null ? void 0 : qe.skillKey) ?? ((lt = i == null ? void 0 : i.payload) == null ? void 0 : lt.key) ?? ""
    ).trim(), b = y ? ed(((Ze = this.actor) == null ? void 0 : Ze.system) ?? {}, y) : [], A = String(((Ve = n == null ? void 0 : n.payload) == null ? void 0 : Ve.specializationKey) ?? "").trim(), w = b.find((ie) => ie.key === A) ?? null;
    if (s !== "edge") {
      o.specialization = w ? Number(((vt = (bt = i == null ? void 0 : i.resolved) == null ? void 0 : bt.specialization) == null ? void 0 : vt.value) ?? 2) : 0;
      const ie = o.modifiers + c, Te = o.attribute + o.skill + o.bonus + o.specialization;
      l = Math.max(0, Te + ie);
    }
    const v = Array.isArray((kt = g == null ? void 0 : g.payloadState) == null ? void 0 : kt.payloads) ? g.payloadState.payloads : [], R = String(((Mt = g == null ? void 0 : g.weapon) == null ? void 0 : Mt.category) ?? "").trim().toLowerCase() !== "melee" && v.length > 0, E = String(((N = n == null ? void 0 : n.payload) == null ? void 0 : N.payloadId) ?? ((U = g == null ? void 0 : g.payloadState) == null ? void 0 : U.activePayloadId) ?? "").trim(), x = v.find((ie) => ie.id === E) ?? null;
    return {
      header: {
        left: ((ge = i == null ? void 0 : i.header) == null ? void 0 : ge.left) ?? "Roll",
        right: ((ae = i == null ? void 0 : i.header) == null ? void 0 : ae.right) ?? ((De = this.actor) == null ? void 0 : De.name) ?? ""
      },
      formula: String((i == null ? void 0 : i.formula) ?? ((M = i == null ? void 0 : i.resolved) == null ? void 0 : M.formula) ?? "").trim(),
      dice: o,
      modifiers: Array.isArray(i.modifiers) ? i.modifiers : [],
      manual: (n.manual ?? []).map((ie) => ({
        ...ie,
        steps: l0(Number(ie.value ?? 0), -3, 3)
      })),
      edge: {
        domain: d,
        choices: f,
      ...
      attack: g ? {
        weaponName: ((P = g == null ? void 0 : g.weapon) == null ? void 0 : P.name) ?? "Weapon",
        rangeBand: ((Q = g == null ? void 0 : g.weapon) == null ? void 0 : Q.type) === "personalWeapon" || (ne = g == null ? void 0 : g.weapon) != null && ne.isSynthetic ? Kr((g == null ? void 0 : g.rangeBand) ?? "") : (g == null ? void 0 : g.rangeBand) ?? "",
        damageType: ((te = x == null ? void 0 : x.modifies) == null ? void 0 : te.damageType) || ((be = g == null ? void 0 : g.weapon) == null ? void 0 : be.damageTypeLabel) || ((Be = g == null ? void 0 : g.weapon) == null ? void 0 : Be.damageType) || "",
        usesPayloads: R,
        ...
        payloads: v.map((ie) => {
          ...
          return {
            id: ie.id,
            name: ie.label,
            damageType: (Te = ie.modifies) == null ? void 0 : Te.damageType,
            selected: ie.id === E
          };
        }),
        selectedPayloadId: E,
        selectedPayloadLabel: (x == null ? void 0 : x.label) ?? ((et = g == null ? void 0 : g.payload) == null ? void 0 : et.label) ?? ((dt = g == null ? void 0 : g.weapon) == null ? void 0 : dt.payloadLabel) ?? "",
  ...
  /* --------------------------- */
  async _onCancel(t) {
    if (t == null || t.preventDefault(), j(this, Lt)) {
      const i = j(this, Lt);
      Pe(this, Lt, null), i(null);
    }
    return this.close();
  ...
  async _onSubmit(t) {
    ...
    if (i.payload.manualModifiers = (i.manual ?? []).filter((y) => {
      ...
      const y = j(this, Lt);
      Pe(this, Lt, null), y({ payload: i.payload });
    }
  ...
  async _onSetSpecialization(t, i) {
    ...
    if (n)
      return pu(this._mwd.state.payload, n, r), this.render(!1);
  }
  _onRender(t, i) {
    var r, s;
    (r = super._onRender) == null || r.call(this, t, i);
  ...
  static async prompt({ actor: t, basePayload: i, resolved: n, diceParts: r = null, mods: s = [], modTotal: o = 0 } = {}) {
    ...
    try {
      ...
      if (y === "simple" && b !== "attack" && (l == null ? void 0 : l.dn) == null) {
        const A = Number(game.settings.get(game.system.id, "gmNextDn"));
        Number.isFinite(A) && (l.dn = Math.max(0, Math.trunc(A)));
      }
    } catch (y) {
    ...
    l.manualModifiers = fu(l.manualModifiers);
...
Lt = new WeakMap(), O(Ge, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  Xt(Ge, Ge, "DEFAULT_OPTIONS"),
  {
    id: "mwd-roll-dialog",
    classes: [
      ...Xt(Ge, Ge, "DEFAULT_OPTIONS").classes ?? [],
      "mwd",
      "mwd-roll-dialog"
    ],
    ...
    actions: {
      ...
      setPayload: Ge.prototype._onSetPayload,
...
let Bo = Ge;
const { ApplicationV2: d0, HandlebarsApplicationMixin: m0 } = foundry.applications.api, mn = class mn extends m0(d0) {
  static get DEFAULT_OPTIONS() {
    return foundry.utils.mergeObject(super.DEFAULT_OPTIONS, {
      id: "select-item",
...
O(mn, "PARTS", {
  body: {
    template: `${Z}/dialog/select-item.hbs`
  }
});
let zo = mn;
const hu = { execute: S0 }, f0 = {
  physical: ["grit", "chaos"],
...
function gu(a = {}) {
  ...
  return {
    ...
    manualModifiers: y0(a.manualModifiers)
  };
}
async function g0({ actor: a, payload: e } = {}) {
  ...
  const t = foundry.utils.deepClone(e ?? {}), i = ((r = a.getPersonalCombatLoadout) == null ? void 0 : r.call(a, { refresh: !0 })) ?? null, n = (y) => {
    var A, w, v, R, E;
    const b = ((w = (A = a.items) == null ? void 0 : A.get) == null ? void 0 : w.call(A, y)) ?? null;
    return !b || !(((v = b.isPersonalWeapon) == null ? void 0 : v.call(b)) ?? b.type === S.itemType.personalWeapon) || !((R = b.system) != null && R.equipped) ? null : ((E = b.getCombatProfile) == null ? void 0 : E.call(b, { payloadId: t == null ? void 0 : t.payloadId })) ?? null;
  };
  if (t.weaponId) {
...
async function S0({ actor: a, payload: e, event: t } = {}) {
  var F, V, Y, re, ce, ue, oe, Re, Ie, _e, rt, st, ot, qe, lt, Ze, Ve, bt, vt, kt, Mt, N, U, ge, ae, De, M, P, Q, ne, te, be, Be, et, dt, Ot, ie, Te, ct, ut, mt, Ye, Jt, vi, Wa, Ga;
  ...
  if (e = gu(e), e = await g0({ actor: a, payload: e }), !e) return null;
  ...
  if (e.intent === "attack" && ((Y = (V = i == null ? void 0 : i.attack) == null ? void 0 : V.capabilityReport) != null && Y.isTemplated)) {
    ...
    try {
      ...
      console.warn("MWD | Unable to create visual template indicator", Oe);
    }
    if (await b0(J.autoTargetTokenIds ?? []), !Ru(((re = i == null ? void 0 : i.attack) == null ? void 0 : re.areaEffect) ?? ((ue = (ce = i == null ? void 0 : i.attack) == null ? void 0 : ce.payload) == null ? void 0 : ue.areaEffect) ?? {}) && (!Array.isArray(J.targetSnapshots) || J.targetSnapshots.length === 0))
  ...
  const r = await Bo.prompt({
    ...
    resolved: i,
    diceParts: {
      attribute: ((Re = i == null ? void 0 : i.pool) == null ? void 0 : Re.attribute) ?? 0,
      skill: ((Ie = i == null ? void 0 : i.pool) == null ? void 0 : Ie.skill) ?? 0,
      bonus: ((_e = i == null ? void 0 : i.pool) == null ? void 0 : _e.bonus) ?? 0,
      specialization: ((rt = i == null ? void 0 : i.pool) == null ? void 0 : rt.specialization) ?? 0
    },
    mods: n.mods,
    modTotal: n.total,
    options: {
  ...
  if (!r) return null;
  if (e = gu(r), i = await Ls({ actor: a, payload: e, event: t }), e.intent === "attack" && !((ot = (st = i == null ? void 0 : i.attack) == null ? void 0 : st.capabilityReport) != null && ot.isTemplated) && (delete e.targetSnapshots, delete e.templatePlacement, delete e.templateGeometry), e.intent === "attack" && e.weaponId) {
    const J = ((lt = (qe = a.items) == null ? void 0 : qe.get) == null ? void 0 : lt.call(qe, e.weaponId)) ?? null;
    if ((Ze = J == null ? void 0 : J.isPersonalWeapon) != null && Ze.call(J)) {
      const Oe = String(e.payloadId ?? "").trim(), rs = String(((Ve = J.system) == null ? void 0 : Ve.selectedPayloadId) ?? "").trim();
      if (Oe && Oe !== rs && await ((bt = J.setActivePayload) == null ? void 0 : bt.call(J, Oe)), !((vt = J.canConsumePayload) != null && vt.call(J, { payloadId: Oe }))) {
        const mi = (kt = J.getPayloadState) == null ? void 0 : kt.call(J, { payloadId: Oe }), qa = mi != null && mi.payloadLabel ? ` (${mi.payloadLabel})` : "";
  ...
  const { mods: s, total: o } = n, { mods: l, total: c } = h0(e);
  let u = [...s, ...l], d = Number(o ?? 0) + Number(c ?? 0);
  const m = Number(((N = i == null ? void 0 : i.pool) == null ? void 0 : N.attribute) ?? 0) + Number(((U = i == null ? void 0 : i.pool) == null ? void 0 : U.skill) ?? 0) + Number(((ge = i == null ? void 0 : i.pool) == null ? void 0 : ge.bonus) ?? 0) + Number(((ae = i == null ? void 0 : i.pool) == null ? void 0 : ae.specialization) ?? 0), f = Math.max(0, m + Number(d ?? 0)), p = e.intent !== "initiative", h = p ? A0({ actor: a, ctx: i, payload: e }) : null, g = (De = h == null ? void 0 : h.pre) != null && De.spent ? 4 : Number(i.diceTarget ?? i.target ?? 5), y = {
    snapshot: ((Q = (P = (M = game.mwd) == null ? void 0 : M.personalCombat) == null ? void 0 : P.getSnapshot) == null ? void 0 : Q.call(P, a)) ?? null
  };
  let b = null, A = null;
  if (i.intent === "machineRemedy") {
    if (A = await ts(e, {
      ...
      return (ne = ui.notifications) == null || ne.warn(A.reason ?? "Unable to resolve the machine remedy."), null;
    if (b = await LA(A), !(b != null && b.ok))
      return (te = ui.notifications) == null || te.warn((b == null ? void 0 : b.reason) ?? "Unable to spend the remedy action."), null;
  }
  const w = Bt({
    actor: a,
    phase: "onBuildRoll",
  ...
  await Ai({ actor: a, mutations: w.mutations, runtime: y }), p && ((be = h == null ? void 0 : h.pre) != null && be.spent) && ((Be = h == null ? void 0 : h.pre) != null && Be.poolKey) && await ((et = a.spendEdge) == null ? void 0 : et.call(a, h.pre.poolKey, 1));
  let v, R = 0, E = 0;
  if (i.rollType === "sum" && ((dt = i.sum) != null && dt.formula))
    v = await new Roll(i.sum.formula, i.sum.data ?? {}).evaluate(), R = Number(v.total ?? 0) + Number(d ?? 0);
  else {
    v = await new Roll(`${f}d6cs>=${g}`).evaluate();
    const J = (Ot = v.dice) == null ? void 0 : Ot[0];
    R = Array.isArray(J == null ? void 0 : J.results) ? J.results.filter((Oe) => Oe.success).length : 0, E = Array.isArray(J == null ? void 0 : J.results) ? J.results.filter((Oe) => Oe.result === 1).length : 0;
  }
  if (i.intent === "initiative" && (v == null ? void 0 : v.total) != null) {
    const J = { total: Number(v.total ?? 0) + Number(d ?? 0) }, Oe = Bt({
      actor: a,
      phase: "onInitiativeResolved",
      facts: Md({ actor: a, packet: J, runtime: y }),
      packet: J,
      options: { runtime: y, consumeUsage: !0 }
    });
    if (await Ai({ actor: a, mutations: Oe.mutations, runtime: y }), Oe.modifiers.length) {
      const rs = Oe.modifiers.reduce((mi, qa) => mi + Number(qa.value ?? 0), 0);
      u = u.concat(Oe.modifiers), d += rs, R = Number(Oe.packet.total ?? 0), await yu({ actor: a, total: Oe.packet.total ?? v.total }), i.breakdown = (i.breakdown ?? []).concat(Oe.modifiers.map((mi, qa) => ({
        id: `traitInitiative${qa + 1}`,
        label: mi.label,
        value: Number(mi.value ?? 0)
      })));
    } else
      R = Number(J.total ?? 0), await yu({ actor: a, total: J.total });
  }
  const x = Um(
    i,
    { successes: R, raw: (ie = v == null ? void 0 : v.toJSON) == null ? void 0 : ie.call(v) },
    null
    // opposed rolls can pass defender result later
  ), K = x == null ? void 0 : x.edgeEarned;
  if ((K == null ? void 0 : K.amount) > 0) {
    const J = (Te = i == null ? void 0 : i.domains) != null && Te.includes("physical") ? "physical" : (ct = i == null ? void 0 : i.domains) != null && ct.includes("mental") ? "mental" : (ut = i == null ? void 0 : i.domains) != null && ut.includes("social") ? "social" : null, Oe = p0(a, J);
    await ((mt = a.gainEdge) == null ? void 0 : mt.call(a, Oe, K.amount)), x.edgeEarned.pool = Oe;
  }
  i.intent === "overload" && await v0({ actor: a, passed: x.passed });
  let q = null, H = null;
  i.intent === "attack" ? q = await Bm({
    attacker: a,
    ctx: i,
    outcomeModel: x
  }) : i.intent === "machineRemedy" && (H = await _A(e, {
    gmOverride: !!(e != null && e.gmOverride),
  ...
  q && (W.attackResult = q), i.intent === "machineRemedy" && (W.machineRemedy = i.machineRemedy ?? null, W.machineRemedyResult = {
    ...H ?? { ok: !1, reason: "Machine remedy result missing." },
    spend: b,
    context: A
  });
  const _ = await pa({ resolved: W });
  if (e.intent === "attack" && e.weaponId) {
    const J = ((Jt = (Ye = a.items) == null ? void 0 : Ye.get) == null ? void 0 : Jt.call(Ye, e.weaponId)) ?? null;
    (vi = J == null ? void 0 : J.isPersonalWeapon) != null && vi.call(J) && (await ((Wa = J.consumePayload) == null ? void 0 : Wa.call(J, { payloadId: e.payloadId })) || (Ga = ui.notifications) == null || Ga.warn(`Payload could not be consumed for ${J.name}.`));
  }
...
function A0({ actor: a, ctx: e, payload: t }) {
  var p, h, g, y, b, A, w;
  const i = T0(e == null ? void 0 : e.domains), n = w0[i] ?? null, r = (n == null ? void 0 : n.a) ?? null, s = (n == null ? void 0 : n.b) ?? null, o = [r, s].filter(Boolean), l = !!((p = t == null ? void 0 : t.toggles) != null && p.useEdge) || !!(t != null && t.useEdge);
...
async function yu({ actor: a, total: e }) {
  var o, l, c, u, d;
...
async function v0({ actor: a, passed: e }) {
  e || await a.update({ "system.burn.overloaded": !0 });
}
const k0 = /* @__PURE__ */ new Set(["physical", "mental", "social"]);
function M0(a) {
  if (a == null || a === "" || a === "—" || a === "–") return 0;
  const e = Number(a);
  return Number.isFinite(e) ? e : null;
...
class R0 {
  ...
  collect({ actor: e } = {}) {
    ...
    const i = [];
    for (const r of t) {
      const s = zr(r), o = s ? Fr(s, e) ? s.modifierKey : "" : r, l = Pa == null ? void 0 : Pa[o];
...
class Dl {
  ...
  async onInit() {
    console.log(Ce + "AnarchySystem.onInit"), game.system.mwd = this, game.system.anarchy = this, game.mwd ?? (game.mwd = {}), x0(), xA(), lS("mwd"), game.mwd.roll = hu, game.mwd.attacks = Qc, game.mwd.personalCombat = z, game.mwd.harm = Tt, this.roll = hu, this.attacks = Qc, this.personalCombat = z, this.harm = Tt, this.skills = $0(), this.lifeModules = B0(), this.traits = z0(), this.remoteCall = new Gs(), game.system.mwd.skills = this.skills, game.system.mwd.lifeModules = this.lifeModules, game.system.mwd.traits = this.traits, game.mwd.skills = this.skills, game.mwd.lifeModules = this.lifeModules, game.mwd.traits = this.traits, Me.init(), this.modifiers = new he(), ti.register(new E0()), ti.register(new R0()), ti.register(new P0()), ti.register(new N0()), ti.register(I0), ti.register(new D0()), ti.register(new O0()), ti.register(new _0()), ti.register(new xb()), Handlebars.registerHelper("mwdClassList", (e) => Array.isArray(e) ? e.join(" ") : typeof e == "string" ? e : ""), this.actorClasses = {
      character: Rc,
      npc: Rc,
      vehicle: km,
      battlemech: Ob
    }, this.hooks = new aa(), this.styles = new dy(), this.handlebarsManager = new pl(), z.init(), WS.register(), Hooks.on("updateSetting", (e) => {
      (e == null ? void 0 : e.key) === `${T}.statusConditionCatalog` && Kl();
    }), console.log(Ce + "AnarchySystem.onInit | loading system"), CONFIG.ANARCHY = $e, CONFIG.Combat.initiative = { formula: "2d6" }, Kl(), CONFIG.Actor.documentClass = ew, CONFIG.Item.documentClass = Fa, Fa.init(), qm(), mh(), RT(), GT(), await YT(), console.log(Ce + "AnarchySystem.onInit | done");
  }
  async onReady() {
    if (console.log(Ce + "AnarchySystem.onReady"), await z.onReady(), !game.user.isGM) return;
    await _g();
    ...
    game.mwd = game.mwd ?? {}, game.mwd.gmGadget = () => cS({ systemId: T }).render({ force: !0 }), e && game.mwd.gmGadget();
  }
}
Dl.start();
