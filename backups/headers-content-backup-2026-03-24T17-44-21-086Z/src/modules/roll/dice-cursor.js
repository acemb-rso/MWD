...
// Purpose: System module or client script for dice-cursor. Integrates with the system's JavaScript modules.
...
export class DiceCursor {
  ...
  static async diceCursor({ value, min, max, editable }) {
    return await renderTemplate('systems/mwd/templates/roll/parts/dice-cursor.hbs', {
